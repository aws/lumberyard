...
function timer:OnActivate()
    ...
    self.canvasEntityId = UiCanvasRefBus.Event.GetCanvas(self.entityId);
    self.UiTextElement = UiCanvasBus.Event.FindElementByName(self.canvasEntityId, self.Properties.TimerElementName);
    -- Debug.Log("UiTextElement("..tostring(self.Properties.TimerElementName).."): "..tostring(self.UiTextElement))
end
