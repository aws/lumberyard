...
public:
    ...
    // render into buffer
    ILINE void                              AddRenderMesh(IRenderMesh* pRM, Matrix34A* pTranRotMatrix, _smart_ptr<IMaterial> pMaterial, bool bOutdoorOnly, bool bCompletelyInFrustum, bool bNoCull){}
