...
bool CGeomCache::LoadGeomCache()
{
    ...
    ScopedFileHandle geomCacheFileHandle(m_fileName, "rb");
...
bool CGeomCache::ReadStaticBlock(AZ::IO::HandleType fileHandle, GeomCacheFile::EBlockCompressionFormat compressionFormat, std::vector<char>& compressedData)
{
