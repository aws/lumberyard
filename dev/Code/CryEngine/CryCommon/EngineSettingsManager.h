...
public:
    ...
    // returns the folder relative to the root path where the binary executables reside
    void GetBinFolderUtf16(SettingsManagerHelpers::CWCharBuffer wbuffer);
    void GetBinFolderAscii(SettingsManagerHelpers::CCharBuffer wbuffer);
