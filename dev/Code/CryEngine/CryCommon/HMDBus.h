    ...
    namespace VR
    {
        ...
        */
        ...
        public:
            ...
            ///
            virtual void GetPerEyeCameraInfo(const EStereoEye eye, const float nearPlane, const float farPlane, PerEyeCameraInfo& cameraInfo) {}
            ...
            ///
            virtual bool CreateRenderTargets(void* renderDevice, const TextureDesc& desc, size_t eyeCount, HMDRenderTarget* renderTargets[]) { return false; }
            ...
            ///
            virtual void DestroyRenderTarget(HMDRenderTarget& renderTarget) {}
            ...
            ///
            virtual void SubmitFrame(const EyeTarget& left, const EyeTarget& right) {}
            ...
            ///
            virtual void SetTrackingLevel(const AZ::VR::HMDTrackingLevel level) {}
            ...
            ///
            virtual void EnableDebugging(bool enable) {}
            ...
            ///
            virtual void DrawDebugInfo(const AZ::Transform& transform, IRenderAuxGeom* auxGeom) {}
