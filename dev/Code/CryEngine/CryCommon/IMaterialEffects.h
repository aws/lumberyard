...
public:
    ...
    // audio related
    EntityId audioComponentEntityId;      // if set, uses this Entity's audio component to execute audio triggers. otherwise creates independent sound
