...
#define MAXIMUM_NUMBER_OF_CONNECTIONS       64              // Maximum number of connections supported.
        ...
        #include "Salem/INetwork_h_salem.inl"
    #endif
#endif
...
struct IGameContext
{
    ...
    virtual uint32 GetContextFlags() = 0;
...
public:
    ...
    virtual void InvokeRMI(IGameObject* gameObject, IRMIRep& rep, void* params, ChannelId targetChannelFilter, uint32 where) = 0;
