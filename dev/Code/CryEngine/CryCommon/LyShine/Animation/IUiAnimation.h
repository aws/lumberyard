...
public:
    ...
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, float value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, bool value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, int value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, unsigned int value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, const AZ::Vector2& value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, const AZ::Vector3& value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, const AZ::Vector4& value) { return false; }
    virtual bool SetParamValueAz(float time, const UiAnimParamData& param, const AZ::Color& value) { return false; }

    virtual bool GetParamValueAz(float time, const UiAnimParamData& param, float& value) { return false; }
    ...
    // Arguments:
    //          paramType - parameter id
    virtual const char* GetParamNameForTrack(const CUiAnimParamType& paramType, const IUiAnimTrack* track) const { return GetParamName(paramType); }
