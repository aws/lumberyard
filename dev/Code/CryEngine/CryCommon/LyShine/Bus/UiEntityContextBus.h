...
public:
    ...
    virtual void AddUiEntities(const AzFramework::EntityContext::EntityList& entities) = 0;
    ...
    virtual bool CloneUiEntities(const AZStd::vector<AZ::EntityId>& sourceEntities, AzFramework::EntityContext::EntityList& resultEntities) = 0;
