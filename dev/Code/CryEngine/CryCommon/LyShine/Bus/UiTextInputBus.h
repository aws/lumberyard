...
public: // member functions
    ...
    virtual void OnTextInputChange(const AZStd::string& textString) {}

    //! Called when edit of text is completed
    virtual void OnTextInputEndEdit(const AZStd::string& textString) {}

    //! Called when Enter is pressed on keyboard
    virtual void OnTextInputEnter(const AZStd::string& textString) {}
};
