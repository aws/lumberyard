...
namespace Audio
{
        ...
        : public IAudioProxy
    {
        ...
        MOCK_METHOD3(ExecuteTrigger, void(const TAudioControlID nTriggerID, const ELipSyncMethod eLipSyncMethod, const SAudioCallBackInfos& rCallbackInfos /* = SAudioCallbackInfos::GetEmptyObject()*/));
