...
public:
    ...
    MOCK_CONST_METHOD0(IsRelaunch,
        bool());
    MOCK_METHOD0(LaunchAssetProcessor,
        bool());
    MOCK_METHOD4(DisplayErrorMessage,
        void(const char*, float, const float*, bool));

    void FatalError(const char* sFormat, ...) override {}
    void ReportBug(const char* sFormat, ...) override {}
    ...
    MOCK_METHOD0(GetINameTable,
        INameTable * ());
    MOCK_METHOD0(GetIDiskProfiler,
        IDiskProfiler * ());
    MOCK_METHOD0(GetIProfileSystem,
        IFrameProfileSystem * ());
    ...
    MOCK_METHOD0(GetICryFont,
        ICryFont * ());
    MOCK_METHOD0(GetIEntitySystem,
        IEntitySystem * ());
    MOCK_METHOD0(GetIMemoryManager,
        IMemoryManager * ());
    MOCK_METHOD0(GetAISystem,
        IAISystem * ());
    ...
    MOCK_METHOD0(GetIRenderer,
        IRenderer * ());
    MOCK_METHOD0(GetIInput,
        IInput * ());
    MOCK_METHOD0(GetITimer,
        ITimer * ());
    MOCK_METHOD0(GetGemManager,
        IGemManager * ());
    ...
    MOCK_METHOD1(SetIParticleManager,
        void(IParticleManager * pParticleManager));
    ...
    MOCK_METHOD0(CreateAVIReader,
        IAVI_Reader * ());
    MOCK_METHOD1(ReleaseAVIReader,
        void(IAVI_Reader * pAVIReader));
