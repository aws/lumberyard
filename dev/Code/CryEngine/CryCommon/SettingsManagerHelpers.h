...
public:
    ...
    void GetBinFolderUtf16(bool pullFromRegistry, SettingsManagerHelpers::CWCharBuffer wbuffer);
    void GetBinFolderAscii(bool pullFromRegistry, SettingsManagerHelpers::CCharBuffer buffer);
