...
namespace Unicode
{
    ...
    namespace Detail
    {
        ...
        template<>
        inline uint32 Decode<eEncoding_UTF32, false>(uint32 state, uint32 unit)
        {
            return unit;
        }
        ...
        // Decode UTF-32, safe.
        template<>
        inline uint32 Decode<eEncoding_UTF32, true>(uint32 state, uint32 unit)
        {
        ...
        // Decode ASCII, unsafe.
        template<>
        inline uint32 Decode<eEncoding_ASCII, false>(uint32 state, uint32 unit)
        {
            return unit;
        }
        ...
        // Decode ASCII, safe.
        template<>
        inline uint32 Decode<eEncoding_ASCII, true>(uint32 state, uint32 unit)
        {
            if (unit > 0x7F)
            {
                return cDecodeErrorBit;
        ...
        template<>
        inline uint32 Decode<eEncoding_Latin1, false>(uint32 state, uint32 unit)
        {
            return unit;
        }
        ...
        // Decode Latin1, safe.
        template<>
        inline uint32 Decode<eEncoding_Latin1, true>(uint32 state, uint32 unit)
        {
        ...
        template<>
        inline uint32 Decode<eEncoding_Win1252, false>(uint32 state, uint32 unit)
        {
