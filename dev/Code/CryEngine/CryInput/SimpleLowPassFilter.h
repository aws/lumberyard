...
*
*/
#ifndef CRYINCLUDE_CRYINPUT_SIMPLELOWPASSFILTER_H
#define CRYINCLUDE_CRYINPUT_SIMPLELOWPASSFILTER_H
#pragma once

#include "SingleOrderFilter.h"

////////////////////////////////////////////////////////////////////////////////////////////////////
struct CSimpleLowPassFilter
    : public CSingleOrderFilter
{
public:
    CSimpleLowPassFilter(float filterConstant, EMotionSensorFlags filterFlags);
    virtual ~CSimpleLowPassFilter();
...
#endif // CRYINCLUDE_CRYINPUT_SIMPLELOWPASSFILTER_H
