...
namespace GridMate
{
    namespace NetSerialize
    {
        ...
        */
         ...
         * This is used when reading state from a game object via IGameObject::NetSerialize(),
         * RMI param gathering, etc.
         */
         ...
         * This is used when writing state to a game object via IGameObject::NetSerialize(), invoking
         * RMIs, etc.
         */
