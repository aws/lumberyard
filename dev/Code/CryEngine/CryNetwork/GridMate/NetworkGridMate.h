...
namespace GridMate
{
    ...
    public: // INetwork implementation.
        ...
        //! Stores a pointer of the active game context to the network layer for internal use.
        ...
        //! Invoke a legacy game object RMI through GridMate RPCs.
    ...
    public: // GridMate-integration-specific APIs
        ...
        //! Set the current game context replica, which represents current level and game rules per the server.
        void SetGameContextReplica(GameContextReplica* replica);

        //! Retrieve the current game context replica, which represents current level and game rules per the server.
        GameContextReplica* GetGameContextReplica() const           { return m_gameContextReplica; }
        ...
        bool OnBeforeSpawn(SEntitySpawnParams& params) override { (void)params;  return true; }
        void OnReused(IEntity* pEntity, SEntitySpawnParams& params) override { (void)pEntity; (void)params; }
        void OnEvent(IEntity* pEntity, SEntityEvent& event) override { (void)pEntity; (void)event; }
        void GetMemoryUsage(class ICrySizer* pSizer) const override { (void)pSizer; }
        ////////////////////////////////////////////////////////////////
    ...
    private:
        ...
        //! Pointer to game context (CryEngine).
        ...
        //! Pointer to game session replica.
        GameContextReplica*             m_gameContextReplica;
