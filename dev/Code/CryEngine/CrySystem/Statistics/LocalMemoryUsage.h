...
private:
    ...
    void CheckCharacterP1(ICharacterInstance* pCharacter, IRenderNode* pRenderNode, _smart_ptr<IMaterial> pSlotMat, AABB bounding, float maxViewDist, float scale, int nMaxDepth);
