...
public:
    ...
    unsigned int GetBytesRead(bool bWait) override { return static_cast<unsigned int>(m_numBytesRead); };
    ...
    void SetFileRequest(AZStd::shared_ptr<AZ::IO::Request> request) { m_fileRequest = request; }
    AZ::IO::Request* GetFileRequest() { return m_fileRequest.get(); }

    void OnRequestComplete(AZ::IO::SizeType numBytesRead, void* buffer, AZ::IO::Request::StateType requestState);
...
private:
    ...
    AZStd::shared_ptr<AZ::IO::Request> m_fileRequest;
