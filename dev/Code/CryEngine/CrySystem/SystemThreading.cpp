...
#endif
{
    ...
    CryProfile::SetProfilingEvent("Thread_Run");
    ...
    CryProfile::SetThreadName(pThreadData->m_threadName.c_str());
    ...
    if (pThreadConfig == pThreadConfigMngr->GetDefaultThreadConfig())
    {
        ...
        CryProfile::SetThreadName(tmpString.c_str());
    }
    ...
    CryProfile::SetProfilingEvent("Thread_Stop");
