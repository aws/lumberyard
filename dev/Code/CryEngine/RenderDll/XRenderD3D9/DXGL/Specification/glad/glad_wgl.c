...
PFNWGLQUERYMAXSWAPGROUPSNVPROC glad_wglQueryMaxSwapGroupsNV; // ACCEPTED_USE
...
static void load_WGL_NV_swap_group(GLADloadproc load) {
	...
	glad_wglQueryMaxSwapGroupsNV = (PFNWGLQUERYMAXSWAPGROUPSNVPROC)load("wglQueryMaxSwapGroupsNV"); // ACCEPTED_USE
