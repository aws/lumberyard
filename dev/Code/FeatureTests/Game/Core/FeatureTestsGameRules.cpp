...
namespace LYGame
{
    DECLARE_DEFAULT_COMPONENT_FACTORY(FeatureTestsGameRules, IGameRules)

    bool FeatureTestsGameRules::Init(IGameObject* pGameObject)
    {
    ...
    void FeatureTestsGameRules::PostInit(IGameObject* pGameObject)
    {
    ...
    FeatureTestsGameRules::~FeatureTestsGameRules()
    {
    ...
    bool FeatureTestsGameRules::OnClientConnect(ChannelId channelId, bool isReset)
    {
