...
namespace AZStd
{
    ...
    public:
        ...
        {
#if AZ_TESTS_ENABLED // Clearing the original pointers isn't necessary, but is an easy way for the unit test to verify that the move constructor is being called
        ...
        array_view& operator=(array_view&& other)
        {
            ...
            m_end = other.m_end;
#if AZ_TESTS_ENABLED // Clearing the original pointers isn't necessary, but is an easy way for the unit test to verify that the move operaator is being called
            other.m_begin = nullptr;
            other.m_end = nullptr;
#endif
            return *this;
