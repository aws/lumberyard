...
namespace UnitTest
{
    ...
    public:
        ...
        bool LoadAssetData(const Asset<AssetData>&, IO::GenericStream*, const AZ::Data::AssetFilterCB&) override
        {
            return false;
        }
    ...
    TEST_F(InstanceDatabaseTest, InstanceCreate)
    {
        ...
        Asset<TestAssetType> someAsset = assetManager.CreateAsset<TestAssetType>(s_assetId0);
    ...
    void ParallelInstanceCreateHelper(size_t threadCountMax, size_t assetIdCount, size_t durationSeconds)
    {
        ...
        for (size_t i = 0; i < assetIdCount; ++i)
        {
            ...
            assets.emplace_back(assetManager.CreateAsset<TestAssetType>(guid));
        }
    ...
    TEST_F(InstanceDatabaseTestWithMultipleSubclasses, InstanceCreate)
    {
        ...
        Asset<FooAsset> fooAsset = assetManager.CreateAsset<FooAsset>(s_assetId0);
        Asset<BarAsset> barAsset = assetManager.CreateAsset<BarAsset>(s_assetId1);
    ...
    TEST_F(InstanceDatabaseTestWithMultipleSubclasses, TestError_AddHandler_AssetTypeIsNotSubclass)
    {
        ...
        // Try to use the unrelated handler. This is where we'll actually get an error.
        {
            ...
            Asset<TestAssetType> testAsset = AssetManager::Instance().CreateAsset<TestAssetType>(s_assetId0);
