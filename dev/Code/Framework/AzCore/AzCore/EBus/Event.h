...
namespace AZ
{
    ...
    class Event final
    {
        friend class Handler; // This is required in order to allow for relocating the handle pointers on a move
    ...
    public:
        ...
        public:
            ...
            explicit Handler(const Handler& rhs);
            explicit Handler(Handler&& rhs);
        ...
        Event& operator=(Event& rhs) = delete; // Cannot copy events
