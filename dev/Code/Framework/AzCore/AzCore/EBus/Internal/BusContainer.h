    ...
    namespace Internal
    {
        ...
        namespace
        {
            ...
            class MidDispatchDisconnectFixer
                : public Internal::CallstackEntry<typename Bus::InterfaceType, typename Bus::Traits>
            {
                using Base = Internal::CallstackEntry<typename Bus::InterfaceType, typename Bus::Traits>;
                    ...
                    if (auto* context = Bus::GetContext())
                    {
                        ...
                        while (addressIt != addresses.rend())
                        {
                            ...
                            if (addressIt != addresses.rbegin())
                            {
                                ...
                                nextHolder = &*AZStd::prior(addressIt);
                                nextHolder->add_ref();
                            }
