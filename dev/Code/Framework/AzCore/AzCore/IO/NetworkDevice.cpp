...
namespace AZ
{
    namespace IO
    {
        ...
        // [8/29/2012]
        //=========================================================================
        NetworkDevice::NetworkDevice(const AZStd::string& name, FileIOBase* ioBase, unsigned int cacheBlockSize, unsigned int numCacheBlocks, const AZStd::thread_desc* threadDesc, int threadSleepTimeMS)
            : Device(name, ioBase, threadDesc, threadSleepTimeMS)
        {
            m_type = DT_NETWORK_DRIVE;
        ...
        // [8/29/2012]
        //=========================================================================
        void NetworkDevice::ScheduleRequests()
        {
            if (m_pending.size() <= 1)
            {
