...
namespace AZ
{
    namespace Geometry2DUtils
    {
            ...
            VectorFloat epsilon)
        {
            ...
            const VectorFloat segmentLengthSq = segmentVector.GetLengthSq();
        ...
        bool IsSimplePolygon(const AZStd::vector<AZ::Vector2>& vertices, AZ::VectorFloat epsilon)
        {
            ...
            const AZ::VectorFloat epsilonSq = epsilon * epsilon;
