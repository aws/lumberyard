...
namespace AZ
{
    namespace Intersect
    {
         ...
         */
        inline VectorFloat    LineToPointDistanceTime(const Vector3& s1, const Vector3& s21, const Vector3& p)
        {
         ...
         */
        inline Vector3 LineToPointDistance(const Vector3& s1, const Vector3& s2, const Vector3& p, VectorFloat& u)
        {
        ...
        int IntersectRayAABB2(
            ...
            VectorFloat& start, VectorFloat& end);
        ...
        inline int ClipRayWithAabb(
            const Aabb& aabb, Vector3& rayStart, Vector3& rayEnd,VectorFloat& tClipStart, VectorFloat& tClipEnd)
        {
            Vector3 startNormal;
        ...
        AZ_INLINE int IntersectRaySphereOrigin(
            ...
            const VectorFloat& sphereRadius, VectorFloat& t)
        {
            Vector3 m = rayStart;
        ...
        inline int IntersectRaySphere(
            const Vector3& rayStart, const Vector3& rayDirNormalized, const Vector3& sphereCenter, const VectorFloat& sphereRadius, VectorFloat& t)
        {
        ...
        */
        ...
        int IntersectSegmentCylinder(
            ...
            const VectorFloat& r, VectorFloat& t);
        ...
        int IntersectSegmentCapsule(
            ...
            const Vector3& q, const VectorFloat& r, VectorFloat& t);
