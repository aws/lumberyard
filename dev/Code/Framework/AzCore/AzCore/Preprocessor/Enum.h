...
#define AZ_STRINGIFY(arg) AZ_STRINGIFY_IMPL(arg)
#define AZ_STRINGIFY_IMPL(arg) #arg
...
#define INIT_ENUM_STRING_PAIR_IMPL(_enumname, _optionname) { _enumname::_optionname, AZ_STRINGIFY(_optionname) },
...
{ \
    ...
    static constexpr MembersArrayType& Members = AZ_JOIN(EnumTypeName, Namespace)::AZ_JOIN(EnumTypeName, Members); \
    static constexpr size_t Count              = AZ_JOIN(EnumTypeName, Namespace)::AZ_JOIN(EnumTypeName, Count); \
}; 
