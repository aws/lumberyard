...
namespace AZ
{
    ...
    namespace StringFunc
    {
        ...
        */
        ...
        void Tokenize(AZStd::string_view in, AZStd::vector<AZStd::string>& tokens, const char* delimiters = "\\//, \t\n", bool keepEmptyStrings = false, bool keepSpaceStrings = false);
        ...
        */
        ...
        namespace Path
        {
            ...
            */
            ...
            //! StripQuotes
            /*! gets rid of all preceding and trailing quotes from a path, if they exist.  returns true if the operation to copy into the destination buffer was successful, false otherwise
            *! EX: StringFunc::Path::StripQuotes(input="D:\\path\\to\\resource", outputBuffer, outputBufferSize=32) == true; outputBuffer=="D:\\path\\to\\resource"
            *! EX: StringFunc::Path::StripQuotes(input="\"D:\\path\\to\\resource\"", outputBuffer, outputBufferSize=32) == true; outputBuffer=="D:\\path\\to\\resource"
            *! EX: StringFunc::Path::StripQuotes(input="\"\"D:\\path\\to\\resource\"\"", outputBuffer, outputBufferSize=32) == true; outputBuffer=="D:\\path\\to\\resource"
            *! EX: StringFunc::Path::StripQuotes(input="\"D:\\path\\to\\resource, outputBuffer, outputBufferSize=32) == true; outputBuffer=="D:\\path\\to\\resource"
            *! EX: StringFunc::Path::StripQuotes(input="D:\\path\\to\\resource\"", outputBuffer, outputBufferSize=32) == true; outputBuffer=="D:\\path\\to\\resource"
            *! EX: StringFunc::Path::StripQuotes(input="D:\\path\\to\\resource\"", outputBuffer, outputBufferSize=8) == false; outputBuffer==""
            */
