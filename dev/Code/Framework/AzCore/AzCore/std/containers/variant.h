...
namespace AZStd
{
    ...
    using has_hash_specialization = integral_constant<bool, AZStd::is_default_constructible<AZStd::hash<KeyType>>::value && AZStd::is_invocable_r<size_t, AZStd::hash<KeyType>, const KeyType&>::value>;

    template <typename... Types>
    struct variant_hash_enabled_concept
        : bool_constant<conjunction<has_hash_specialization<AZStd::remove_cv_t<Types>>...>::value>
    {
    };
    ...
    {
        enable_if_t<variant_hash_enabled_concept<Types...>::value, size_t> operator()(const variant<Types...>& variantKey) const
        {
