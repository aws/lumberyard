...
#define AZSTD_FUNCTION_ENABLE_IF_NOT_INTEGRAL(Functor, Type)  typename ::AZStd::Utils::enable_if_c<(::AZStd::type_traits::ice_not<(::AZStd::is_integral<Functor>::value)>::value), Type>::type
...
namespace AZStd
{
    namespace Internal
    {
        namespace function_util
        {
            ...
            {
                AZSTD_STATIC_CONSTANT(bool, value = ((sizeof(F) <= sizeof(function_buffer) && (alignment_of<function_buffer>::value % alignment_of<F>::value == 0))));
            };
