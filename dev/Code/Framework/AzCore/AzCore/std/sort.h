...
namespace AZStd
{
    ...
    */
    ...
    /**
    * sort using default less predicate. Depending on the array size we use different
    * algorithms.
    * [first, last) using operator<
     */
    template<class RandomAccessIterator>
    AZ_FORCE_INLINE void sort(RandomAccessIterator first, RandomAccessIterator last)
    {
        AZStd::Internal::sort_recursive(first, last, last - first);
    }

    /**
    * sort using user predicate. Depending on the array size we use different
    * algorithms.
    * [first, last)
    */
    template<class RandomAccessIterator, class Compare>
    AZ_FORCE_INLINE void sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp)
    {
    ...
    /**
     * Our version of stable sort always require to pass temporary buffer allocator. It is not guaranteed that
     * the system will have a default allocator, this is why we must provide it.
     */
    template<class BidirectionalIterator, class Allocator >
    AZ_INLINE void stable_sort(BidirectionalIterator first, BidirectionalIterator last, const Allocator& alloc)
    {
        if (first != last)
        {
    ...
    template<class BidirectionalIterator, class Compare, class Allocator >
    AZ_INLINE void stable_sort(BidirectionalIterator first, BidirectionalIterator last, Compare comp, const Allocator& alloc)
    {
        if (first != last)
        {
            typename iterator_traits<BidirectionalIterator>::difference_type count = AZStd::distance(first, last);
