...
*
*/
#ifndef AZSTD_TYPE_TRAIT_HAS_TRIVIAL_COPY_INCLUDED
#define AZSTD_TYPE_TRAIT_HAS_TRIVIAL_COPY_INCLUDED
    ...
    namespace Internal
    {
        ...
        struct has_trivial_copy_impl
        {
            AZSTD_STATIC_CONSTANT(bool, value =
                    (::AZStd::type_traits::ice_and< ::AZStd::type_traits::ice_or< ::AZStd::is_pod<T>::value, AZSTD_HAS_TRIVIAL_COPY(T)>::value,
                             ::AZStd::type_traits::ice_not< ::AZStd::is_volatile<T>::value >::value
                         >::value));
        };
    }

    AZSTD_TYPE_TRAIT_BOOL_DEF1(has_trivial_copy, T, ::AZStd::Internal::has_trivial_copy_impl<T>::value)
}

#endif // AZSTD_TYPE_TRAIT_HAS_TRIVIAL_COPY_INCLUDED
#pragma once