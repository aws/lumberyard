...
*
*/
#ifndef AZSTD_TYPE_TRAITS_IS_UNSIGNED_INCLUDED
#define AZSTD_TYPE_TRAITS_IS_UNSIGNED_INCLUDED
...
namespace AZStd
{
    ...
    AZSTD_TYPE_TRAIT_BOOL_DEF1(is_unsigned, T, ::AZStd::Internal::is_unsigned_imp<T>::value)
}

#endif // AZSTD_TYPE_TRAITS_IS_UNSIGNED_INCLUDED
#pragma once