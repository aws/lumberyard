...
namespace UnitTest
{
    ...
    TEST(Allocator, Examples)
    {
        ...
        // Sharing allocator between containers
        {
            ...
            typedef static_buffer_allocator<16*1024, 16> staic_buffer_16KB_aligned16;
            staic_buffer_16KB_aligned16 bufferAllocator;

            typedef allocator_ref<staic_buffer_16KB_aligned16> staic_buffer_16KB_aligned16_ref;

            staic_buffer_16KB_aligned16_ref sharedAllocator(bufferAllocator);
            ...
            vector<int, staic_buffer_16KB_aligned16_ref>     int_vector(sharedAllocator);
            list<float, staic_buffer_16KB_aligned16_ref>     float_list(sharedAllocator);
            deque<MyClass, staic_buffer_16KB_aligned16_ref>  myclass_deque(sharedAllocator);
        }
    ...
    public:
        ...
        void Vector()
        {
            ...
            // Quick tear-down (leak_and_reset extension)
            {
                ...
                vector<int, staic_buffer_16KB> tempVector(100, 10);
            ...
            // Allocators
            {
                ...
                staic_buffer_16KB otherAllocator("Other allocator");

                // change allocator name
                // All of this depends if your allocator assignment is slow/expensive. Otherwise this is valid code
                vector<int, staic_buffer_16KB> int_vec1(100, 10, staic_buffer_16KB("New Allocator Name"));
                ...
                typedef allocator_ref<staic_buffer_16KB> static_buffer_16KB_ref;
