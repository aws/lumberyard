...
namespace UnitTest
{
    ...
    TEST_F(ListContainers, ListResizeInsertEraseClear)
    {
        ...
        AZ_TEST_ASSERT(*prior(list_it) == 66); // 66 was the last element added at int_list.end()
    ...
    TEST_F(ListContainers, StaticBufferAllocator)
    {
        ...
        // list operations with container with the same allocator.
        typedef static_buffer_allocator<16*1024, 0> staic_buffer_16KB_type;
        staic_buffer_16KB_type myMemoryManager1;
        staic_buffer_16KB_type myMemoryManager2;
        typedef allocator_ref<staic_buffer_16KB_type> static_allocator_ref_type;
