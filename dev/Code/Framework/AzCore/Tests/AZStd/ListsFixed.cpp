...
namespace UnitTest
{
    ...
    TEST(FixedListContainers, ListCtorAssign)
    {
    ...
    TEST(FixedListContainers, ListResizeInsertErase)
    {
        fixed_list<int, 100> int_list;
        fixed_list<int, 100> int_list1;
        ...
        AZ_TEST_ASSERT(*prior(int_list.end(), 2) == 55);
        AZ_TEST_ASSERT(*int_list.begin() == *prior(int_list.rend()));
        ...
        AZ_TEST_ASSERT(*prior(int_list.end(), 2) == 22);
        ...
        int_list.erase(prior(int_list.end(), 2), int_list.end());
        AZ_TEST_VALIDATE_LIST(int_list, 3);
    ...
    TEST(FixedListContainers, ListSwapSplice)
    {
        fixed_list<int, 100> int_list;
        fixed_list<int, 100> int_list1;
        fixed_list<int, 100> int_list2;
    ...
    TEST(FixedListContainers, ListRemoveUniqueSort)
    {
        fixed_list<int, 100> int_list;
    ...
    TEST(FixedListContainers, ListReverseMerge)
    {
        fixed_list<int, 100> int_list;
        fixed_list<int, 100> int_list1;
        fixed_list<int, 100> int_list2;
    ...
    TEST(FixedListContainers, ListExtensions)
    {
        fixed_list<int, 100> int_list;
    ...
    TEST(FixedListContainers, ForwardListCtorAssign)
    {
    ...
    TEST(FixedListContainers, ForwardListResizeInsertErase)
    {
        fixed_forward_list<int, 100> int_slist;
        fixed_forward_list<int, 100> int_slist1;
        ...
        //AZ_TEST_ASSERT(*prior(int_slist.end(),2)==55);
        //AZ_TEST_ASSERT(*int_slist.begin()==*prior(int_slist.rend()));
    ...
    TEST(FixedListContainers, ForwardListSwapSplice)
    {
        fixed_forward_list<int, 100> int_slist;
        fixed_forward_list<int, 100> int_slist1;
        fixed_forward_list<int, 100> int_slist2;
    ...
    TEST(FixedListContainers, ForwardListRemoveUniqueSort)
    {
        fixed_forward_list<int, 100> int_slist;
    ...
    TEST(FixedListContainers, ForwardListReverseMerge)
    {
        fixed_forward_list<int, 100> int_slist;
        fixed_forward_list<int, 100> int_slist1;
        fixed_forward_list<int, 100> int_slist2;
    ...
    TEST(FixedListContainers, ForwardListExtensions)
    {
        fixed_forward_list<int, 100> int_slist;
