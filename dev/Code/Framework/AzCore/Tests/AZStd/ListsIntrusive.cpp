...
namespace UnitTest
{
    ...
    TEST(IntrusiveListContainers, IntrusiveListCtorAssign)
    {
    ...
    TEST(IntrusiveListContainers, IntrusiveListResizeInsertEraseClear)
    {
        // Create 2 list types, one which hooks to the base hook and one to the public member hook.
        typedef intrusive_list<MyListClass, list_base_hook<MyListClass> > myclass_base_list_type;
        typedef intrusive_list<MyListClass, list_member_hook<MyListClass, &MyListClass::m_listHook> > myclass_member_list_type;
        ...
        AZ_TEST_VALIDATE_LIST(myclass_base_list, myclassArray.size());
        AZ_TEST_ASSERT(myclass_base_list.front().m_data == prior(myclassArray.end())->m_data);

        myclass_member_list.insert(myclass_member_list.begin(), next(myclassArray.begin()), myclassArray.end());
        AZ_TEST_VALIDATE_LIST(myclass_member_list, myclassArray.size());
        AZ_TEST_ASSERT(myclass_member_list.back().m_data == prior(myclassArray.end())->m_data);

        // erase
        myclass_base_list.erase(prior(myclass_base_list.end()));
        ...
        myclass_member_list.erase(prior(myclass_member_list.end()));
    ...
    TEST(IntrusiveListContainers, IntrusiveListSwapSplace)
    {
        typedef intrusive_list<MyListClass, list_base_hook<MyListClass> > myclass_base_list_type;
        typedef intrusive_list<MyListClass, list_member_hook<MyListClass, &MyListClass::m_listHook> > myclass_member_list_type;
    ...
    TEST(IntrusiveListContainers, IntrusiveListRemoveUniqueSortReverse)
    {
        typedef intrusive_list<MyListClass, list_base_hook<MyListClass> > myclass_base_list_type;
        typedef intrusive_list<MyListClass, list_member_hook<MyListClass, &MyListClass::m_listHook> > myclass_member_list_type;
    ...
    TEST(IntrusiveListContainers, IntrusiveSListCtorAssign)
    {
        // Create 2 list types, one which hooks to the base hook and one to the public member hook.
    ...
    TEST(IntrusiveListContainers, IntrusiveSListResizeInsertEraseClear)
    {
        // Create 2 list types, one which hooks to the base hook and one to the public member hook.
        typedef intrusive_slist<MySListClass, slist_base_hook<MySListClass> > myclass_base_list_type;
        typedef intrusive_slist<MySListClass, slist_member_hook<MySListClass, &MySListClass::m_listHook> > myclass_member_list_type;
    ...
    TEST(IntrusiveListContainers, IntrusiveSListSwapSplice)
    {
        // Create 2 list types, one which hooks to the base hook and one to the public member hook.
        typedef intrusive_slist<MySListClass, slist_base_hook<MySListClass> > myclass_base_list_type;
        typedef intrusive_slist<MySListClass, slist_member_hook<MySListClass, &MySListClass::m_listHook> > myclass_member_list_type;
    ...
    TEST(IntrusiveListContainers, IntrusiveSListRemoveUniqueSortReverse)
    {
        // Create 2 list types, one which hooks to the base hook and one to the public member hook.
        typedef intrusive_slist<MySListClass, slist_base_hook<MySListClass> > myclass_base_list_type;
        typedef intrusive_slist<MySListClass, slist_member_hook<MySListClass, &MySListClass::m_listHook> > myclass_member_list_type;
    ...
    TEST(IntrusiveListContainers, IntrusiveSListMerge)
    {
        // Create 2 list types, one which hooks to the base hook and one to the public member hook.
        typedef intrusive_slist<MySListClass, slist_base_hook<MySListClass> > myclass_base_list_type;
        typedef intrusive_slist<MySListClass, slist_member_hook<MySListClass, &MySListClass::m_listHook> > myclass_member_list_type;
