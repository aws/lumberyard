...
namespace UnitTest
{
    ...
    TEST_F(ScriptMathTest, Vector2Test)
    {
        ////Constructors
        ...
        script->Execute("vA:NormalizeSafe()");
        script->Execute("AZTestAssert(vA:IsClose(Vector2(1, 0)))");
        ...
        script->Execute("AZTestAssert(Vector2(0.707, 0.707):IsNormalized())");
        ...
        script->Execute("AZTestAssert(slerped:IsClose(Vector2(0.707, 0.707)))");
    ...
    TEST_F(ScriptMathTest, Vector3Test)
    {
        // Not all Vector3 C++ functions are reflected into Lua:
        // Compound assignment operators are not supported in Lua (+=, -=, /=, *=)
        // Approx and Exact functions are not specified, the performance benefits of Approx
        // are lost when marshalling between Lua and C++.
        ...
        script->Execute("AZTestAssert(Vector3(0):GetNormalizedSafe() == Vector3(1, 0, 0))");
        ...
        script->Execute("v1:NormalizeSafe()");
        script->Execute("AZTestAssert(v1 == Vector3(1, 0, 0))");
        ...
        script->Execute("AZTestAssert(Vector3(0.707, 0.707, 0):IsNormalized())");
        ...
        script->Execute("v1:Set(3, 4, 0)");
        script->Execute("v1:SetLengthApprox(10)");
        script->Execute("AZTestAssert(v1:IsClose(Vector3(6, 8, 0)))");
        script->Execute("v1:Set(3, 4, 0)");
        script->Execute("v1:SetLengthExact(10)");
        script->Execute("AZTestAssert(v1:IsClose(Vector3(6, 8, 0)))");
        ...
        script->Execute("AZTestAssert(Vector3(1, 0, 0):Slerp(Vector3(0, 1, 0), 0.5):IsClose(Vector3(0.707, 0.707, 0)))");
    ...
    TEST_F(ScriptMathTest, Vector4Test)
    {
    ...
    TEST_F(ScriptMathTest, QuaternionTest)
    {
        //constructors
        ...
        script->Execute("q6 = Quaternion.CreateFromTransform(Transform.CreateRotationX(Math.DegToRad(60)))");
        script->Execute("AZTestAssert(q6:IsClose(Quaternion(0.5, 0, 0, 0.866)))");
        ...
        script->Execute("AZTestAssert(v2:IsClose(q3*v1))");
        script->Execute("q4 = Quaternion.CreateShortestArc(Vector3(1, 0, 0), Vector3(0, 1, 0))");
        script->Execute("AZTestAssert((q4*Vector3(0, 0, 1)):IsClose(Vector3(0, 0, 1)))");    //perpendicular vector should be unaffected
        script->Execute("AZTestAssert((q4*Vector3(0, -1, 0)):IsClose(Vector3(1, 0, 0)))");   //make sure we rotate the right direction, i.e. actually shortest arc
        ...
        script->Execute("AZTestAssert(Quaternion(0, -4, 2, 4):GetNormalized():IsClose(Quaternion(0, -0.666, 0.333, 0.666)))");
        script->Execute("q1:Set(2, 0, 4, -4)");
        script->Execute("q1:Normalize()");
        script->Execute("AZTestAssert(q1:IsClose(Quaternion(0.333, 0, 0.666, -0.666)))");
        script->Execute("q1:Set(2, 0, 4, -4)");
        ...
        script->Execute("AZTestAssert(Quaternion.CreateRotationX(Math.DegToRad(10)):Slerp(Quaternion.CreateRotationY(Math.DegToRad(60)), 0.5):IsClose(Quaternion(0.045, 0.259, 0, 0.965)))");
        script->Execute("AZTestAssert(Quaternion.CreateRotationX(Math.DegToRad(10)):Squad(Quaternion.CreateRotationY(Math.DegToRad(60)), Quaternion.CreateRotationZ(Math.DegToRad(35)), Quaternion.CreateRotationX(Math.DegToRad(80)), 0.5):IsClose(Quaternion(0.2, 0.132, 0.083, 0.967)))");
        ...
        //vector transform
        script->Execute("AZTestAssert((Quaternion.CreateRotationX(Math.DegToRad(45))*Vector3(4, 1, 0)):IsClose(Vector3(4, 0.707, 0.707)))");
    ...
    TEST_F(ScriptMathTest, Matrix3x3Test)
    {
        ...
        script->Execute("v1 = Vector3(1, 2, 3)");
        script->Execute("AZTestAssert((v1*m1):IsClose(Vector3(30, 36, 42)))");
    ...
    TEST_F(ScriptMathTest, Matrix4x4Test)
    {
        script->Execute("testIndices = { 0, 1, 2, 3 }");
        ...
        script->Execute("AZTestAssert(m1:GetRow(0):IsClose(Vector4(-2.1, 0, 0, 0)))");
        ...
        script->Execute("AZTestAssert(m1:GetPosition():IsClose(Vector3(5, 6, 7)))");
        script->Execute("m1:SetPosition(1, 2, 3)");
        script->Execute("AZTestAssert(m1:GetPosition():IsClose(Vector3(1, 2, 3)))");
        script->Execute("m1:SetPosition(Vector3(2, 3, 4))");
        script->Execute("AZTestAssert(m1:GetPosition():IsClose(Vector3(2, 3, 4)))");
        ...
        script->Execute("v1 = Vector3(1, 2, 3)");
        script->Execute("AZTestAssert((v1*m1):IsClose(Vector3(51, 58, 65)))");
        script->Execute("v2 = Vector4(1, 2, 3, 4)");
        script->Execute("AZTestAssert((v2*m1):IsClose(Vector4(90, 100, 110, 120)))");
        ...
        script->Execute("m1:SetPosition(Vector3(10, -3, 5))");
        ...
        script->Execute("m2:SetPosition(Vector3(-5, 4.2, -32))");
        script->Execute("m3 = m2:GetInverseFast()");
        //// allow a little bigger threshold, because of the 2 rot matrices (sin,cos differences)
    ...
    TEST_F(ScriptMathTest, TransformTest)
    {
        script->Execute("testIndices = { 0, 1, 2, 3 }");

        ////create functions
        script->Execute("t1 = Transform.CreateIdentity()");
        script->Execute("AZTestAssert(t1:GetRow(0) == Vector4(1,0,0,0))");
        script->Execute("AZTestAssert(t1:GetRow(1) == Vector4(0,1,0,0))");
        script->Execute("AZTestAssert(t1:GetRow(2) == Vector4(0,0,1,0))");
        script->Execute("t1 = Transform.CreateZero()");
        script->Execute("AZTestAssert(t1:GetRow(0) == Vector4(0))");
        script->Execute("AZTestAssert(t1:GetRow(1) == Vector4(0))");
        script->Execute("AZTestAssert(t1:GetRow(2) == Vector4(0))");
        script->Execute("t1 = Transform.CreateFromValue(2)");
        script->Execute("AZTestAssert(t1:GetRow(0) == Vector4(2))");
        script->Execute("AZTestAssert(t1:GetRow(1) == Vector4(2))");
        script->Execute("AZTestAssert(t1:GetRow(2) == Vector4(2))");
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(1,0,0,0)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(0,0.866,-0.5,0)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(0,0.5,0.866,0)))");
        script->Execute("t1 = Transform.CreateRotationY(Math.DegToRad(30))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(0.866,0,0.5,0)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(0,1,0,0)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(-0.5,0,0.866,0)))");
        script->Execute("t1 = Transform.CreateRotationZ(Math.DegToRad(30))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(0.866,-0.5,0,0)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(0.5,0.866,0,0)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(0,0,1,0)))");
        ...
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(1,0,0,1)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(0,0.866,-0.5,2)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(0,0.5,0.866,3)))");
        script->Execute("t1 = Transform.CreateScale(Vector3(1,2,3))");
        script->Execute("AZTestAssert(t1:GetRow(0) == Vector4(1,0,0,0))");
        script->Execute("AZTestAssert(t1:GetRow(1) == Vector4(0,2,0,0))");
        script->Execute("AZTestAssert(t1:GetRow(2) == Vector4(0,0,3,0))");
        script->Execute("t1 = Transform.CreateDiagonal(Vector3(2,3,4))");
        script->Execute("AZTestAssert(t1:GetRow(0) == Vector4(2,0,0,0))");
        script->Execute("AZTestAssert(t1:GetRow(1) == Vector4(0,3,0,0))");
        script->Execute("AZTestAssert(t1:GetRow(2) == Vector4(0,0,4,0))");
        script->Execute("t1 = Transform.CreateTranslation(Vector3(1,2,3))");
        script->Execute("AZTestAssert(t1:GetRow(0) == Vector4(1,0,0,1))");
        script->Execute("AZTestAssert(t1:GetRow(1) == Vector4(0,1,0,2))");
        script->Execute("AZTestAssert(t1:GetRow(2) == Vector4(0,0,1,3))");

        ////element access
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("AZTestAssertFloatClose(t1:GetElement(1,2), -0.5)");
        script->Execute("AZTestAssertFloatClose(t1:GetElement(2,2), 0.866)");
        script->Execute("t1:SetElement(2,1, 5)");
        script->Execute("AZTestAssert(t1:GetElement(2,1) == 5)");

        ////row access
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(0,0.5,0.866,0)))");
        script->Execute("AZTestAssert(t1:GetRowAsVector3(2):IsClose(Vector3(0,0.5,0.866)))");
        script->Execute("t1:SetRow(0, 1,2,3,4)");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(1,2,3,4)))");
        script->Execute("t1:SetRow(1, Vector3(5,6,7), 8)");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(5,6,7,8)))");
        script->Execute("t1:SetRow(2, Vector4(3,4,5,6.0))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(3,4,5,6)))");
        ////test GetRow with non-constant, we have different implementations for constants and variables
        script->Execute("AZTestAssert(t1:GetRow(testIndices[1]):IsClose(Vector4(1,2,3,4)))");
        script->Execute("AZTestAssert(t1:GetRow(testIndices[2]):IsClose(Vector4(5,6,7,8)))");
        script->Execute("AZTestAssert(t1:GetRow(testIndices[3]):IsClose(Vector4(3,4,5,6)))");
        script->Execute("row0, row1, row2 = t1:GetRows()");
        script->Execute("AZTestAssert(row0:IsClose(Vector4(1,2,3,4)))");
        script->Execute("AZTestAssert(row1:IsClose(Vector4(5,6,7,8)))");
        script->Execute("AZTestAssert(row2:IsClose(Vector4(3,4,5,6)))");
        script->Execute("t1:SetRows(Vector4(10,11,12,13), Vector4(14,15,16,17), Vector4(18,19,20,21))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(10,11,12,13)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(14,15,16,17)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(18,19,20,21)))");

        ////column access
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("AZTestAssert(t1:GetColumn(1):IsClose(Vector3(0,0.866,0.5)))");
        script->Execute("t1:SetColumn(3, 1,2,3)");
        script->Execute("AZTestAssert(t1:GetColumn(3):IsClose(Vector3(1,2,3)))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(1,0,0,1)))"); //checking all components in case others get messed up with the shuffling
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(0,0.866,-0.5,2)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(0,0.5,0.866,3)))");
        script->Execute("t1:SetColumn(0, Vector3(2,3,4))");
        script->Execute("AZTestAssert(t1:GetColumn(0):IsClose(Vector3(2,3,4)))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(2,0,0,1)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(3,0.866,-0.5,2)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(4,0.5,0.866,3)))");
        ////test GetColumn with non-constant, we have different implementations for constants and variables
        script->Execute("AZTestAssert(t1:GetColumn(testIndices[1]):IsClose(Vector3(2,3,4)))");
        script->Execute("AZTestAssert(t1:GetColumn(testIndices[2]):IsClose(Vector3(0,0.866,0.5)))");
        script->Execute("AZTestAssert(t1:GetColumn(testIndices[3]):IsClose(Vector3(0,-0.5,0.866)))");
        script->Execute("AZTestAssert(t1:GetColumn(testIndices[4]):IsClose(Vector3(1,2,3)))");
        script->Execute("col0, col1, col2, col3 = t1:GetColumns()");
        script->Execute("AZTestAssert(col0:IsClose(Vector3(2,3,4)))");
        script->Execute("AZTestAssert(col1:IsClose(Vector3(0,0.866,0.5)))");
        script->Execute("AZTestAssert(col2:IsClose(Vector3(0,-0.5,0.866)))");
        script->Execute("AZTestAssert(col3:IsClose(Vector3(1,2,3)))");
        script->Execute("t1:SetColumns(Vector3(10,11,12), Vector3(13,14,15), Vector3(16,17,18), Vector3(19, 20, 21))");
        script->Execute("AZTestAssert(t1:GetColumn(0):IsClose(Vector3(10,11,12)))");
        script->Execute("AZTestAssert(t1:GetColumn(1):IsClose(Vector3(13,14,15)))");
        script->Execute("AZTestAssert(t1:GetColumn(2):IsClose(Vector3(16,17,18)))");
        script->Execute("AZTestAssert(t1:GetColumn(3):IsClose(Vector3(19,20,21)))");

        ////basis access
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("t1:SetPosition(1,2,3)");
        script->Execute("AZTestAssert(t1.basisX:IsClose(Vector3(1,0,0)))");
        script->Execute("AZTestAssert(t1.basisY:IsClose(Vector3(0,0.866,0.5)))");
        script->Execute("AZTestAssert(t1.basisZ:IsClose(Vector3(0,-0.5,0.866)))");
        script->Execute("t1.basisX = Vector3(10, 11, 12)");
        script->Execute("AZTestAssert(t1.basisX:IsClose(Vector3(10,11,12)))");
        script->Execute("t1.basisY = Vector3(13, 14, 15)");
        script->Execute("AZTestAssert(t1.basisY:IsClose(Vector3(13,14,15)))");
        script->Execute("t1.basisZ = Vector3(16, 17, 18)");
        script->Execute("AZTestAssert(t1.basisZ:IsClose(Vector3(16,17,18)))");
        script->Execute("basis0, basis1, basis2, pos = t1:GetBasisAndPosition()");
        script->Execute("AZTestAssert(basis0:IsClose(Vector3(10,11,12)))");
        script->Execute("AZTestAssert(basis1:IsClose(Vector3(13,14,15)))");
        script->Execute("AZTestAssert(basis2:IsClose(Vector3(16,17,18)))");
        script->Execute("AZTestAssert(pos:IsClose(Vector3(1,2,3)))");
        script->Execute("t1:SetBasisAndPosition(Vector3(1,2,3), Vector3(4,5,6), Vector3(7,8,9), Vector3(10,11,12))");
        script->Execute("AZTestAssert(t1.basisX:IsClose(Vector3(1,2,3)))");
        script->Execute("AZTestAssert(t1.basisY:IsClose(Vector3(4,5,6)))");
        script->Execute("AZTestAssert(t1.basisZ:IsClose(Vector3(7,8,9)))");
        script->Execute("AZTestAssert(t1:GetPosition():IsClose(Vector3(10,11,12)))");

        ////position access
        script->Execute("t1 = Transform.CreateTranslation(Vector3(5,6,7))");
        script->Execute("AZTestAssert(t1:GetPosition():IsClose(Vector3(5,6,7)))");
        script->Execute("t1:SetPosition(1,2,3)");
        script->Execute("AZTestAssert(t1:GetPosition():IsClose(Vector3(1,2,3)))");
        script->Execute("t1:SetPosition(Vector3(2,3,4))");
        script->Execute("AZTestAssert(t1:GetPosition():IsClose(Vector3(2,3,4)))");
        ...
        script->Execute("AZTestAssert(t3:GetRow(0):IsClose(Vector4(0.866,0,0.5,3)))");
        script->Execute("AZTestAssert(t3:GetRow(1):IsClose(Vector4(0.25,0.866,-0.433,2.598)))");
        script->Execute("AZTestAssert(t3:GetRow(2):IsClose(Vector4(-0.433,0.5,0.75,7.964)))");
        ...
        script->Execute("AZTestAssert(t1:TransposedMultiply3x3(Vector3(1,2,3)):IsClose(Vector3(1,3.224,1.598), 0.02))");
        script->Execute("AZTestAssert(t1:Multiply3x3(Vector3(1,2,3)):IsClose(Vector3(1,0.224,3.598), 0.02))");
        script->Execute("v1 = Vector3(1,2,3)");
        script->Execute("AZTestAssert((v1*t1):IsClose(Vector3(1,3.224,1.598), 0.02))");
        script->Execute("v2 = Vector4(1,2,3,4)");
        script->Execute("AZTestAssert((v2*t1):IsClose(Vector4(1,3.224,1.598,18), 0.02))");

        ////transpose
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("t1:SetTranslation(Vector3(1,2,3))");
        script->Execute("t2 = t1:GetTranspose()");
        script->Execute("AZTestAssert(t2:GetRow(0):IsClose(Vector4(1,0,0,0)))");
        script->Execute("AZTestAssert(t2:GetRow(1):IsClose(Vector4(0,0.866,0.5,0)))");
        script->Execute("AZTestAssert(t2:GetRow(2):IsClose(Vector4(0,-0.5,0.866,0)))");
        script->Execute("t2 = t1:Clone()");
        script->Execute("t2:Transpose()");
        script->Execute("AZTestAssert(t2:GetRow(0):IsClose(Vector4(1,0,0,0)))");
        script->Execute("AZTestAssert(t2:GetRow(1):IsClose(Vector4(0,0.866,0.5,0)))");
        script->Execute("AZTestAssert(t2:GetRow(2):IsClose(Vector4(0,-0.5,0.866,0)))");
        script->Execute("t3 = t1:GetTranspose3x3()");
        script->Execute("AZTestAssert(t3:GetRow(0):IsClose(Vector4(1,0,0,1)))");
        script->Execute("AZTestAssert(t3:GetRow(1):IsClose(Vector4(0,0.866,0.5,2)))");
        script->Execute("AZTestAssert(t3:GetRow(2):IsClose(Vector4(0,-0.5,0.866,3)))");
        script->Execute("t3 = t1:Clone()");
        script->Execute("t3:Transpose3x3()");
        script->Execute("AZTestAssert(t3:GetRow(0):IsClose(Vector4(1,0,0,1)))");
        script->Execute("AZTestAssert(t3:GetRow(1):IsClose(Vector4(0,0.866,0.5,2)))");
        script->Execute("AZTestAssert(t3:GetRow(2):IsClose(Vector4(0,-0.5,0.866,3)))");
        ...
        script->Execute("t1:SetPosition(Vector3(10, -3, 5))");
        script->Execute("AZTestAssert((t1*t1:GetInverseFast()):IsClose(Transform.CreateIdentity(), 0.02))");
        script->Execute("t2 = Transform.CreateRotationZ(2) * Transform.CreateRotationX(1)");
        script->Execute("t2:SetPosition(Vector3(-5, 4.2, -32))");
        script->Execute("t3 = t2:GetInverseFast()");
        //// allow a little bigger threshold, because of the 2 rot matrices (sin,cos differences)
        script->Execute("AZTestAssert((t2*t3):IsClose(Transform.CreateIdentity(), 0.1))");
        script->Execute("AZTestAssert(t3:GetRow(0):IsClose(Vector4(-0.420,0.909,0,-5.920), 0.06))");
        script->Execute("AZTestAssert(t3:GetRow(1):IsClose(Vector4(-0.493,-0.228,0.841,25.418), 0.06))");
        script->Execute("AZTestAssert(t3:GetRow(2):IsClose(Vector4(0.765,0.353,0.542,19.703), 0.06))");

        ////test inverse, should handle non-orthogonal matrices
        script->Execute("t1:SetElement(0,1,23.1234)");
        script->Execute("AZTestAssert((t1*t1:GetInverseFull()):IsClose(Transform.CreateIdentity()))");

        ////scale access
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(40)) * Transform.CreateScale(Vector3(2, 3, 4))");
        script->Execute("AZTestAssert(t1:RetrieveScale():IsClose(Vector3(2, 3, 4)))");
        script->Execute("AZTestAssert(t1:ExtractScale():IsClose(Vector3(2, 3, 4)))");
        script->Execute("AZTestAssert(t1:RetrieveScale():IsClose(Vector3.CreateOne()))");
        script->Execute("t1:MultiplyByScale(Vector3(3, 4, 5))");
        script->Execute("AZTestAssert(t1:RetrieveScale():IsClose(Vector3(3, 4, 5)))");

        ////polar decomposition
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("t1:SetTranslation(Vector3(1,2,3))");
        script->Execute("t2 = Transform.CreateScale(Vector3(5,6,7))");
        script->Execute("t3 = t1 * t2");
        script->Execute("AZTestAssert(t3:GetPolarDecomposition():IsClose(t1))");
        script->Execute("t4, t5 = t3:GetPolarDecomposition()");
        script->Execute("AZTestAssert((t4*t5):IsClose(t3))");
        script->Execute("AZTestAssert(t4:IsClose(t1))");
        script->Execute("AZTestAssert(t5:IsClose(t2, 0.01))");

        ////orthogonalize
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30)) * Transform.CreateScale(Vector3(2, 3, 4))");
        script->Execute("t1:SetTranslation(Vector3(1,2,3))");
        script->Execute("t1:SetElement(0,1, 0.2)");
        script->Execute("t2 = t1:GetOrthogonalized()");
        script->Execute("AZTestAssertFloatClose(t2:GetColumn(0):GetLength(),1)");
        script->Execute("AZTestAssertFloatClose(t2:GetColumn(1):GetLength(),1)");
        script->Execute("AZTestAssertFloatClose(t2:GetColumn(2):GetLength(),1)");
        script->Execute("AZTestAssertFloatClose(t2:GetColumn(0):Dot(t2:GetColumn(1)),0)");
        script->Execute("AZTestAssertFloatClose(t2:GetColumn(0):Dot(t2:GetColumn(2)),0)");
        script->Execute("AZTestAssertFloatClose(t2:GetColumn(1):Dot(t2:GetColumn(2)),0)");
        script->Execute("AZTestAssert(t2:GetColumn(0):Cross(t2:GetColumn(1)):IsClose(t2:GetColumn(2)))");
        script->Execute("AZTestAssert(t2:GetColumn(1):Cross(t2:GetColumn(2)):IsClose(t2:GetColumn(0)))");
        script->Execute("AZTestAssert(t2:GetColumn(2):Cross(t2:GetColumn(0)):IsClose(t2:GetColumn(1)))");
        ...
        script->Execute("t1:SetRow(1, t1:GetRow(1)*2)");
        script->Execute("AZTestAssert( not t1:IsOrthogonal(0.05))");
        script->Execute("t1 = Transform.CreateRotationX(Math.DegToRad(30))");
        script->Execute("t1:SetRow(1, Vector4(0,1,0,0))");
        script->Execute("AZTestAssert( not t1:IsOrthogonal(0.05))");
        ...
        script->Execute("t2 = t1:Clone()");
        script->Execute("AZTestAssert(t1:IsClose(t2))");
        script->Execute("t2:SetElement(0,0,2)");
        script->Execute("AZTestAssert( not t1:IsClose(t2))");
        script->Execute("t2 = t1:Clone()");
        script->Execute("t2:SetElement(0,3,2)");
        script->Execute("AZTestAssert( not t1:IsClose(t2))");

        ////set rotation part
        script->Execute("t1 = Transform.CreateTranslation(Vector3(1,2,3))");
        script->Execute("t1:SetRotationPartFromQuaternion(Quaternion.CreateRotationX(Math.DegToRad(30)))");
        script->Execute("AZTestAssert(t1:GetRow(0):IsClose(Vector4(1,0,0,1)))");
        script->Execute("AZTestAssert(t1:GetRow(1):IsClose(Vector4(0,0.866,-0.5,2)))");
        script->Execute("AZTestAssert(t1:GetRow(2):IsClose(Vector4(0,0.5,0.866,3)))");

        ////determinant
        script->Execute("t1:SetRow(0, -1,2,3,1)");
        script->Execute("t1:SetRow(1, 4,5,6,2)");
        script->Execute("t1:SetRow(2, 7,8,-9,3)");
        script->Execute("AZTestAssertFloatClose(t1:GetDeterminant3x3(),240)");
    }

    TEST_F(ScriptMathTest, PlaneTest)
    {
        ...
        script->Execute("AZTestAssertFloatClose(pl:GetPlaneEquationCoefficients().w, 55)");
        script->Execute("AZTestAssertFloatClose(pl:GetPlaneEquationCoefficients().x, 0.707)");
        script->Execute("AZTestAssertFloatClose(pl:GetPlaneEquationCoefficients().y, 0.707)");
        script->Execute("AZTestAssertFloatClose(pl:GetPlaneEquationCoefficients().z, 0)");
    ...
    TEST_F(ScriptMathTest, UuidTest)
    {
        // null
    ...
    TEST_F(ScriptMathTest, Crc32Test)
    {
    ...
    TEST_F(ScriptMathTest, AabbTest)
    {
        ...
        script->Execute("axisX = Vector3(0.707, 0.707, 0)");
        script->Execute("axisY = Vector3(0, 0.707, 0.707)");
        script->Execute("axisZ = Vector3(0.707, 0, 0.707)");
        script->Execute("halfLength = 1");
        script->Execute("obb = Obb.CreateFromPositionAndAxes(position, axisX, halfLength, axisY, halfLength, axisZ, halfLength)");
        script->Execute("aabb = Aabb.CreateFromObb(obb)");
        script->Execute("AZTestAssert(aabb.min:IsClose(Vector3(-0.414, -0.414, -0.414)))");
        script->Execute("AZTestAssert(aabb.max:IsClose(Vector3(2.414, 2.414, 2.414)))");
        ...
        script->Execute("AZTestAssertFloatClose(aabb:GetWidth(), 1)");
        script->Execute("AZTestAssertFloatClose(aabb:GetHeight(), 2)");
        script->Execute("AZTestAssertFloatClose(aabb:GetDepth(), 3)");
    ...
    TEST_F(ScriptMathTest, AabbTransformCompareTest)
    {
        // create aabb
        ...
        script->Execute("tm = Transform.CreateScale(Vector3(0.4,1,1.2)) * Transform.CreateRotationX(1)");
    ...
    TEST_F(ScriptMathTest, ObbTest)
    {
        ...
        script->Execute("axisY = Vector3(0, 0.707, 0.707)");
        script->Execute("axisZ = Vector3(0.707, 0, 0.707)");
        script->Execute("halfLength = 0.5");
        script->Execute("obb = Obb.CreateFromPositionAndAxes(position, axisX, halfLength, axisY, halfLength, axisZ, halfLength)");
        script->Execute("AZTestAssert(obb.position:IsClose(position))");
        script->Execute("AZTestAssert(obb.axisX:IsClose(axisX))");
        script->Execute("AZTestAssert(obb.axisY:IsClose(axisY))");
        script->Execute("AZTestAssert(obb.axisZ:IsClose(axisZ))");
        script->Execute("AZTestAssertFloatClose(obb.halfLengthX,halfLength)");
        script->Execute("AZTestAssertFloatClose(obb.halfLengthY,halfLength)");
        script->Execute("AZTestAssertFloatClose(obb.halfLengthZ, halfLength)");
        script->Execute("AZTestAssert(obb:GetAxis(0):IsClose(axisX))");
        script->Execute("AZTestAssert(obb:GetAxis(1):IsClose(axisY))");
        script->Execute("AZTestAssert(obb:GetAxis(2):IsClose(axisZ))");
        script->Execute("AZTestAssertFloatClose(obb:GetHalfLength(0), halfLength)");
        script->Execute("AZTestAssertFloatClose(obb:GetHalfLength(1), halfLength)");
        script->Execute("AZTestAssertFloatClose(obb:GetHalfLength(2), halfLength)");
        ...
        script->Execute("AZTestAssert(obb.axisX:IsClose(Vector3(1, 0, 0)))");
        script->Execute("AZTestAssert(obb.axisY:IsClose(Vector3(0, 1, 0)))");
        script->Execute("AZTestAssert(obb.axisZ:IsClose(Vector3(0, 0, 1)))");
        ...
        script->Execute("AZTestAssert(obb.axisX:IsClose(Vector3(0, 0.707, -0.707)))");
        script->Execute("AZTestAssert(obb.axisY:IsClose(Vector3(0.707, 0.707, 0)))");
        script->Execute("AZTestAssert(obb.axisZ:IsClose(Vector3(0.707, 0, -0.707)))");
        ...
        script->Execute("AZTestAssert(obb.position:IsClose(position))");
        script->Execute("obb.axisX = axisX");
        script->Execute("AZTestAssert(obb.axisX:IsClose(axisX))");
        script->Execute("obb.axisY = axisY");
        script->Execute("AZTestAssert(obb.axisY:IsClose(axisY))");
        script->Execute("obb.axisZ = axisZ");
        script->Execute("AZTestAssert(obb.axisZ:IsClose(axisZ))");
        script->Execute("obb:SetAxis(1, axisX)");
        script->Execute("AZTestAssert(obb:GetAxis(1):IsClose(axisX))");
        script->Execute("obb.halfLengthX = 2");
        script->Execute("AZTestAssertFloatClose(obb.halfLengthX, 2)");
        script->Execute("obb.halfLengthY = 3");
        script->Execute("AZTestAssertFloatClose(obb.halfLengthY, 3)");
        script->Execute("obb.halfLengthZ = 4");
        script->Execute("AZTestAssertFloatClose(obb.halfLengthZ, 4)");
        ...
        script->Execute("obb.position = position");
        script->Execute("AZTestAssert(obb:IsFinite())");
        script->Execute("obb.axisX = infiniteV3");
        script->Execute("AZTestAssert( not obb:IsFinite())");
        script->Execute("obb.axisX = axisX");
        script->Execute("AZTestAssert(obb:IsFinite())");
        script->Execute("obb.halfLengthY = infinity");
        script->Execute("AZTestAssert( not obb:IsFinite())");
    }

    TEST_F(ScriptMathTest, MathHelpersTest)
    {
