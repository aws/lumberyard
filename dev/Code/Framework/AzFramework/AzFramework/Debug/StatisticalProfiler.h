...
namespace AzFramework
{
    namespace Debug
    {
        ...
        public:
            ...
            AzFramework::Statistics::StatisticsManager<StatIdType>& GetStatsManager()
            {
            ...
            double SummarizePerFrameStats()
            {
                ...
                for (StatisticalAggregate& aggregate : m_perFrameAggregates)
                {
                    ...
                    for (const AzFramework::Statistics::NamedRunningStatistic* stat : aggregate.m_statsForPerFrameCalculation)
                    {
            ...
            void LogAndResetStats(const char* windowName)
            {
                ...
                for (AzFramework::Statistics::NamedRunningStatistic* stat : m_statsVector)
                {
            ...
            {
                AZStd::scoped_lock<MutexType> lock(m_mutex);
                AzFramework::Statistics::NamedRunningStatistic* stat = m_statisticsManager.GetStatistic(statId);
                if (!stat)
                {
                    return;
                }
            ...
            const AzFramework::Statistics::NamedRunningStatistic* GetStatistic(const StatIdType& statId)
            {
            ...
            const AzFramework::Statistics::NamedRunningStatistic* GetFirstStatPerFrame() const
            {
                if (m_perFrameAggregates.size() < 1)
                {
                    return nullptr;
        ...
        protected:
            ...
            MutexType m_mutex;
            AzFramework::Statistics::StatisticsManager<StatIdType> m_statisticsManager;
            AZStd::vector<AzFramework::Statistics::NamedRunningStatistic*> m_statsVector;
            ...
            struct StatisticalAggregate
            {
                ...
                AzFramework::Statistics::NamedRunningStatistic* m_statPerFrame;
                AZStd::vector<AzFramework::Statistics::NamedRunningStatistic*> m_statsForPerFrameCalculation;
