...
#include <AzFramework/Debug/StatisticalProfiler.h>
...
#define AZ_PROFILE_SCOPE(profiler, scopeNameId) \
    ...
    AzFramework::Debug::StatisticalProfilerProxy::TimedScope AZ_JOIN(scope, __LINE__)(profiler, AZ_JOIN(blockName, __LINE__));
