...
namespace AzFramework
{
    ...
    public:
        ...
        /// @deprecated SetDC has been moved to a new EBus - DisplayContextRequestBus, please use this instead.
        AZ_DEPRECATED(, "SetDC has been moved to a new EBus - DisplayContextRequestBus, please use this instead.")
        virtual void SetDC(DisplayContext* dc) { (void)dc; }
        /// @deprecated GetDC has been moved to a new EBus - DisplayContextRequestBus, please use this instead.
        AZ_DEPRECATED(, "GetDC has been moved to a new EBus - DisplayContextRequestBus, please use this instead.")
        virtual DisplayContext* GetDC() { return nullptr; }

    protected:
        ~EntityDebugDisplayRequests() = default;
    };

    /// Inherit from EntityDebugDisplayRequestBus::Handler to implement the EntityDebugDisplayRequests interface.
    DEPRECATE_EBUS(EntityDebugDisplayRequests, EntityDebugDisplayRequestBus, "EntityDebugDisplayRequestBus has been deprecated in favor of DebugDisplayRequestBus");
    ...
    public:
        ...
        /// @deprecated DisplayEntity(bool& handled) has been replaced in favor of
        /// void DisplayEntityViewport(const ViewportInfo&, DebugDisplayRequests&)
        /// Provide viewport drawing for a particular entity.
        AZ_DEPRECATED(,
            "DisplayEntity(bool& handled) has been deprecated - Please use "
            "DisplayEntityViewport(const ViewportInfo&, DebugDisplayRequests&).")
        virtual void DisplayEntity(bool& /*handled*/) {}
