...
namespace AzFramework
{
    namespace RenderGeometry
    {
        ...
        AZ::Aabb Intersector::CalculateEntityGeometryBounds(AZ::EntityId entityId)
        {
            AZ::EBusReduceResult<AZ::Aabb, AabbUnionAggregator> aabbResult(AZ::Aabb::CreateNull());
            IntersectionRequestBus::EventResult(aabbResult, { entityId, m_contextId }, &IntersectionRequests::GetGeometryBounds);
        ...
        RayResult Intersector::CalculateRayAgainstEntityDataList(const RayRequest& ray, EntityDataList& entityDataList)
        {
            ...
            AZStd::sort(m_candidatesSortedByDist.begin(), m_candidatesSortedByDist.end(),
        ...
        void Intersector::UpdateDirtyEntities()
        {
            ...
            {
                m_registeredEntities.Update({ entityId, CalculateEntityGeometryBounds(entityId) });
            }
