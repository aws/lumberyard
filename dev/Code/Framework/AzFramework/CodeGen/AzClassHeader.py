...
class AzClassHeader_Driver(TemplateDriver):
    ...
    def render_templates(self, input_file, **template_kwargs):
        ...
        self.render_template_to_file("AzClassHeader.tpl", template_kwargs, '{}.generated.h'.format(input_file_name))


# Factory function - called from launcher
def create_drivers(env):
    return [AzClassHeader_Driver(env)]
