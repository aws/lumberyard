...
class AzClassInline_Driver(TemplateDriver):
    ...
    def render_templates(self, input_file, **template_kwargs):
        ...
        self.render_template_to_file("AzClassInline.tpl", template_kwargs, '{}.generated.inline'.format(input_file_name))


# Factory function - called from launcher
def create_drivers(env):
    return [AzClassInline_Driver(env)]
