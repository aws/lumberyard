...
class AzComponentCPP_Driver(TemplateDriver):
    ...
    def render_templates(self, input_file, **template_kwargs):
        ...
        self.render_template_to_file("AzComponentCpp.tpl", template_kwargs, '{}.generated.cpp'.format(input_file_name))


# Factory function - called from launcher
def create_drivers(env):
    return [AzComponentCPP_Driver(env)]
