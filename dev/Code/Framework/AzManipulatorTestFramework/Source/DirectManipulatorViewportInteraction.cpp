...
namespace AzManipulatorTestFramework
{
    ...
    //! Implementation of the viewport interaction interface using direct access to the manipulator manager.
    class DirectCallViewportInteraction
        : public ViewportInteraction
    {
    public:
        DirectCallViewportInteraction(AzToolsFramework::ManipulatorManager* manipulatorManager);
    private:
        AzToolsFramework::ManipulatorManager* m_manipulatorManager;
    };
    ...
    DirectCallViewportInteraction::DirectCallViewportInteraction(
        AzToolsFramework::ManipulatorManager* manipulatorManager)
        : m_manipulatorManager(manipulatorManager)
    {
    }
    ...
    DirectCallManipulatorViewportInteraction::DirectCallManipulatorViewportInteraction()
        ...
        , m_viewportInteraction(AZStd::make_unique<DirectCallViewportInteraction>(m_customManager.get()))
    ...
    ViewportInteractionInterface& DirectCallManipulatorViewportInteraction::GetViewportInteraction()
    {
        return *m_viewportInteraction;
    }

    ManipulatorManagerInterface& DirectCallManipulatorViewportInteraction::GetManipulatorManager()
    {
