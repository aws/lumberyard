...
namespace AzQtComponents
{
    ...
    public:
        enum Mode
        {
            ...
            Mode_Whitelisted = 1, // Nice window decorations for hardcoded types (QMessageBox, QInputDialog (add more as you wish))
        ...
        // The default is Mode_Whitelisted
        void setMode(Mode);
    protected:
        bool eventFilter(QObject* watched, QEvent* ev) override;
    private:
        void ensureCustomWindowDecorations(QWidget* w);
        Mode m_mode = Mode_Whitelisted;
    };
} // namespace AzQtComponents
