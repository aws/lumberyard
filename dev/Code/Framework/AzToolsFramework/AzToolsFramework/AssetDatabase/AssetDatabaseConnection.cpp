...
namespace AzToolsFramework
{
    namespace AssetDatabase
    {
        ...
        namespace
        {
            ...
            static const char* CREATE_UNRESOLVED_PRODUCT_DEPENDENCIES_TEMP_TABLE = "AssetProcessor::CreateUnresolvedProductDependenciesTempTable";
            ...
            static const auto s_createUnresolvedProductDependenciesTempTable = MakeSqlQuery(CREATE_UNRESOLVED_PRODUCT_DEPENDENCIES_TEMP_TABLE,
            ...
            static const auto s_queryInsertProductDependencyTempTableValues = MakeSqlQuery(INSERT_PRODUCT_DEPENDENCY_TEMP_TABLE_VALUES, INSERT_PRODUCT_DEPENDENCY_TEMP_TABLE_VALUES_STATEMENT, LOG_NAME,
                SqlParam<const char*>(":filename"));

            static const char* GET_UNRESOLVED_PRODUCT_DEPENDENCIES_USING_TEMP_TABLE = "AssetProcessor::GetUnresolvedProductDependenciesUsingTempTable";
            ...
            static const auto s_queryGetUnresolvedProductDependenciesUsingTempTable = MakeSqlQuery(GET_UNRESOLVED_PRODUCT_DEPENDENCIES_USING_TEMP_TABLE, GET_UNRESOLVED_PRODUCT_DEPENDENCIES_USING_TEMP_TABLE_STATEMENT, LOG_NAME);
        ...
        bool AssetDatabaseConnection::QueryProductDependenciesUnresolvedAdvanced(const AZStd::vector<AZStd::string>& searchPaths, productDependencyAndPathHandler handler)
        {
            ...
            {
                result = s_queryInsertProductDependencyTempTableValues.BindAndStep(*m_databaseConnection, path.c_str())
                    && result;
            }

            result = s_queryGetUnresolvedProductDependenciesUsingTempTable.BindAndQuery(*m_databaseConnection, handler, &GetProductDependencyAndPathResult)
                && result;
        ...
        namespace
        {
            ...
            bool GetProductDependencyAndPathResult([[maybe_unused]] const char* callName, Statement* statement, AssetDatabaseConnection::productDependencyAndPathHandler handler)
            {
                Statement::SqlStatus result = statement->Step();
