...
namespace AzToolsFramework
{
    ...
    void CreateSliceCommand::Redo()
    {
        ...
        AzToolsFramework::EditorEntityContextRequestBus::BroadcastResult(sliceInstanceResult, &AzToolsFramework::EditorEntityContextRequestBus::Events::PromoteEditorEntitiesIntoSlice, sliceAsset, m_liveToAssetMap);
    }
    ...
    AZ::Data::Asset<AZ::SliceAsset> CreateSliceCommand::PreloadSliceAsset()
    {
        ...
        AZ::Data::Asset<AZ::SliceAsset> sliceAsset = AZ::Data::AssetManager::Instance().GetAsset<AZ::SliceAsset>(m_sliceAssetId, false);
