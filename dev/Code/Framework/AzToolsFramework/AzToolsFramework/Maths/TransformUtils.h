...
namespace AzToolsFramework
{
    ...
    inline AZ::Transform TransformNormalizedScale(const AZ::Transform& transform)
    {
        ...
        transformNormalizedScale.ExtractScaleExact();
    ...
    inline AZ::Transform TransformUniformScale(const AZ::Transform& transform)
    {
        ...
        const AZ::VectorFloat maxScale = transformUniformScale.ExtractScaleExact().GetMaxElement();
    ...
    {
        return AZ::Quaternion::CreateFromTransform(TransformNormalizedScale(transform)).GetNormalizedExact();
    }
    ...
    {
        return (QuaternionFromTransformNoScaling(transform) * direction).GetNormalizedSafeExact();
    }
    ...
    {
        return transform.GetTranslation() + QuaternionFromTransformNoScaling(transform) * position;
    }
} // namespace AzToolsFramework