    ...
    namespace SliceUtilities
    {
                          ...
                          AZ::SerializeContext* serializeContext)
        {
            ...
            { 
                ...
                for (const AZ::Entity* entity : entityObjectsToInclude)
                {
                    ...
                    newParentWorldTM.SetPosition(sliceRootEntityPosition);
        ...
        */
        ...
        void ReparentNonTrivialSliceInstanceHierarchy(const AZ::EntityId& entityId, const AZ::EntityId& newParentId)
        {
            ...
            AzToolsFramework::EditorEntityContextRequestBus::Broadcast(&AzToolsFramework::EditorEntityContextRequestBus::Events::DetachSubsliceInstances, subslicesToDetach);

            AzToolsFramework::EditorEntityContextRequestBus::Broadcast(&AzToolsFramework::EditorEntityContextRequestBus::Events::DetachSliceEntities, entitiesToDetach);
        ...
        namespace Internal
        {
                ...
                AzToolsFramework::EntityIdList& entitiesToDetach)
            {
                ...
                AzFramework::EntityIdContextQueryBus::EventResult(sourceSliceInstance, rootEntity, &AzFramework::EntityIdContextQueryBus::Events::GetOwningSlice);
