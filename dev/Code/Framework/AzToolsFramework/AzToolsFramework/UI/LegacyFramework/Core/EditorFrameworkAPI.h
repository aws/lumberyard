...
namespace LegacyFramework
{
    ...
    */
    ...
    public:
        ...
        * this happens INSTEAD of run, if you are a secondary instance of an application instead of the master.
        * by default, the UI Framework, when it gets this, sends the "open" message to the main master instance for every misc value on its command line
        * causing the master to attempt to open it instead of ourselves.
        * you can also implement this yourself in order to send messages to the master (if you wish).
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** this is true if you are the first, 'master' instance running.
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** call this to send an IPC command to the master
        * you can only do this if you're not a master.  It can be any command you'd like the master to perform as long as ther is a handler
