...
namespace UnitTest
{
    ...
    {
    protected:
        AZStd::unique_ptr<AZ::SerializeContext> m_serializeContext = nullptr;
        AZStd::unique_ptr<AZ::ComponentDescriptor> m_sliceDescriptor = nullptr;
        AZStd::unique_ptr<SliceUpgradeTest_MockCatalog> m_mockCatalog = nullptr;
    ...
    public:
        ...
        void SaveRawSliceAssetXML(AZ::Data::AssetId sliceAssetId, const char* sliceStr, size_t sliceStrSize)
        {
            ...
            AZ::Data::Asset<AZ::SliceAsset> sliceAssetHolder = AZ::Data::AssetManager::Instance().CreateAsset<AZ::SliceAsset>(assetInfo.m_assetId);
