...
protected:
    ...
    void SetUp() override
    {
        ...
        m_root = "Z:\\Dummy";
        m_application->NormalizePathKeepCase(m_root);
        m_application->SetAssetRoot(m_root.c_str());
    }
...
TEST_F(ApplicationTest, MakePathAssetRootRelative_AbsPath_Valid)
{
    ...
    AzFramework::StringFunc::Path::ConstructFull(m_root.c_str(), "TestA.txt", inputPath, true);
...
TEST_F(ApplicationTest, MakePathRelative_AbsPath_Valid)
{
    AZStd::string inputPath;
    AzFramework::StringFunc::Path::ConstructFull(m_root.c_str(), "TestA.txt", inputPath, true);
    m_application->MakePathRelative(inputPath, m_root.c_str());
    EXPECT_EQ(inputPath, "TestA.txt");
}
...
{
    AZStd::string inputPath;
    AzFramework::StringFunc::Path::ConstructFull(m_root.c_str(), "Foo/TestA.txt", inputPath, true);
    m_application->MakePathAssetRootRelative(inputPath);
