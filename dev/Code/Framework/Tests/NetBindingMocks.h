...
namespace UnitTest
{
    ...
    public:
        ...
        MOCK_METHOD1(MarkEntityForNoActivation, void (AZ::EntityId));
    ...
    public:
        ...
        MOCK_METHOD3(LoadAssetData, bool (const AZ::Data::Asset<AZ::Data::AssetData>&, AZ::IO::GenericStream*, const AZ::Data::AssetFilterCB&));
        MOCK_METHOD3(LoadAssetData, bool (const AZ::Data::Asset<AZ::Data::AssetData>&, const char*, const AZ::Data::AssetFilterCB&));
    ...
    public:
        ...
        MOCK_METHOD0(GetExecutableFolder, const char* ());
