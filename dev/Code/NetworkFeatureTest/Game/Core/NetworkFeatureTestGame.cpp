...
#include "NetworkFeatureTestGame.h"
...
NetworkFeatureTestGame* LYGame::g_Game = nullptr;

//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////

NetworkFeatureTestGame::NetworkFeatureTestGame()
...
bool NetworkFeatureTestGame::Init(IGameFramework* framework)
{
    ...
    REGISTER_FACTORY(framework, "NetworkFeatureTestGameRules", NetworkFeatureTestGameRules, false);
    IGameRulesSystem* pGameRulesSystem = g_Game->GetIGameFramework()->GetIGameRulesSystem();
    pGameRulesSystem->RegisterGameRules("DummyRules", "NetworkFeatureTestGameRules");
...
bool NetworkFeatureTestGame::CompleteInit()
{
...
int NetworkFeatureTestGame::Update(bool hasFocus, unsigned int updateFlags)
{
...
void NetworkFeatureTestGame::PlayerIdSet(EntityId playerId)
{
    m_clientEntityId = playerId;
}

void NetworkFeatureTestGame::Shutdown()
{
    this->~NetworkFeatureTestGame();
}

void NetworkFeatureTestGame::LoadActionMaps(const char* fileName)
{
...
void NetworkFeatureTestGame::ReleaseActionMaps()
{
...
bool NetworkFeatureTestGame::ReadProfile(const XmlNodeRef& rootNode)
{
...
bool NetworkFeatureTestGame::ReadProfilePlatform(const XmlNodeRef& platformsNode, LYGame::Platform platformId)
{
    bool successful = false;
    ...
    if (platformsNode && (platformId > ePlatform_Unknown) && (platformId < ePlatform_Count))
    {
        ...
        {
            GameWarning("NetworkFeatureTestGame::ReadProfilePlatform: Failed to find platform, action mappings loading will fail");
        }
    }
...
LYGame::Platform NetworkFeatureTestGame::GetPlatform() const
{
...
void NetworkFeatureTestGame::OnActionEvent(const SActionEvent& event)
{
