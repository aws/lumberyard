...
//////////////////////////////////////////////////////////////////////////
void Q2DViewport::OnRButtonUp(Qt::KeyboardModifiers modifiers, const QPoint& point)
{
    ReleaseMouse();
...
//////////////////////////////////////////////////////////////////////////
void Q2DViewport::OnMouseWheel(Qt::KeyboardModifiers, short zDelta, const QPoint& pt)
{
...
//////////////////////////////////////////////////////////////////////////
void Q2DViewport::SetScrollOffset(float x, float y, bool bLimits)
{
...
//////////////////////////////////////////////////////////////////////////
QPoint Q2DViewport::WorldToViewParticleEditor(const Vec3& wp, int width, int height) const //Eric@conffx implement for the children class of IDisplayViewport
{
    Vec3 sp = m_screenTM.TransformPoint(wp);
    QPoint p = QPoint(sp.x, sp.y);
    return p;
...
//////////////////////////////////////////////////////////////////////////
float Q2DViewport::GetScreenScaleFactor(const Vec3& worldPoint) const
{
...
//////////////////////////////////////////////////////////////////////////
void Q2DViewport::MakeConstructionPlane(int axis)
{
...
//////////////////////////////////////////////////////////////////////////
void Q2DViewport::OnDragSelectRectangle(const QRect &rect, bool bNormalizeRect)
{
    Vec3 org;
    AABB box;
    box.Reset();
