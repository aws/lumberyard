...
#ifndef CRYINCLUDE_EDITOR_AI_NAVDATAGENERATION_SHAPE_H
#define CRYINCLUDE_EDITOR_AI_NAVDATAGENERATION_SHAPE_H
#pragma once
...
public:
    ...
    bool IntersectLineSeg(const Vec3& start, const Vec3& end, float& tmin, Vec3* outClosestPoint = 0, Vec3* outNormal = 0, bool bForceNormalOutwards = false) const;
...
#endif // CRYINCLUDE_EDITOR_AI_NAVDATAGENERATION_SHAPE_H
