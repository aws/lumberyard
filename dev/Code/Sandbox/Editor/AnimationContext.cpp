...
void CAnimationContext::AnimateActiveSequence()
{
    ...
    {
        CEntityObject* pCameraObject = static_cast<CEntityObject*>(pRenderViewport->GetCameraObject());
        ac.m_activeCameraEntity = pCameraObject ? pCameraObject->GetEntityId() : 0;
    }
