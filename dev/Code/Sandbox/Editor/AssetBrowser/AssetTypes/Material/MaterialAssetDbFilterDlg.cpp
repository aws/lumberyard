...
#include <AssetBrowser/AssetTypes/Material/ui_MaterialAssetDbFilterDlg.h>

// CMaterialAssetDbFilterDlg dialog

CMaterialAssetDbFilterDlg::CMaterialAssetDbFilterDlg(QWidget* pParent /*=NULL*/)
    : QWidget(pParent)
    , ui(new Ui::MaterialAssetDbFilterDlg)
{
    ui->setupUi(this);
}
...
#include <AssetBrowser/AssetTypes/Material/MaterialAssetDbFilterDlg.moc>