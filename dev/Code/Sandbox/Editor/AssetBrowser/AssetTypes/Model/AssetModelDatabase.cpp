...
const char* CAssetModelDatabase::GetSupportedExtensions() const
{
    return "cgf";
};
...
QWidget* CAssetModelDatabase::CreateDbFilterDialog(QWidget* pParent, IAssetViewer* pViewerCtrl)
{
    CModelAssetDbFilterDlg* pDlg = new CModelAssetDbFilterDlg(pParent);
    pDlg->SetAssetViewer(pViewerCtrl);

    return pDlg;
}

void CAssetModelDatabase::UpdateDbFilterDialogUI(QWidget* pDlg)
{
    CModelAssetDbFilterDlg* pFilterDlg = (CModelAssetDbFilterDlg*)pDlg;
