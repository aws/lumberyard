...
void CColorGradientCtrl::DrawGradient(QPaintEvent* e, QPainter* painter)
{
    ...
    QPen pen(QColor(128, 255, 128), 1, Qt::SolidLine);
    painter->setPen(pen);
...
void CColorGradientCtrl::OnLButtonDown(QMouseEvent* event)
{
    if (m_bTracking)
    {
        return;
...
//////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::OnRButtonDown(QMouseEvent* event)
{
}
...
//////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::OnRButtonUp(QMouseEvent* event)
{
    if (!m_pSpline)
    {
        return;
...
#include <Controls/ColorGradientCtrl.moc>
