...
//////////////////////////////////////////////////////////////////////////
bool CImageListCtrl::isIndexHidden(const QModelIndex& index) const
{
    return false; /* not supported */
}

//////////////////////////////////////////////////////////////////////////
QModelIndex CImageListCtrl::moveCursor(CursorAction cursorAction, Qt::KeyboardModifiers modifiers)
{
    if (!model())
    {
        return QModelIndex();
...
#include <Controls/ImageListCtrl.moc>