...
//////////////////////////////////////////////////////////////////////////
void CSplineCtrl::resizeEvent(QResizeEvent* event)
{
    m_rcSpline = rect();
...
void CSplineCtrl::OnLButtonDown(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    if (m_bTracking)
    {
        return;
...
//////////////////////////////////////////////////////////////////////////
void CSplineCtrl::OnRButtonDown(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    setFocus();
...
//////////////////////////////////////////////////////////////////////////
void CSplineCtrl::OnLButtonUp(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    if (!m_pSpline)
    {
        return;
...
CSplineCtrl::EHitCode CSplineCtrl::HitTest(const QPoint& point)
{
    ...
    if (abs(splinePt.y() - point.y()) < 4)
    {
        ...
        for (int i = 0; i < m_pSpline->GetKeyCount(); i++)
        {
            const QPoint splinePt = TimeToPoint(m_pSpline->GetKeyTime(i));
...
#include <Controls/SplineCtrl.moc>
