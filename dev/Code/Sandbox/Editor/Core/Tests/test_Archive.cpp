...
TEST(CArchive, test2ByteLengthString)
{
    ...
    const char* data = dataBuffer.constData();
    EXPECT_EQ(data[0], aznumeric_cast<char>(0xff));
    short shortLength = 0;
...
TEST(CArchive, test4ByteLengthString)
{
    ...
    const char* data = dataBuffer.constData();
    EXPECT_EQ(data[0], aznumeric_cast<char>(0xff));
    EXPECT_EQ(data[1], aznumeric_cast<char>(0xff));
    EXPECT_EQ(data[2], aznumeric_cast<char>(0xff));
...
TEST(CArchive, testWindowsWideCharacterString1ByteLength)
{
    ...
    testBuffer[0] = aznumeric_cast<char>(0xff);
    testBuffer[1] = aznumeric_cast<char>(0xfe);
    testBuffer[2] = aznumeric_cast<char>(0xff);
...
TEST(CArchive, testWindowsWideCharacterString2ByteLength)
{
    ...
    testBuffer[1] = aznumeric_cast<char>(0xfe);
    testBuffer[2] = aznumeric_cast<char>(0xff);
    testBuffer[3] = aznumeric_cast<char>(0xff);
