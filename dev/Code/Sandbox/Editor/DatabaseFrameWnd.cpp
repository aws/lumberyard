...
AssetSelectionModel CDatabaseFrameWnd::GetAssetSelectionModel() const
{
    // By default return prefabs asset type
    return AssetSelectionModel::AssetTypeSelection("Prefabs Library");
}
...
bool LibraryItemTreeModel::DoesGroupExist(const QString& groupName) const
{
#if 0
    auto it = std::find_if(
...
bool LibraryItemTreeModel::dropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& index)
{
