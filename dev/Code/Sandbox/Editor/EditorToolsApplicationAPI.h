...
namespace EditorInternal
{
    ...
    public:
        ...
        virtual int CreateLevel(AZStd::string_view levelName, int resolution, int unitSize, bool bUseTerrain) = 0;
        virtual int CreateLevelNoPrompt(AZStd::string_view levelName, int heightmapResolution, int heightmapUnitSize, int terrainExportTextureSize, bool useTerrain) = 0;
