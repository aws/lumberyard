...
bool QLensFlareAtomicListModel::dropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent)
{
    return false;
}
...
#include <LensFlareEditor/LensFlareAtomicList.moc>
