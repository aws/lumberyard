...
public:
    ...
    MOCK_METHOD0(GetMasterCDFolder, QString());
    ...
    MOCK_METHOD1(StartObjectCreation, void(const QString&));
    MOCK_METHOD2(StartObjectCreation, void(const QString&, const QString&));
    ...
    MOCK_METHOD0(GetEntityProtManager, CEntityPrototypeManager*());
    ...
    MOCK_METHOD0(GetParticleManager, IEditorParticleManager* ());
    ...
    MOCK_METHOD0(GetTerrainManager, class CTerrainManager* ());
    ...
    MOCK_METHOD0(GetMissingAssetResolver, IMissingAssetResolver* ());
    ...
    MOCK_METHOD1(UpdateSequencer, void(bool));
    ...
    MOCK_METHOD1(SelectRollUpBar, int(int rollupBarId));
    MOCK_METHOD5(AddRollUpPage, int(int, const QString&, QWidget*, int, bool));
    MOCK_METHOD2(RemoveRollUpPage, void(int, int));
    MOCK_METHOD3(RenameRollUpPage, void(int, int, const char* ));
    MOCK_METHOD3(ExpandRollUpPage, void(int, int, bool ));
    MOCK_METHOD3(EnableRollUpPage, void(int, int, bool));
    MOCK_METHOD1(GetRollUpPageCount, int(int ));
    ...
    MOCK_METHOD2(OpenDataBaseLibrary, CBaseLibraryDialog* (EDataBaseItemType , IDataBaseItem*));
    ...
    MOCK_METHOD1(SetAWSResourceManager, void(IAWSResourceManager* ));
    MOCK_METHOD0(GetAWSResourceManager, IAWSResourceManager* ());
    MOCK_METHOD1(LaunchAWSConsole, void(QString ));
    MOCK_METHOD3(ToProjectConfigurator, bool(const QString& , const QString& , const QString& ));
    ...
    MOCK_METHOD0(GetAssetBrowser, IAssetBrowser* ());
    MOCK_METHOD0(GetImageUtil, IImageUtil* ());
    MOCK_METHOD0(GetEditorSettings, SEditorSettings* ());
    MOCK_METHOD0(GetLogFile, ILogFile* ());  
    MOCK_METHOD1(UnloadPlugins, void(bool ));
    MOCK_METHOD0(LoadPlugins, void());
    MOCK_METHOD1(BaseObjectFromEntityId, CBaseObject* (unsigned int));
    MOCK_METHOD0(IsLegacyUIEnabled, bool());
    MOCK_METHOD1(SetLegacyUIEnabled, void(bool));
