...
void CMaterialImageListCtrl::resizeEvent(QResizeEvent* event)
{
    m_resizeTimer->stop();
...
void CMaterialImageListCtrl::setModel(QAbstractItemModel* model)
{
    ...
    connect(model, SIGNAL(dataChanged(const QModelIndex&, const QModelIndex&, const QVector<int>&)), this, SLOT(ModelDataChanged(const QModelIndex&)));
}
...
//////////////////////////////////////////////////////////////////////////
void CMaterialImageListCtrl::OnSystemEvent(ESystemEvent event, UINT_PTR wparam, UINT_PTR lparam)
{
    switch (event)
    {
...
#include <Material/MaterialImageListCtrl.moc>
