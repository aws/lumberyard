...
{
    GUID m_modifiedObjectGuidInPrefab; //! The object that was modified identified by guid in the prefab
    ...
    SObjectChangedContext(EObjectChangedOpType optype)
        : m_modifiedObjectGuidInPrefab(GUID_NULL)
...
struct IBaseObject
{
    virtual void SetLayerModified() = 0;
};
...
public:
    ...
    */
    ...
    // Layer support.
    //////////////////////////////////////////////////////////////////////////
    virtual bool SupportsLayers() const { return true; }
    void SetLayer(CObjectLayer* layer);
    CObjectLayer* GetLayer() const { return m_layer; };
    virtual void OnLayerChanged(CObjectLayer* layer) { (void)layer; }
    //  IBaseObject Overrides
    void SetLayerModified() override;
    //~ IBaseObject Overrides
    ...
    REFGUID GetIdInPrefab() const { return m_guidInPrefab; }
    void SetIdInPrefab(REFGUID guid) { m_guidInPrefab = guid; }
    ...
    virtual bool GetUntransformedScale(Vec3& scale) const {   return false;   }
    virtual bool TransformScale(const Vec3& scale)                {   return false;   }
    ...
    void GetAllPrefabFlagedChildren(TBaseObjects& outAllChildren, CBaseObject* pObj = NULL) const;
    void GetAllPrefabFlagedChildren(CSelectionGroup& outAllChildren, CBaseObject* pObj = NULL) const;
    //! Clone Children
    ...
    //! Flags is combination of ObjectEditFlags flags.
    ...
    //! Determine if this object can be grouped
    virtual bool IsGroupable() { return true; }
    ...
    // Statistics
    //////////////////////////////////////////////////////////////////////////
    virtual QString GetMouseOverStatisticsText() const { return QString(); }
...
protected:
    ...
    */
    ...
    // Instead of adding and removing all variables, it just updates the existing ones
    // in a panel. This function was created for use in event handling code, such as
    // update events that could crash when using UpdateUIVars due to its DeleteVars().
    void RefreshUIPanel();

    //////////////////////////////////////////////////////////////////////////
    // Insert a new QWidget based page into the roll up bar
    virtual int AddUIPage(const char* sCaption, QWidget* pDialog, int iIndex = -1, bool bAutoExpand = true);
    // Remove a dialog page from the roll up bar
    virtual void RemoveUIPage(int iIndex);
    // Rename a dialog page in the roll up bar
    void RenameUIPage(int iIndex, const char* pNewName);
    //////////////////////////////////////////////////////////////////////////
