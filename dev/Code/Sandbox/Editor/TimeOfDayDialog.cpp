...
//////////////////////////////////////////////////////////////////////////
void CTimeOfDayDialog::OnSystemEvent(ESystemEvent event, UINT_PTR wparam, UINT_PTR lparam)
{
...
void CTimeOfDayDialog::resizeEvent(QResizeEvent* event)
{
    if (m_ui->spline->GetSplineCount() == 0)
    {
        m_ui->spline->FitSplineToViewWidth();
