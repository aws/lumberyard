...
void UndoStackItemSelectionModel::select(const QItemSelection& selection, QItemSelectionModel::SelectionFlags command)
{
...
void CUndoDropDown::SelectionChanged(const QItemSelection& selected, const QItemSelection& deselected)
{
