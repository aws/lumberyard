...
bool CubemapUtils::GenCubemapWithObjectPathAndSize(QString& filename, CBaseObject* pObject, const int size, const bool hideObject)
{
    ...
    if (pObject->GetType() != OBJTYPE_ENTITY && pObject->GetType() != OBJTYPE_BRUSH && pObject->GetType() != OBJTYPE_AZENTITY)
    {
...
void CubemapUtils::RegenerateAllEnvironmentProbeCubemaps()
{
    ...
    GetIEditor()->GetObjectManager()->FindObjectsOfType(&CEnvironementProbeObject::staticMetaObject, results);
