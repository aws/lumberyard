...
//////////////////////////////////////////////////////////////////////////
bool CVariableBase::StartResolveRequest(char type, const char* value, const TMissingAssetResolveCallback& cb)
{
    return GetIEditor()->GetMissingAssetResolver()->AddResolveRequest(value, cb, type) != 0;
}

//////////////////////////////////////////////////////////////////////////
void CVariableBase::CancelResolveRequest(const TMissingAssetResolveCallback& cb)
{
    GetIEditor()->GetMissingAssetResolver()->CancelRequest(cb);
}
