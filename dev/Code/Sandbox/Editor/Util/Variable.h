...
public:
    ...
    void Set(double value)                { assert(0); }
    ...
    void Set(const QString& value)        { assert(0); }
    ...
    void Get(double& value) const     { assert(0); }
    ...
    void Get(QString& value) const    { assert(0); }
...
protected:
    ...
    bool StartResolveRequest(char type, const char* value, const TMissingAssetResolveCallback& cb);
    void CancelResolveRequest(const TMissingAssetResolveCallback& cb);
...
protected:
    ...
    //////////////////////////////////////////////////////////////////////////
    template <class P>
    void SetValue(const P& value, bool bResolve = true)
    {
        T newValue = T();
    ...
    template <class P>
    inline void InitAssetResolver(const P& value)
    {
    }

    inline void InitAssetResolver(const QString& value)
    {
        if (m_bResolving)
        {
    ...
    void OnResolved(uint32 id, bool success, const char* orgVal, const char* newVal)
    {
        if (success)
        {
            SetValue(QString::fromLatin1(newVal), false);
        }
    }
