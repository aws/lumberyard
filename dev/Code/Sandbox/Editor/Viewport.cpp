...
//////////////////////////////////////////////////////////////////////////
void QtViewport::OnMouseWheel(Qt::KeyboardModifiers modifiers, short zDelta, const QPoint& pt)
{
    if (zDelta != 0)
    {
...
//////////////////////////////////////////////////////////////////////////
void QtViewport::paintEvent(QPaintEvent* event)
{
...
//////////////////////////////////////////////////////////////////////////
Vec3 QtViewport::WorldToView3D(const Vec3& wp, int nFlags) const
{
...
//////////////////////////////////////////////////////////////////////////
Vec3    QtViewport::ViewToWorldNormal(const QPoint& vp, bool onlyTerrain, bool bTestRenderMesh)
{
    return Vec3(0, 0, 0);
}

//////////////////////////////////////////////////////////////////////////
void    QtViewport::ViewToWorldRay(const QPoint& vp, Vec3& raySrc, Vec3& rayDir) const
{
    raySrc(0, 0, 0);
    rayDir(0, 0, -1);
}
...
//////////////////////////////////////////////////////////////////////////
bool QtViewport::IsBoundsVisible(const AABB& box) const
{
