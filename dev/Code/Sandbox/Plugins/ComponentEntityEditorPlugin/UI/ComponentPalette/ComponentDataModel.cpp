...
QModelIndex ComponentDataModel::parent(const QModelIndex &child) const
{
    return QModelIndex();
}

int ComponentDataModel::rowCount(const QModelIndex &parent /*= QModelIndex()*/) const
{
    return m_componentList.size();
}

int ComponentDataModel::columnCount(const QModelIndex &parent /*= QModelIndex()*/) const
{
...
bool ComponentDataProxyModel::filterAcceptsRow(int sourceRow, const QModelIndex &sourceParent) const
{
...
#include "UI/ComponentPalette/ComponentDataModel.moc"