...
float CDisplayViewportAdapter::GetScreenScaleFactor(const CCamera& camera, const Vec3& object_position)
{
    return 1;
}
...
bool CDisplayViewportAdapter::IsBoundsVisible(const AABB& box) const
{
    return false;
}
...
QPoint CDisplayViewportAdapter::WorldToViewParticleEditor(const Vec3& worldPoint, int width, int height) const
{
    return m_viewport->ProjectToScreen(worldPoint);
}

Vec3 CDisplayViewportAdapter::WorldToView3D(const Vec3& worldPoint, int flags) const
{
...
void CDisplayViewportAdapter::ScreenToClient(QPoint& pt) const
{
}
...
void CDisplayViewportAdapter::setRay(QPoint& vp, Vec3& raySrc, Vec3& rayDir)
{
}

void CDisplayViewportAdapter::setHitcontext(QPoint& vp, Vec3& raySrc, Vec3& rayDir)
{
}
