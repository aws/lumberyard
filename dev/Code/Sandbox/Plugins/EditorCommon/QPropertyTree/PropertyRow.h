...
public:
	...
	virtual bool assignTo(const Serialization::SStruct& ser) const{ return false; }
	...
	virtual void setValueAndContext(const Serialization::SStruct& ser, Serialization::IArchive& ar) { serializer_ = ser; }
	...
	virtual void closeNonLeaf(const Serialization::SStruct& ser, Serialization::IArchive& ar) {}
	...
	virtual bool getHoverInfo(PropertyHoverInfo* hit, const QPoint& cursorPos, const QPropertyTree* tree) const { 
	...
	virtual void serializeValue(Serialization::IArchive& ar) {}
