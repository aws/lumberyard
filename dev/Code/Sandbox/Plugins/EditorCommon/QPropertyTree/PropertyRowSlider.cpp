...
bool PropertyRowSliderF::onMouseDown(QPropertyTree* tree, QPoint point, bool& changed)
{
...
void PropertyRowSliderF::setValueAndContext(const Serialization::SStruct& ser, Serialization::IArchive& ar)
{
...
bool PropertyRowSliderI::onMouseDown(QPropertyTree* tree, QPoint point, bool& changed)
{
    if (floorRect(tree).contains(point) && !userReadOnly())
    {
        tree->model()->rowAboutToBeChanged(this);
...
void PropertyRowSliderI::setValueAndContext(const Serialization::SStruct& ser, Serialization::IArchive& ar)
{
