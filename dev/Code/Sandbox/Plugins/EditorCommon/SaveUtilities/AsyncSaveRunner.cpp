...
namespace AZ
{
    ...
    void SaveOperationController::HandleOperationComplete(SaveOperationCache* saveOperation, bool success)
    {
        if (!success)
        {
    ...
    void AsyncSaveRunner::HandleRunnerFinished(SaveOperationController* runner, bool success)
    {
        if (!success)
        {
