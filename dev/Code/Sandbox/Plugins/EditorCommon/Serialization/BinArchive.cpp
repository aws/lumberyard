...
namespace Serialization {
    ...
    bool BinOArchive::operator()(IString& value, const char* name, const char* label)
    {
    ...
    bool BinOArchive::operator()(IWString& value, const char* name, const char* label)
    {
    ...
    bool BinOArchive::operator()(int16& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(int8& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(uint8& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(uint16& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(int32& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(uint32& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(int64& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(uint64& value, const char* name, const char* label)
    {
        openNode(name);
        stream_.write(value);
        closeNode(name);
    ...
    bool BinOArchive::operator()(const SStruct& ser, const char* name, const char* label)
    {
        openNode(name, false);
        ser(*this);
    ...
    bool BinOArchive::operator()(IContainer& ser, const char* name, const char* label)
    {
        openNode(name, false);
    ...
    bool BinOArchive::operator()(IPointer& ptr, const char* name, const char* label)
    {
        openNode(name, false);
    ...
    bool BinIArchive::operator()(IString& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            string str;
    ...
    bool BinIArchive::operator()(IWString& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            wstring str;
    ...
    bool BinIArchive::operator()(int16& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(uint16& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(int32& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(uint32& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(int64& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(uint64& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(int8& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(uint8& value, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            read(value);
    ...
    bool BinIArchive::operator()(const SStruct& ser, const char* name, const char* label)
    {
        if (!strlen(name))
        {
            ser(*this);
    ...
    bool BinIArchive::operator()(IContainer& ser, const char* name, const char* label)
    {
        if (strlen(name))
        {
            if (!openNode(name))
    ...
    bool BinIArchive::operator()(IPointer& ptr, const char* name, const char* label)
    {
