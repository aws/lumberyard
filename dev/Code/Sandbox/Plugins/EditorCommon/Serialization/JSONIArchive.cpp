...
namespace Serialization {
    ...
    bool JSONIArchive::operator()(const SStruct& ser, const char* name, const char* label)
    {
        if (findName(name))
        {
            if (openBracket())
    ...
    bool JSONIArchive::operator()(const SBlackBox& box, const char* name, const char* label)
    {
        if (findName(name))
        {
            if (openBracket() || openContainerBracket())
    ...
    bool JSONIArchive::operator()(IKeyValue& keyValue, const char* name, const char* label)
    {
        Token nextName;
    ...
    bool JSONIArchive::operator()(IPointer& ser, const char* name, const char* label)
    {
        if (findName(name))
        {
            if (openBracket())
    ...
    bool JSONIArchive::operator()(IContainer& ser, const char* name, const char* label)
    {
        if (findName(name))
        {
    ...
    bool JSONIArchive::operator()(int32& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(uint32& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(int16& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(uint16& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(int64& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(uint64& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(IString& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(IWString& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(int8& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
    ...
    bool JSONIArchive::operator()(uint8& value, const char* name, const char* label)
    {
        if (findName(name))
        {
            readToken();
