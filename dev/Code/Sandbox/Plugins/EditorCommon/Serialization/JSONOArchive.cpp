...
namespace Serialization {
    ...
    bool JSONOArchive::operator()(IString& value, const char* name, const char* label)
    {
        placeIndent();
        placeName(name);
        (*buffer_) << "\"";
    ...
    bool JSONOArchive::operator()(IWString& value, const char* name, const char* label)
    {
        placeIndent();
        placeName(name);
        (*buffer_) << "\"";
    ...
    bool JSONOArchive::operator()(int32& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(uint32& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(int16& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(uint16& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(int64& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(uint64& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(uint8& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(int8& value, const char* name, const char* label)
    {
        placeIndentCompact();
        placeName(name);
        (*buffer_) << value;
    ...
    bool JSONOArchive::operator()(const SStruct& ser, const char* name, const char* label)
    {
        placeIndent();
        placeName(name);
    ...
    bool JSONOArchive::operator()(const SBlackBox& box, const char* name, const char* label)
    {
    ...
    bool JSONOArchive::operator()(IKeyValue& keyValue, const char* name, const char* label)
    {
        placeIndent();
    ...
    bool JSONOArchive::operator()(IPointer& ser, const char* name, const char* label)
    {
        placeIndent();
        placeName(name);
        openBracket();
    ...
    bool JSONOArchive::operator()(IContainer& ser, const char* name, const char* label)
    {
        placeIndent();
        placeName(name);
        std::size_t position = buffer_->position();
