    ...
    , m_awsResourceManager(editor)
{
    ...
    gEnv->pLmbrAWS->GetClientManager()->GetEditorClientSettings().credentialProvider =
        Aws::MakeShared<Aws::Auth::ProfileConfigFileAWSCredentialsProvider>("AWSManager", profileName.c_str(), Aws::Auth::REFRESH_THRESHOLD);
