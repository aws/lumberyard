...
namespace ProjectSettingsTool
{
        ...
        , m_validator(nullptr)
    {
        ...
        connect(m_pLineEdit, &QLineEdit::textChanged, this, [this](const QString& text)
            {
    ...
    void PropertyFuncValLineEditCtrl::ConsumeAttribute(AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
    ...
    void PropertyFuncValLineEditHandler::WriteGUIValuesIntoProperty(size_t index, PropertyFuncValLineEditCtrl* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->GetValue().toUtf8().data();
    }

    bool PropertyFuncValLineEditHandler::ReadValuesIntoGUI(size_t index, PropertyFuncValLineEditCtrl* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
...
#include <PropertyFuncValLineEdit.moc>
