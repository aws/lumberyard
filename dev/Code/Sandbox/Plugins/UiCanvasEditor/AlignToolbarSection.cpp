...
void AlignToolbarSection::AddButton(QToolBar* parent, ViewportAlign::AlignType alignType, const QString& iconName, const QString& toolTip)
{
    ...
    QString iconImageHover = QString(":/Icons/%1Hover.png").arg(iconName);
    QString iconImageDisabled = QString(":/Icons/%1Disabled.png").arg(iconName);
    ...
    QObject::connect(button,
        &QPushButton::clicked,
        [ editorWindow, alignType ](bool checked)
        {
