...
//////////////////////////////////////////////////////////////////////////
void SplineWidget::DrawKeys(QPainter* painter, int splineIndex, float startTime, float endTime)
{
...
//////////////////////////////////////////////////////////////////////////
void SplineWidget::OnLButtonUp(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    if (m_bEditLock)
    {
        return;
...
//////////////////////////////////////////////////////////////////////////
void AbstractSplineWidget::SetHorizontalExtent(int min, int max)
{
    /*
    m_scrollMin.x = min;
    m_scrollMax.x = max;
    ...
    for (int splineIndex = 0, splineCount = m_splines.size(); splineIndex < splineCount; ++splineIndex)
    {
        ...
        for (nCurrentDimension = 0; nCurrentDimension < nTotalNumberOfDimensions; nCurrentDimension++)
        {
            ...
            if (bSplineHit)
            {
                ...
                for (int i = 0; i < pSpline->GetKeyCount(); i++)
                {
                    QPoint splinePt = TimeToPoint(pSpline->GetKeyTime(i), pSpline);
...
#include <Animation/Controls/UiSplineCtrlEx.moc>