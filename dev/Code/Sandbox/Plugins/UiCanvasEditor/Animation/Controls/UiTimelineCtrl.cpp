...
void TimelineWidget::DrawTicks(QPainter* painter)
{
    ...
    // Draw vertical line showing current time.
    {
        ...
        if (x > m_rcTimeline.left() && x < m_rcTimeline.right())
        {
            ...
            painter->drawLine(x, 0, x, m_rcTimeline.bottom());
        }
    }
    ...
    for (int keyTimeIndex = 0; m_pKeyTimeSet && keyTimeIndex < m_pKeyTimeSet->GetKeyTimeCount(); ++keyTimeIndex)
    {
        ...
        painter->drawRect(QRect(QPoint(x - 2, rc.top()), QPoint(x + 3, rc.bottom())));
    }
...
//////////////////////////////////////////////////////////////////////////
void TimelineWidget::OnRButtonDown(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    Q_EMIT clicked();
...
//////////////////////////////////////////////////////////////////////////
void TimelineWidget::OnRButtonUp(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    switch (m_trackingMode)
    {
    case TRACKING_MODE_SET_TIME:
...
void TimelineWidget::mouseMoveEvent(QMouseEvent* event)
{
    ...
    case TRACKING_MODE_SET_TIME:
    {
        if (m_bTrackingSnapToFrames)
        {
            SetTimeMarker(FacialEditorSnapTimeToFrame(ClientToTime(event->x())));
        }
        else
        {
...
//////////////////////////////////////////////////////////////////////////
void TimelineWidget::OnLButtonUp(const QPoint& point, Qt::KeyboardModifiers modifiers)
{
    switch (m_trackingMode)
    {
    case TRACKING_MODE_MOVE_KEYS:
...
#include <Animation/Controls/UiTimelineCtrl.moc>
