...
void CUiAVCustomizeTrackColorsDlg::SaveColors(const char* sectionName)
{
    // We no longer support custom colors but haven't completely removed the functionality
    // in case we want to support it.
}

void CUiAVCustomizeTrackColorsDlg::LoadColors(const char* sectionName)
{
    // We no longer support custom colors but haven't completely removed the functionality
...
#include <Animation/UiAVCustomizeTrackColorsDlg.moc>
