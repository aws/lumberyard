...
//////////////////////////////////////////////////////////////////////////
AZ::Entity* CUiAnimViewAnimNode::GetNodeEntityAz(const bool bSearch)
{
    if (m_pAnimNode)
    {
        if (m_nodeEntityId.IsValid())
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewAnimNode::OnNodeUiAnimated(IUiAnimNode* pNode)
{
    // UI ANIMATION_REVISIT - is this function needed?
}

//////////////////////////////////////////////////////////////////////////
void CUiAnimViewAnimNode::OnNodeVisibilityChanged(IUiAnimNode* pNode, const bool bHidden)
{
    // UI ANIMATION_REVISIT - is this function needed?
}

//////////////////////////////////////////////////////////////////////////
void CUiAnimViewAnimNode::OnNodeReset(IUiAnimNode* pNode)
{
    // UI ANIMATION_REVISIT - is this function needed?
}
