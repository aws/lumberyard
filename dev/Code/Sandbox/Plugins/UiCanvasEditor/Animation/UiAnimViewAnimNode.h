...
public:
    ...
    virtual void Render(CUiAnimViewAnimNode* pNode, const SUiAnimContext& ac) {}

    // Called when binding/unbinding the owning node
    virtual void Bind(CUiAnimViewAnimNode* pNode) {}
...
public:
    ...
    char* GetParamName(const CUiAnimParamType& paramType) const;
    char* GetParamNameForTrack(const CUiAnimParamType& paramType, const IUiAnimTrack* track) const;
