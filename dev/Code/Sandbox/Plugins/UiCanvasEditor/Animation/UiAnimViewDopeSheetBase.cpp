...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewDopeSheetBase::OnLButtonUp(Qt::KeyboardModifiers modifiers, const QPoint& point)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewDopeSheetBase::OnRButtonUp(Qt::KeyboardModifiers modifiers, const QPoint& point)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
    if (!pSequence)
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewDopeSheetBase::MouseMoveMove(const QPoint& p, Qt::KeyboardModifiers modifiers)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
    CUiAnimViewSequenceNotificationContext context(pSequence);
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewDopeSheetBase::LButtonDownOnTimeAdjustBar(const QPoint& point, CUiAnimViewKeyHandle& keyHandle, bool bStart)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewDopeSheetBase::LButtonDownOnKey(const QPoint& point, CUiAnimViewKeyHandle& keyHandle, Qt::KeyboardModifiers modifiers)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewDopeSheetBase::DrawClipboardKeys(QPainter* painter, const QRect& rc)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
...
void CUiAnimViewDopeSheetBase::DrawTimeLineInFrames(QPainter* painter, const QRect& rc, const QColor& lineCol, const QColor& textCol, double step)
{
...
void CUiAnimViewDopeSheetBase::DrawTimeLineInSeconds(QPainter* painter, const QRect& rc, const QColor& lineCol, const QColor& textCol, double step)
{
    Range VisRange = GetVisibleRange();
    const Range& timeRange = m_timeRange;
    int nNumberTicks = 10;
