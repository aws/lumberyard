...
void FindEntityWidget::OnSelectionChanged(const QItemSelection& selected, const QItemSelection& deselected)
{
    // Update select button state
    m_selectButton->setEnabled(!selected.isEmpty());
}

void FindEntityWidget::OnItemDblClick(const QModelIndex& index)
{
    OnSelectClicked();
}
