...
namespace AssetBundler
{
    ...
    protected:
        ...
        void SendErrorMetricEvent(const char *errorMessage) const;
        void AddFlagAttribute(const char* key, bool flagValue) const;
        void AddMetric(const char* metricName, double metricValue) const;
        ////////////////////////////////////////////////////////////////////////////////////////////
        ...
        LyMetricIdType m_assetBundlerMetricId;
