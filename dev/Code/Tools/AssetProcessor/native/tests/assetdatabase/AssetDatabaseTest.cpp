...
namespace UnitTests
{
    ...
    TEST_F(AssetDatabaseTest, QueryProductDependenciesUnresolvedAdvanced_HandlesLargeSearch_Success)
    {
        ...
        ProductDependencyDatabaseEntry dependency2(m_data->m_product1.m_productID, AZ::Uuid::CreateNull(), 0, 0, "pc", false, "default.xml");
        ...
        ASSERT_TRUE(m_data->m_connection.QueryProductDependenciesUnresolvedAdvanced(searchPaths, [&matches](AzToolsFramework::AssetDatabase::ProductDependencyDatabaseEntry& /*entry*/, const AZStd::string& path)
            {
