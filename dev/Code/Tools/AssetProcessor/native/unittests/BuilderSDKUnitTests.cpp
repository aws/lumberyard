...
public:
    ...
    void StartTest() override
    {
        ...
        UNIT_TEST_EXPECT_TRUE(CreateDummyFile(dummyFileName, "<ControllerDef>stuff</ControllerDef>"));
        UNIT_TEST_EXPECT_TRUE(AssetBuilderSDK::JobProduct::InferAssetTypeByProductFileName(dummyFileName.toUtf8().data()) == mannequinControllerDefinitionAssetType);
