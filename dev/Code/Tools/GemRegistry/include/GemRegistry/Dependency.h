...
namespace Gems
{
    ...
    using EngineSpecifier = Specifier<EngineVersion::parts_count>;
    using GemSpecifier = Specifier<GemVersion::parts_count>;
    ...
    using EngineDependency = Dependency<EngineVersion::parts_count>;
    using GemDependency = Dependency<GemVersion::parts_count>;
    ...
    BITMASK_OPS(EngineDependency::Bound::Comparison)
    BITMASK_OPS(GemDependency::Bound::Comparison)
...
#include <GemRegistry/Dependency.inl>
