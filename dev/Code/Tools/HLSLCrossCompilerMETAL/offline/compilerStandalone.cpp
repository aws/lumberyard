...
int Run(const char* srcPath, const char* destPath, ShaderLang language, int flags, const char* reflectPath, Shader* shader, int useStdErr, const char *fxcCmdLine, const char *debugSrcPath)
{
	FILE* outputFile;
	Shader tempShader;
