...
static void DecodeOperandDX9(const ShaderData* psShader,
...
static void DeclareNumTemps(ShaderData* psShader,
...
static void SetupRegisterUsage(const ShaderData* psShader,
...
static void DeclareConstantBuffer(const ShaderData* psShader,
                                Declaration* psDecl)
{
...
static void DecodeDeclarationDX9(const ShaderData* psShader,
                                const uint32_t ui32Token0,
                                const uint32_t ui32Token1,
                                Declaration* psDecl)
{
