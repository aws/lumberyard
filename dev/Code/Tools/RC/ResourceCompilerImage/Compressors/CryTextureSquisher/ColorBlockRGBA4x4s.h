...
#ifndef CRYINCLUDE_CRYTEXTURESQUISHER_COLORBLOCKRGBA4X4S_H
#define CRYINCLUDE_CRYTEXTURESQUISHER_COLORBLOCKRGBA4X4S_H
#pragma once
...
struct ColorBlockRGBA4x4s
{
    ...
    void setBGRA16(const void* imgBGRA16, unsigned int width, unsigned int height, unsigned int pitch, unsigned int x, unsigned int y);
    void getBGRA16(void* imgBGRA16, unsigned int width, unsigned int height, unsigned int pitch, unsigned int x, unsigned int y);
...
#endif // CRYINCLUDE_CRYTEXTURESQUISHER_COLORBLOCKRGBA4X4S_H
