...
void ImageToProcess::ConvertFromR16ToRGBA16()
{
    ...
    std::unique_ptr<ImageObject> pRet(get()->AllocateImage(0, ePixelFormat_A16B16G16R16));
...
void ImageToProcess::ConvertFromRGBA16ToR16()
{
    ...
    std::unique_ptr<ImageObject> pRet(get()->AllocateImage(0, ePixelFormat_R16));
...
ImageObject* ImageObject::CopyAnyAlphaIntoR16Image(int maxMipCount) const
{
    ...
    std::unique_ptr<ImageObject> pRet(new ImageObject(width, height, newMipCount, ePixelFormat_R16, GetCubemap()));
