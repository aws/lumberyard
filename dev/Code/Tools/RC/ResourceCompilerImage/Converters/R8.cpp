...
void ImageToProcess::ConvertFromRGBA8ToR8()
{
    ...
    std::unique_ptr<ImageObject> pRet(get()->AllocateImage(0, ePixelFormat_R8));
...
ImageObject* ImageObject::CopyAnyAlphaIntoR8Image(int maxMipCount) const
{
    ...
    std::unique_ptr<ImageObject> pRet(new ImageObject(width, height, newMipCount, ePixelFormat_R8, GetCubemap()));
