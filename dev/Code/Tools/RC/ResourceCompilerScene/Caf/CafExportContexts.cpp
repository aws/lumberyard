...
namespace AZ
{
    namespace RC
    {
        CafGroupExportContext::CafGroupExportContext(SceneAPI::Events::ExportEventContext& parent,
        ...
        CafGroupExportContext::CafGroupExportContext(SceneAPI::Events::ExportProductList& products, const SceneAPI::Containers::Scene& scene, const AZStd::string& outputDirectory,
            const SceneAPI::DataTypes::IAnimationGroup& group, Phase phase)
            : m_products(products)
            , m_scene(scene)
        ...
        CafGroupExportContext::CafGroupExportContext(const CafGroupExportContext& copyContext, Phase phase)
