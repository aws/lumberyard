...
namespace AZ
{
    namespace RC
    {
        ...
        void BlendShapeExporter::Reflect(ReflectContext* context)
        {
            ...
            if (serializeContext)
            {
                serializeContext->Class<BlendShapeExporter, SceneAPI::SceneCore::ExportingComponent>()->Version(1);
            }
        }
        ...
        SceneAPI::Events::ProcessingResult BlendShapeExporter::ProcessBlendShapes(MeshNodeExportContext& context)
        {
            ...
            for (size_t index = 0; index < blendShapeRule->GetSceneNodeSelectionList().GetSelectedNodeCount(); ++index)
            {
                ...
                {
                    AZ_TracePrintf(SceneAPI::Utilities::ErrorWindow, "Invalid name %s for blend shape.", blendShapeRule->GetSceneNodeSelectionList().GetSelectedNode(index));
                ...
                AZ::Transform skinTransform = AZ::Transform::Identity();
