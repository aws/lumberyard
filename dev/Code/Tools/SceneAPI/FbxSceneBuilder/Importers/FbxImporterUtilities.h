...
namespace AZ
{
    ...
    namespace SceneAPI
    {
        ...
        namespace FbxSceneBuilder
        {
            ...
            CoreProcessingResult AddDataNodeWithContexts(SceneDataPopulatedContext& dataContext);
            CoreProcessingResult AddAttributeDataNodeWithContexts(SceneAttributeDataPopulatedContext& dataContext);
            ...
            bool GetBindPoseLocalTransform(const FbxSDKWrapper::FbxSceneWrapper& sceneWrapper,
                FbxSDKWrapper::FbxNodeWrapper& nodeWrapper, AZ::Transform& xf);
        } // namespace FbxSceneBuilder
    } // namespace SceneAPI
} // namespace AZ
