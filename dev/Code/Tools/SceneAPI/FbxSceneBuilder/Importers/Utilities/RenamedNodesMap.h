    ...
    namespace SceneAPI
    {
        namespace FbxSceneBuilder
        {
            ...
            public:
                ...
                bool RegisterNode(const std::shared_ptr<FbxSDKWrapper::FbxNodeWrapper>& node, const Containers::SceneGraph& graph,
                    Containers::SceneGraph::NodeIndex parentNode, const char* defaultName = "unnamed");
                bool RegisterNode(const std::shared_ptr<const FbxSDKWrapper::FbxNodeWrapper>& node, const Containers::SceneGraph& graph,
                    Containers::SceneGraph::NodeIndex parentNode, const char* defaultName = "unnamed");
                bool RegisterNode(const FbxSDKWrapper::FbxNodeWrapper& node, const Containers::SceneGraph& graph,
                    Containers::SceneGraph::NodeIndex parentNode, const char* defaultName = "unnamed");

                //! Returns the name of the given node, which may be sanitized if this was needed.
                const char* GetNodeName(const std::shared_ptr<FbxSDKWrapper::FbxNodeWrapper>& node) const;
                const char* GetNodeName(const std::shared_ptr<const FbxSDKWrapper::FbxNodeWrapper>& node) const;
                const char* GetNodeName(const AZStd::shared_ptr<FbxSDKWrapper::FbxNodeWrapper>& node) const;
                const char* GetNodeName(const AZStd::shared_ptr<const FbxSDKWrapper::FbxNodeWrapper>& node) const;
                const char* GetNodeName(const FbxSDKWrapper::FbxNodeWrapper& node) const;
            private:
