    ...
    namespace SceneAPI
    {
        namespace Containers
        {
            namespace Views
            {
                ...
                template<typename Iterator, typename ReturnType>
                auto ConvertIterator<Iterator, ReturnType, AZStd::input_iterator_tag>::operator*()->typename super::reference
                {
                ...
                template<typename Iterator, typename ReturnType>
                auto ConvertIterator<Iterator, ReturnType, AZStd::input_iterator_tag>::GetPointer(AZStd::false_type intermediateValue)->typename super::pointer
                {
                    AZ_Assert(super::m_converter, "No valid conversion function set for ConvertIterator.");
                ...
                template<typename Iterator, typename ReturnType>
                auto ConvertIterator<Iterator, ReturnType, AZStd::input_iterator_tag>::operator->()->typename super::pointer
                {
                ...
                //
                template<typename Iterator, typename ReturnType>
                ConvertIterator<Iterator, ReturnType, AZStd::continuous_random_access_iterator_tag>::ConvertIterator(Iterator iterator, typename super::Function converter)
                    : super(iterator, converter)
                {
                }
