    ...
    namespace SceneAPI
    {
        namespace Containers
        {
            namespace Views
            {
                ...
                template<typename FirstIterator, typename SecondIterator>
                auto PairIterator<FirstIterator, SecondIterator, AZStd::input_iterator_tag>::operator*()->typename super::reference
                {
                    return typename super::reference(*super::m_first, *super::m_second);
                }

                template<typename FirstIterator, typename SecondIterator>
                auto PairIterator<FirstIterator, SecondIterator, AZStd::input_iterator_tag>::operator->()->typename super::pointer
                {
