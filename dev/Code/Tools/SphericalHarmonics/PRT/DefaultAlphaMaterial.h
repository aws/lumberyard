...
#ifndef CRYINCLUDE_TOOLS_SPHERICALHARMONICS_PRT_DEFAULTALPHAMATERIAL_H
#define CRYINCLUDE_TOOLS_SPHERICALHARMONICS_PRT_DEFAULTALPHAMATERIAL_H
#pragma once
...
namespace NSH
{
    namespace NMaterial
    {
        ...
        class CDefaultAlphaSHMaterial
            : public ISHMaterial
        {
        public:
            INSTALL_CLASS_NEW(CDefaultAlphaSHMaterial)

            CDefaultAlphaSHMaterial(CSimpleIndexedMesh* pMesh, const float cTransparencyShadowingFactor = 1.f, const float cAlphaIntensity = 0.f);
            ...
            virtual const EMaterialType Type() const{return MATERIAL_TYPE_ALPHA_DEFAULT; }
...
#endif
#endif // CRYINCLUDE_TOOLS_SPHERICALHARMONICS_PRT_DEFAULTALPHAMATERIAL_H
