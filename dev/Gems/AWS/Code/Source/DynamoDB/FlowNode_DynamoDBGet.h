...
namespace LmbrAWS
{
    //////////////////////////////////////////////////////////////////////////////////////
    ///
    /// Get values from Dynamo DB
    ///
    //////////////////////////////////////////////////////////////////////////////////////
    class FlowNode_DynamoDBGet
        : public BaseMaglevFlowNode< eNCT_Singleton >
    {
    public:

        FlowNode_DynamoDBGet(IFlowNode::SActivationInfo* activationInfo);

        // ~IFlowNode
        virtual ~FlowNode_DynamoDBGet() {}

    protected:
        const char* GetFlowNodeDescription() const override { return _HELP("Get values from DynamoDB"); }
    ...
    private:
        ...
        enum EInputs
        {
            EIP_ActivateGet = EIP_StartIndex,
            EIP_TableClient,
            EIP_TableKeyName,
            EIP_Key,
            EIP_Attribute
