...
*/
#include <StdAfx.h>
#include <Util/JSON/FlowNode_GetJsonProperty.h>
#include <aws/core/utils/json/JsonSerializer.h>
#include <aws/core/utils/memory/stl/AWSStringStream.h>

namespace LmbrAWS
{
    static const char* CLASS_TAG = "JSON:GetJsonProperty";

    void FlowNode_GetJsonProperty::GetConfiguration(SFlowNodeConfig& configuration)
    {
    ...
    void FlowNode_GetJsonProperty::ProcessEvent(EFlowEvent event, SActivationInfo* pActInfo)
    {
        if (event == eFE_Activate && IsPortActive(pActInfo, EIP_Activate))
        {
    ...
    REGISTER_CLASS_TAG_AND_FLOW_NODE(CLASS_TAG, FlowNode_GetJsonProperty);
} // namespace LmbrAWS
