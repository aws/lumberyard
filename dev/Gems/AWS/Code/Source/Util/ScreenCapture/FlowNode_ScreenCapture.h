...
namespace LmbrAWS
{
    //////////////////////////////////////////////////////////////////////////////////////
    ///
    /// Creates a screen capture node
    ///
    //////////////////////////////////////////////////////////////////////////////////////
    class FlowNode_ScreenCapture
        : public BaseMaglevFlowNode <eNCT_Singleton>
    {
    public:
        FlowNode_ScreenCapture(IFlowNode::SActivationInfo* activationInfo);

        // ~IFlowNode
        virtual ~FlowNode_ScreenCapture() {}
