...
namespace AssetValidation
{
    ...
    public:
        ...
        virtual bool AddSeedPath(const char* fileName) { return false; }
        //! Request to Remove a Seed from tracking by relative path under the /dev folder
        virtual bool RemoveSeedPath(const char* fileName) { return false; }
    ...
    public:
        ...
        virtual void UnknownAsset(const char* fileName) { }
    };
