...
namespace Audio
{
    ...
    {
        m_nCommandQueueMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_COMMAND_QUEUE_MEMORY_POOL_SIZE;
        m_nLowerEngineDefaultPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_LOWER_ENGINE_DEFAULT_POOL_SIZE;
    #if defined(INCLUDE_WWISE_IMPL_PRODUCTION_CODE)
        m_nMonitorMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_MONITOR_MEMORY_POOL_SIZE;
        m_nMonitorQueueMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_MONITOR_QUEUE_MEMORY_POOL_SIZE;
    #endif // INCLUDE_WWISE_IMPL_PRODUCTION_CODE
        m_nPrepareEventMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_PREPARE_EVENT_MEMORY_POOL_SIZE;
        m_nPrimaryMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_PRIMARY_POOL_SIZE;
        m_nSecondaryMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_SECONDARY_POOL_SIZE;
        m_nSoundEngineDefaultMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_SOUND_ENGINE_DEFAULT_MEMORY_POOL_SIZE;
        m_nStreamDeviceMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_STREAMER_DEVICE_MEMORY_POOL_SIZE;
        m_nStreamManagerMemoryPoolSize = AZ_TRAIT_AUDIOENGINEWWISE_STREAMER_MANAGER_MEMORY_POOL_SIZE;
        ...
        REGISTER_CVAR2("s_WwiseCommandQueueMemoryPoolSize", &m_nCommandQueueMemoryPoolSize, m_nCommandQueueMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_COMMAND_QUEUE_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseLowerEngineDefaultPoolSize", &m_nLowerEngineDefaultPoolSize, m_nLowerEngineDefaultPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_LOWER_ENGINE_DEFAULT_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseMonitorMemoryPoolSize", &m_nMonitorMemoryPoolSize, m_nMonitorMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_MONITOR_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseMonitorQueueMemoryPoolSize", &m_nMonitorQueueMemoryPoolSize, m_nMonitorQueueMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_MONITOR_QUEUE_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
    #endif // INCLUDE_WWISE_IMPL_PRODUCTION_CODE
        ...
        REGISTER_CVAR2("s_WwisePrepareEventMemoryPoolSize", &m_nPrepareEventMemoryPoolSize, m_nPrepareEventMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_PREPARE_EVENT_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwisePrimaryPoolSize", &m_nPrimaryMemoryPoolSize, m_nPrimaryMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_PRIMARY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseSecondaryPoolSize", &m_nSecondaryMemoryPoolSize, m_nSecondaryMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_SECONDARY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseSoundEngineDefaultMemoryPoolSize", &m_nSoundEngineDefaultMemoryPoolSize, m_nSoundEngineDefaultMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_SOUND_ENGINE_DEFAULT_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseStreamDeviceMemoryPoolSize", &m_nStreamDeviceMemoryPoolSize, m_nStreamDeviceMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_STREAMER_DEVICE_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        REGISTER_CVAR2("s_WwiseStreamManagerMemoryPoolSize", &m_nStreamManagerMemoryPoolSize, m_nStreamManagerMemoryPoolSize, VF_REQUIRE_APP_RESTART,
            ...
            "Default: " AZ_TRAIT_AUDIOENGINEWWISE_STREAMER_MANAGER_MEMORY_POOL_SIZE_DEFAULT_TEXT "\n");
        ...
        // After CVar registration, they will by now receive any new values expressed in cfg files.
        // Check the sizes of the memory pools (sub-partitions add up to less than the total size)
        const int memorySubPartitionSizes = m_nPrepareEventMemoryPoolSize + m_nStreamManagerMemoryPoolSize + m_nStreamDeviceMemoryPoolSize
            + m_nSoundEngineDefaultMemoryPoolSize + m_nCommandQueueMemoryPoolSize + m_nLowerEngineDefaultPoolSize
        #if defined(INCLUDE_WWISE_IMPL_PRODUCTION_CODE)
            + m_nMonitorMemoryPoolSize
            + m_nMonitorQueueMemoryPoolSize
        #endif // INCLUDE_WWISE_IMPL_PRODUCTION_CODE
            ;

        AZ_Assert(m_nPrimaryMemoryPoolSize >= memorySubPartitionSizes,
            "Wwise Memory Pool sizes for sub-partitions add up to more than the primary memory pool size!");
    }
    ...
    void CAudioWwiseImplCVars::UnregisterVariables()
    {
        ...
        {
            AZ_Warning("CAudioWwiseImplCVars", false,
