...
def get_options():
    parser = ArgumentParser(description='Processes sound bank folders and generates ATL xml data for use with Lumberyard.\n'
...
def get_load_types_of_existing_preloads(atl_file):
    """
    Pre-parses the ATL controls file if it exists and returns lists of preloads that were marked as auto-load and ones that weren't.
