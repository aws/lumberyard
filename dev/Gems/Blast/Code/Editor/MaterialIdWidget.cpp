...
namespace Blast
{
    namespace Editor
    {
        ...
        void MaterialIdWidget::ConsumeAttribute(
            widget_t* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
        {
        ...
        void MaterialIdWidget::WriteGUIValuesIntoProperty(
            size_t index, widget_t* gui, property_t& instance, AzToolsFramework::InstanceDataNode* node)
        {
            instance = GetIdForIndex(gui->currentIndex());
        }

        bool MaterialIdWidget::ReadValuesIntoGUI(
            size_t index, widget_t* gui, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
        {
            ...
            auto materialAsset = AZ::Data::AssetManager::Instance().GetAsset<Blast::BlastMaterialLibraryAsset>(
                m_materialLibraryId, true, nullptr, true);
