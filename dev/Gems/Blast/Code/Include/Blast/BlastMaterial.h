...
namespace Blast
{
    ...
    public:
        ...
        Physics::CollisionLayer m_collisionLayer; //! Which collision layer is this actor's collider on.
        Physics::CollisionGroups::Id m_collisionGroupId; //! Which layers does this actor's collider collide with.
