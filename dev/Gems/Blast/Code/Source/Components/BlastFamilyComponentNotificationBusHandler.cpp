...
namespace Blast
{
    ...
    void BlastFamilyComponentNotificationBusHandler::OnActorCreatedDummy(BlastActorData blastActor)
    {
        // This is never invoked, and only used for type deduction when calling SetEvent
    }

    void BlastFamilyComponentNotificationBusHandler::OnActorDestroyedDummy(BlastActorData blastActor)
    {
        // This is never invoked, and only used for type deduction when calling SetEvent
    }
