...
def _get_distribution_id(context):
    return _get_distribution_id_by_name(context, context.config.default_deployment, dynamic_content_settings.get_default_resource_group(), get_cloudfront_distribution())
