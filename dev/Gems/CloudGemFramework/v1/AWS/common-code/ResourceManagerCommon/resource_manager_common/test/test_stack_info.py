...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_get_stack_info(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_ParametersDict(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_StackInfo(unittest.TestCase):
    ...
    def test_resources(self):
        ...
        with mock_aws.patch_client('cloudformation', 'list_stack_resources', return_value = mock_response) as mock_list_stack_resources:
            with mock.patch('resource_manager_common.stack_info.ResourceInfo', side_effect = mock_resources) as mock_ResourceInfo:
                target = stack_info.StackInfo(MOCK_STACK_ARN, MOCK_STACK_TYPE)
    ...
    def test_parameters(self):
        ...
        with mock.patch('resource_manager_common.stack_info.StackInfo.stack_description', new_callable=mock.PropertyMock, return_value = mock_stack_description):
            with mock.patch('resource_manager_common.stack_info.ParametersDict', return_value = mock_parameters_dict) as mock_ParametersDict:
                target = stack_info.StackInfo(MOCK_STACK_ARN, MOCK_STACK_TYPE)
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_ResourceInfoList(unittest.TestCase):
    ...
    def test_get_by_logical_id_default(self):
        ...
        logical_id = 'test-id'
        with mock.patch('resource_manager_common.stack_info.ResourceInfoList._ResourceInfoList__find_resource', return_value = expected_resource) as mock_find_resource:
            target = stack_info.ResourceInfoList(MOCK_STACK_INFO)
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_ResourceInfo(unittest.TestCase):
    ...
    def test_description(self):
        ...
        mock_stack_info.client.describe_stack_resource.assert_called_once_with(StackName=MOCK_STACK_ARN, LogicalResourceId=MOCK_LOGICAL_RESOURCE_ID)
    ...
    def test_get_cloud_canvas_metadata_found(self):
        ...
        with mock.patch('resource_manager_common.stack_info.ResourceInfo.metadata', new_callable=mock.PropertyMock, return_value = mock_metadata):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_ProjectInfo(unittest.TestCase):
    ...
    def test_deployments(self):
        ...
        with mock.patch('resource_manager_common.stack_info.DeploymentInfo', side_effect = mock_deployments) as mock_DeploymentInfo:
            with mock.patch('resource_manager_common.stack_info.ProjectInfo.project_settings', new_callable=mock.PropertyMock, return_value = mock_project_settings):
    ...
    def test_configuration_bucket(self):
        ...
        with mock.patch('resource_manager_common.stack_info.ProjectInfo.resources', new = mock.PropertyMock( return_value = mock_resources )):
            target = stack_info.ProjectInfo(MOCK_STACK_ARN)
    ...
    def test_project_settings(self):
        ...
        with mock_aws.patch_client('s3', 'get_object', return_value = mock_response, reload = stack_info) as mock_get_object:
            with mock.patch('resource_manager_common.stack_info.ProjectInfo.configuration_bucket', new_callable=mock.PropertyMock, return_value = mock_configuration_bucket_arn):
                with mock.patch("resource_manager_common.json_utils.JSONCustomEncoder.default", return_value='mock'):
                    target = stack_info.ProjectInfo(MOCK_STACK_ARN)
    ...
    def test_project_settings_missing_object(self):
        ...
        with mock_aws.patch_client('s3', 'get_object', side_effect = client_error, reload = stack_info) as mock_get_object:
            with mock.patch('resource_manager_common.stack_info.ProjectInfo.configuration_bucket', new_callable=mock.PropertyMock, return_value = mock_configuration_bucket_arn):
                target = stack_info.ProjectInfo(MOCK_STACK_ARN)
                actual_project_settings = target.project_settings
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_DeploymentInfo(unittest.TestCase):
    ...
    def test_deployment_name(self):
        ...
        with mock.patch('resource_manager_common.stack_info.DeploymentInfo.parameters', new = mock.PropertyMock( return_value = mock_parameters )):
    ...
    def test_deployment_access_arn_provided(self):
        mock_deployment_access = 'test-deployment-access'
        with mock.patch('resource_manager_common.stack_info.DeploymentAccessInfo', return_value = mock_deployment_access) as mock_DeploymentAccessInfo:
    ...
    def test_project_discovered(self):
        ...
        with mock.patch('resource_manager_common.stack_info.ProjectInfo', return_value = mock_project) as mock_ProjectInfo:
            with mock.patch('resource_manager_common.stack_info.DeploymentInfo.parameters', new = mock.PropertyMock( return_value = mock_parameters )):
    ...
    def test_resource_groups(self):
        ...
        with mock.patch('resource_manager_common.stack_info.ResourceGroupInfo', side_effect = mock_resource_groups) as mock_ResourceGroupInfo:
            with mock.patch('resource_manager_common.stack_info.DeploymentInfo.resources', new_callable=mock.PropertyMock, return_value=mock_resources):
                target = stack_info.DeploymentInfo(MOCK_STACK_ARN, client=MOCK_CLIENT)
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_DeploymentAccessInfo(unittest.TestCase):
    ...
    def test_deployment_discovered(self):
        ...
        with mock.patch('resource_manager_common.stack_info.DeploymentInfo', return_value=mock_deployment) as mock_DeploymentInfo:
            with mock.patch('resource_manager_common.stack_info.DeploymentAccessInfo.parameters', new = mock.PropertyMock( return_value = mock_parameters )):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_stack_info_ResourceGroupInfo(unittest.TestCase):
    ...
    def test_resource_group_name_discovered(self):
        ...
        with mock.patch('resource_manager_common.stack_info.ResourceGroupInfo.parameters', new = mock.PropertyMock( return_value = mock_parameters )):
