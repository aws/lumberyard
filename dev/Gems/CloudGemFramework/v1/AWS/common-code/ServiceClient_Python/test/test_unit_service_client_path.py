...
class UnitTest_CloudGemFramework_ServiceClient_Path(unittest.TestCase):
    ...
    def test_service_request_with_role_arn(self, mock_AWS4Auth):
        ...
        print("Mock_session {} region_name={}".format(mock_session, mock_session.region_name))
        ...
        mock_session.client.assert_called_once_with('sts', endpoint_url=AWSSTSUtils("TEST-REGION").endpoint_url)
