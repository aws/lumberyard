...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestStringOrListOfString(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestObject(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestObjectOrListOfObject(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestProperties(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestInteger(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestBoolean(unittest.TestCase):
...
class UnitTest_CloudGemFramework_ProjectResourceHandler_properties_TestDictionary(unittest.TestCase):
