...
def _process_swagger_cli(context, args):
    ...
    result = process_swagger_path(swagger_path)
...
def process_swagger_path(swagger_path):
...
def process_swagger(swagger):
    validate_swagger(swagger)
    process_lambda_dispatch_objects(swagger)
    validate_swagger(swagger)
