        ...
        execute: function () {
            AppComponent = /** @class */function () {
                function AppComponent(ds, aws, urlService, toastr, vcr) {
                    ...
                    if (ds.isProd) window.onbeforeunload = function (e) {
            ...
            CreateHeatmapComponent = /** @class */function () {
                function CreateHeatmapComponent(fb, breadcrumbs, router, definition, aws, http, toastr, cd) {
                    ...
                    this.generateSQL = function () {
                        ...
                        return _this.metricQuery.toString(query);
                    };
                    this.getMetricEventData = function () {
                        ...
                        // Submit the query
                        _this.isSaving = true;
                        _this.metricsApiHandler.postQuery(_this.generateSQL()).subscribe(function (res) {
                            ...
                            if (heatmapArr && heatmapArr.length > 0) {
                                ...
                                for (var i = 0; i < heatmapArr.length; i++) {
                                    ...
                                    var x_1 = (x - LL.x) * Math.cos(theta) + (y - LL.y) * Math.sin(theta);
                                    var y_1 = -((x - LL.x) * Math.sin(theta)) + (y - LL.y) * Math.cos(theta);
                                ...
                                try {
                                    ...
                                    _this.toastr.error("The heatmap visualization failed to update.  " + err);
                                }
                    ...
                    this.appendLimit = function (query) {
                        if (_this.limit['text'].toLowerCase() !== "all") return query + (" LIMIT " + _this.limit['text']);
                        return query;
                    };
                    ...
                    this.saveHeatmap = function () {
                        ...
                        if (_this.heatmap.event !== "Select") {
                            //ensure the SQL is valid before saving.
                            var query_1 = _this.generateSQL();
                            _this.isSaving = true;
                            _this.metricsApiHandler.postQuery(query_1).subscribe(function (res) {
                                ...
                                _this.toastr.error("Please review the SQL parameters. The SQL '" + query_1 + "' failed to execute.", err);
                                console.error("Failed SQL: " + query_1);
                                _this.isSaving = false;
                            });
                        } else {
                            if (!_this.isUpdatingExistingHeatmap) {
        ...
        execute: function () {
            JiraCredentialsComponent = /** @class */function () {
                ...
                JiraCredentialsComponent = __decorate([core_1.Component({
                    ...
                    template: "<breadcrumbs></breadcrumbs> <div *ngIf=\"!jiraIntegrationEnabled\">     Jira Integration is not enabled for the gem </div> <div *ngIf=\"jiraIntegrationEnabled\">     <div [ngSwitch]=\"isLoadingJiraCredentials\">         <div *ngSwitchCase=\"true\">             <loading-spinner></loading-spinner>         </div>         <div *ngSwitchCase=\"false\">             <div class=\"jira-credentials-container\">                 <p>Jira credentials are required by certain Cloud Gems to operate or to enable features.</p>                 <h3 *ngIf=\"jiraCredentialsExist\" class=\"stored-credentials\">Stored credentials</h3>                 <div *ngFor=\"let property of currentCredentials | objKeys\" class=\"form-group row\" [class.has-danger]=\"!currentCredentials[property]['valid']\">                     <label class=\"col-2 col-form-label credential-property affix\">{{getPropertyName(property)}}</label>                     <div class=\"col-6\">                         <input *ngIf=\"!jiraCredentialsExist\" [type]=\"property === 'password' ? 'password' : 'text'\" class=\"form-control\" [(ngModel)]=\"currentCredentials[property]['value']\">                         <input *ngIf=\"jiraCredentialsExist\" disabled type=\"text\" class=\"form-control\" placeholder=\"********\">                         <div *ngIf=\"!currentCredentials[property]['valid']\" class=\"form-control-feedback\">{{currentCredentials[property]['message']}}</div>                     </div>                 </div>                 <p *ngIf=\"jiraCredentialsExist\">                     For security purposes, you cannot view details or edit the stored credentials.<br />                     To enter in new information you must first clear the existing credentials.                 </p>                 <button *ngIf=\"!jiraCredentialsExist\" class=\"btn l-primary\" (click)=\"updateJiraCredentials()\">                     Save                 </button>                 <button *ngIf=\"jiraCredentialsExist\" class=\"btn l-primary\" (click)=\"clearCredentials()\">                     Clear credentials                 </button>             </div>         </div>     </div> </div>",
        ...
        execute: function () {
            AnalyticIndex = /** @class */function () {
                ...
                AnalyticIndex = __decorate([core_1.Component({
                    ...
                    template: "<h1> Analytics </h1> <div class=\"row\" *ngIf=\"dependencyservice.availableFeatures.Analytics !== null\">     <div *ngFor=\"let feature of dependencyservice.availableFeatures.Analytics\">         <thumbnail *ngIf=\"feature.location === 0\" url=\"/game/{{feature.route_path}}\" icon=\"https://m.media-amazon.com/images/G/01/cloudcanvas/images/{{feature.image}}\">             <div class=\"thumbnail-label-section row no-gutters\">                 <div> {{feature.name}} </div>             </div>             <div class=\"expanded-section row no-gutters\">                 <div class=\"col-12\">                     {{feature.description}}                 </div>             </div>         </thumbnail>     </div> </div>",
        ...
        execute: function () {
            DependencyService = /** @class */function () {
                function DependencyService(aws) {
                    ...
                    this.loadResourceGroups = function (definitions, deployment) {
                        ...
                        _this._resourceGroupSub = deployment.resourceGroup.subscribe(function (rgs) {
                            _this._availableFeatures = new Map();
                            for (var idx in definitions.defined) {
                                var feature = definitions.defined[idx];
                                if (dependency_verify_class_1.Verify.dependency(feature.component.name, _this.aws, definitions)) {
                                    var features = [];
                                    if (feature.parent in _this._availableFeatures) {
                                        features = _this._availableFeatures[feature.parent];
                                    } else if (feature.parent != undefined) {
                                        _this._availableFeatures[feature.parent] = features;
                                    }
                    ...
                    this._availableFeatures = new Map();
                }
                Object.defineProperty(DependencyService.prototype, "availableFeatures", {
                    get: function () {
                ...
                */
                DependencyService.prototype.subscribeToDeploymentChanges = function (def) {
                    ...
                    this._deploymentSub = this.aws.context.project.activeDeploymentSubscription.subscribe(function (deployment) {
                        if (deployment) {
                            _this.loadResourceGroups(def, deployment);
                        }
                    });
                ...
                DependencyService.prototype.ngOnDestroy = function () {
                    if (this._deploymentSub) {
                        this._deploymentSub.unsubscribe();
                    }
        ...
        execute: function () {
            AdminComponent = /** @class */function () {
                ...
                AdminComponent = __decorate([core_1.Component({
                    selector: 'admin',
                    template: "<h1> Administration </h1> <div class=\"row\" *ngIf=\"dependencyservice.availableFeatures.Administration !== null\">     <div *ngFor=\"let feature of dependencyservice.availableFeatures.Administration\">         <thumbnail *ngIf=\"feature.location === 1\" url=\"/game/{{feature.route_path}}\" icon=\"https://m.media-amazon.com/images/G/01/cloudcanvas/images/{{feature.image}}\">             <div class=\"thumbnail-label-section row no-gutters\">                 <div> {{feature.name}} </div>             </div>             <div class=\"expanded-section row no-gutters\">                 <div class=\"col-12\">                     {{feature.description}}                 </div>             </div>         </thumbnail>     </div> </div>"
        ...
        execute: function () {
            DragableComponent = /** @class */function () {
                ...
                DragableComponent = __decorate([core_1.Component({
                    ...
                    styles: [".gu-mirror {   position: fixed !important;   margin: 0 !important;   z-index: 9999 !important;   opacity: 0.8;   -ms-filter: \"progid:DXImageTransform.Microsoft.Alpha(Opacity=80)\";   filter: alpha(opacity=80); } .gu-hide {   display: none !important; } .gu-unselectable {   -webkit-user-select: none !important;   -moz-user-select: none !important;   -ms-user-select: none !important;   user-select: none !important; } .gu-transit {   opacity: 0.2;   -ms-filter: \"progid:DXImageTransform.Microsoft.Alpha(Opacity=20)\";   filter: alpha(opacity=20); } .container{width:100%}.ex-moved{background-color:rgba(78,0,255,0.05);-webkit-transition:background-color 500ms ease-out;transition:background-color 500ms ease-out}.container.ex-over{background-color:rgba(78,0,255,0.05)}.container.ex-over>.action-stub{background-color:rgba(78,0,255,0.05)}"],
                    encapsulation: core_1.ViewEncapsulation.None
            ...
            MetricQuery = /** @class */function () {
                function MetricQuery(aws, table, tables, supported_directives) {
                    ...
                    this.template = function (sql) {
                        ...
                        var date = new Date();
                        var projectName = _this.aws.context.name.replace(new RegExp('-', 'g'), '_').toLowerCase();
                        var deploymentName = _this.aws.context.project.activeDeployment.settings.name.replace(new RegExp('-', 'g'), '_').toLowerCase();
        ...
        execute: function () {
            SidebarComponent = /** @class */function () {
                ...
                SidebarComponent.prototype.ngOnInit = function () {
                    ...
                    this.dependencyservicesubscription = this.dependencyservice.featureMapSubscription.subscribe(function (featureMap) {
    ...
    return {
        ...
        execute: function () {
            PreloadingService = /** @class */function () {
                function PreloadingService(definitionService) {
                ...
                PreloadingService.prototype.preload = function (route, load) {
                    if (route.data && route.data['preload']) {
                        ...
                        if (!this.definitionService.isProd) console.log('Preloaded: ' + route.path);
                        return load();
                    } else {
        ...
        execute: function () {
            AwsProject = /** @class */function () {
                function AwsProject(context, http) {
                    ...
                    this.context = context;
                    this.http = http;
                    this.loadProjectSettingsV2 = function (context, http, proj) {
                        ...
                        context.s3.listObjectsV2(params, function (err, data) {
                            if (err) console.error(err, err.stack);else {
                                var content = data['Contents'];
                                var settings_1 = {};
                                var length_1 = content.length;
                                var i_1 = 1;
                                settings_1[AwsProject.PROJECT_SETTING_ATTR_DEPLOYMENT] = {};
                                for (var item in content) {
                                    var key = content[item].Key;
                                    var parts = key.split(".");
                                    ...
                                    if (key.includes(AwsProject.PROJECT_SETTING_V2_PREFIX + "." + AwsProject.PROJECT_SETTING_ATTR_DEPLOYMENT)) {
                                        settings_1[AwsProject.PROJECT_SETTING_ATTR_DEPLOYMENT][parts[2]] = key;
                                    } else {
                                        settings_1[parts[1]] = key;
                                    }
                                    var signedRequest = context.s3.getSignedUrl('getObject', { Bucket: context.configBucket, Key: key, Expires: 120 });
                                    http.request(signedRequest).subscribe(function (response) {
                                        i_1 += 1;
                                        var deployment = response.text();
                                        try {
                                        ...
                                        if (parts[parts.length - 3] == AwsProject.PROJECT_SETTING_ATTR_DEPLOYMENT) settings_1[AwsProject.PROJECT_SETTING_ATTR_DEPLOYMENT][parts[parts.length - 2]] = deployment;else settings_1[parts[parts.length - 3]] = deployment;
                                        if (i_1 == length_1) {
                                            proj._settingsCache = settings_1;
                                            proj._settings.next(settings_1);
                                        }
                                    }, function (err) {
                    ...
                    http.request(signedRequest).subscribe(function (response) {
                        ...
                        _this.loadProjectSettingsV2(context, http, proj);
                    });
                }
                ...
                Object.defineProperty(AwsProject, "PROJECT_SETTING_V2_PREFIX", {
                    get: function () {
                        return "dstack";
                    },
                    enumerable: true,
                ...
                Object.defineProperty(AwsProject, "PROJECT_SETTING_ATTR_DEPLOYMENT", {
                    get: function () {
                        return "deployment";
                    },
                    enumerable: true,
