...
#include <CloudGemFramework/AwsApiRequestJobConfig.h>
...
namespace CloudGemFramework
{
    ...
    #define AWS_API_REQUEST_TRAITS(SERVICE, REQUEST) \
        CloudGemFramework::AwsApiRequestTraits< \
    ...
    #define AWS_API_REQUEST_JOB(SERVICE, REQUEST) CloudGemFramework::AwsApiRequestJob<AWS_API_REQUEST_TRAITS(SERVICE, REQUEST)>

    /// Macro that simplifies the declaration of an AwsRequstJob that has no result.
    #define AWS_API_REQUEST_JOB_NO_RESULT(SERVICE, REQUEST) CloudGemFramework::AwsApiRequestJob<AWS_API_REQUEST_TRAITS_NO_RESULT(SERVICE, REQUEST)>
    ...
    protected:
        ...
        void Process() override
        {
            ...
            // Currently the AWS SDK always executes requests synchronsly. Even
            // when the Async and Callable versions of the API are used, the 
            // actual AWS call is made synchronsly, blocking whatever thread it
        ...
        /// are made to the request object. Override to defer the preperation
        ...
        /// Called when request has completed succesfully.
