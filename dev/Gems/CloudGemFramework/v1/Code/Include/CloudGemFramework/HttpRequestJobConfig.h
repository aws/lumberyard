...
namespace CloudGemFramework
{
    ...
    // warning C4250: 'CloudGemFramework::HttpRequestJobConfig' : inherits 'CloudGemFramework::AwsApiJobConfig::CloudGemFramework::AwsApiJobConfig::GetJobContext' via dominance
