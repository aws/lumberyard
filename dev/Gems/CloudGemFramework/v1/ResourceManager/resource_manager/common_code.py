...
def resolve_imports(context, target_directory_path, imported_paths = None):
    ...
    content? Should it be detected here? Is it always an error or, if the paths or 
    ...
    if os.path.isfile(imports_file_path):
        ...
        for line in lines:
            ...
            if path not in imported_paths: # avoid infinte loops and extra work
                ...
                resolve_imports(context, path, imported_paths)
