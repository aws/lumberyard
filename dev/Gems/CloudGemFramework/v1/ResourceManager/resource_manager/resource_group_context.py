...
class ResourceGroupController(object):
    ...
    def before_update_framework_version_to_1_1_5(self, from_version):
        self.__context.view.version_update(from_version, json.dumps(self.__context.config.local_project_settings.raw_dict()), '1.1.5')
        self.__context.view.version_update_complete('1.1.5', json.dumps(self.__context.config.local_project_settings.raw_dict()))
