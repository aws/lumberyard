...
class IntegrationTest_CloudGemFramework_ResourceManager_version_update1_1_1(lmbr_aws_test_support.lmbr_aws_TestCase):
    def __init__(self, *args, **kwargs):
        super(IntegrationTest_CloudGemFramework_ResourceManager_version_update1_1_1, self).__init__(*args, **kwargs)
    ...
    def setUp(self):
        ...
        self.prepare_test_environment("project_update_1_1_1")
    ...
    def __010_make_uninitialized_framework_version_1_1_1_project(self):
        project_snapshot.restore_snapshot(
            region=self.TEST_REGION,
            profile=self.TEST_PROFILE,
            stack_name=self.TEST_PROJECT_STACK_NAME,
            project_directory_path=self.GAME_DIR,
            snapshot_file_path=self.snapshot_path('CGF_1_1_1_Minimal_Uninitialized'),
    ...
    def __110_make_initialized_framework_version_1_1_1_project(self):
        project_snapshot.restore_snapshot(
            region=self.TEST_REGION,
            profile=self.TEST_PROFILE,
            stack_name=self.TEST_PROJECT_STACK_NAME,
            project_directory_path=self.GAME_DIR,
            snapshot_file_path=self.snapshot_path('CGF_1_1_1_Minimal_Initialized'),
            root_directory_path=self.REAL_ROOT_DIR)
