...
# In Python 3, int type is unbounded and sys.maxint has been removed
# Define this value here to fix an issue where the Python int is too large to convert to C long
