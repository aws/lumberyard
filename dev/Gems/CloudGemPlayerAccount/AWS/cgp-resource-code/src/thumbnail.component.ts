...
import { PlayerAccountApi } from './index'
...
@Component({
    selector: 'cloudgemplayeraccount-thumbnail',
    template: `
    <thumbnail-gem 
        [title]="displayName" 
        [cost]="'Low'" 
...
export class PlayerAccountThumbnailComponent extends AbstractCloudGemThumbnailComponent {
    @Input() context: any
    @Input() displayName: string = "Player Account";
    @Input() srcIcon: string = "https://m.media-amazon.com/images/G/01/cloudcanvas/images/player_account_optimized._V518452893_.png"
    ...
    ngOnInit() {        
        this._apiHandler = new PlayerAccountApi(this.context.ServiceUrl, this.http, this.aws, this.metricservice, this.context.identifier);
    ...
    public report(metric: Measurable) {
        ...
        this._apiHandler.get("admin/identityProviders/Cognito").subscribe(response => {
