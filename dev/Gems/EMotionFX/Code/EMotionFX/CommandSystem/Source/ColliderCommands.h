...
namespace EMotionFX
{
    ...
    public:
        ...
        void SetCollisionLayer(Physics::CollisionLayer collisionLayer) { m_collisionLayer = collisionLayer; }
        void SetCollisionGroupId(Physics::CollisionGroups::Id collisionGroupId) { m_collisionGroupId = collisionGroupId; }
        ...
        void SetOldCollisionLayer(Physics::CollisionLayer collisionLayer) { m_oldCollisionLayer = collisionLayer; }
        void SetOldCollisionGroupId(Physics::CollisionGroups::Id collisionGroupId) { m_oldCollisionGroupId = collisionGroupId; }
    ...
    private:
        ...
        // ColliderConfiguration
        AZStd::optional<Physics::CollisionLayer> m_collisionLayer;
        AZStd::optional<Physics::CollisionGroups::Id> m_collisionGroupId;
        ...
        AZStd::optional<Physics::CollisionLayer> m_oldCollisionLayer;
        AZStd::optional<Physics::CollisionGroups::Id> m_oldCollisionGroupId;
