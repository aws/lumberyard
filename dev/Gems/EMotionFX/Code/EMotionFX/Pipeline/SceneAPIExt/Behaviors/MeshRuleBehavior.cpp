...
namespace EMotionFX
{
    namespace Pipeline
    {
        namespace Behavior
        {
            ...
            bool MeshRuleBehavior::UpdateMeshRule(const AZ::SceneAPI::Containers::Scene& scene, const AZ::SceneAPI::DataTypes::ISceneNodeGroup& group, EMotionFX::Pipeline::Rule::MeshRule& meshRule)
            {
