...
namespace EMotionFX
{
     ...
     * 1) to create a class that inherits from an allocator type e.g. SystemAllocator, PoolAllocator
    ...
    class NoSubAllocator {};
     
     // Allocator name,                          Allocator type,   Sub-allocator,       UUID,                                     Description
#define EMOTIONFX_ALLOCATORS \
    ((ActorAllocator)                            (SystemAllocator) (NoSubAllocator)     ("{7719384C-BC31-4E95-B60C-BA64F5F1D5E9}")("EMotionFX actor memory allocator")) \
    ((AnimGraphAllocator)                        (SystemAllocator) (NoSubAllocator)     ("{386F92FD-0660-4A4A-8AA8-A748B650279F}")("EMotionFX anim graph memory allocator")) \
    ...
    ((ActorManagerAllocator)                     (SystemAllocator) (ActorAllocator)     ("{E251E70B-C010-4D21-9521-9A53FE8B9C39}")("EMotionFX actor manager memory allocator")) \
    ((ActorUpdateAllocator)                      (SystemAllocator) (ActorAllocator)     ("{03E10078-F8BC-4F5C-B70B-82B87D15E6B6}")("EMotionFX actor update memory allocator")) \
    ((AnimGraphEventHandlerAllocator)            (SystemAllocator) (AnimGraphAllocator) ("{658DC073-5D33-4E08-B3F2-C9856E29AC9E}")("EMotionFX anim graph event handler memory allocator")) \
    ((AnimGraphGameControllerSettingsAllocator)  (SystemAllocator) (AnimGraphAllocator) ("{8F7CA654-BBDA-4E2D-9916-812AF5A21FBA}")("EMotionFX anim graph controller settings memory allocator")) \
    ((AnimGraphInstanceAllocator)                (SystemAllocator) (AnimGraphAllocator) ("{8C632A30-890C-443C-89F2-F86C6CFD4E15}")("EMotionFX anim graph instance memory allocator")) \
    ((AnimGraphManagerAllocator)                 (SystemAllocator) (AnimGraphAllocator) ("{00A3CA02-55DA-4E21-ADFD-91186CFB4C37}")("EMotionFX anim graph manager memory allocator")) \
    ((AttachmentAllocator)                       (SystemAllocator) (ActorAllocator)     ("{1709A833-ED5C-40BC-B25F-4D61CD148920}")("EMotionFX attachment memory allocator")) \
    ((BlendSpaceManagerAllocator)                (SystemAllocator) (AnimGraphAllocator) ("{505B5C4F-6BB9-49B1-B263-00A4FF9C26E6}")("EMotionFX blend space manager memory allocator")) \
    ((DeformerAllocator)                         (SystemAllocator) (ActorAllocator)     ("{010D01A2-7CB8-4031-ADDB-110503E3AF58}")("EMotionFX deformer memory allocator")) \
    ((EMotionFXManagerAllocator)                 (SystemAllocator) (GeneralAllocator)   ("{C6B6EFAB-61ED-4567-A2D1-6CADBF191E17}")("EMotionFX manager memory allocator")) \
    ((EventManagerAllocator)                     (SystemAllocator) (GeneralAllocator)   ("{69A5606E-5503-4D45-AF21-7CAD707BD7F0}")("EMotionFX event manager memory allocator")) \
    ((EventHandlerAllocator)                     (SystemAllocator) (GeneralAllocator)   ("{ACEBE834-E13E-4E76-A58E-F1CC5C4F8D94}")("EMotionFX event handler memory allocator")) \
    ((EyeBlinkerAllocator)                       (SystemAllocator) (ActorAllocator)     ("{F009290A-E939-4AC8-BFA4-E7D2E51E9396}")("EMotionFX eye blinker memory allocator")) \
    ((ImporterAllocator)                         (SystemAllocator) (GeneralAllocator)   ("{0F6A2BB0-28AC-4AA0-B4A5-ADCB110677B2}")("EMotionFX importer memory allocator")) \
    ((LayerPassAllocator)                        (SystemAllocator) (ActorAllocator)     ("{120D1D14-4E03-4E5A-9B04-7D729EDF8501}")("EMotionFX layer pass memory allocator")) \
    ((MaterialAllocator)                         (SystemAllocator) (ActorAllocator)     ("{E8BD8522-4F4A-467D-9EDA-2C6FC0CFB0BE}")("EMotionFX material memory allocator")) \
    ((MeshAllocator)                             (SystemAllocator) (ActorAllocator)     ("{EC73C463-DBDF-448D-9BD0-AAEB5649E97D}")("EMotionFX mesh memory allocator")) \
    ((MotionEventAllocator)                      (SystemAllocator) (MotionAllocator)    ("{565227EE-E633-4C9D-BA03-1C593D990DB0}")("EMotionFX motion event memory allocator")) \
    ((MotionEventHandlerAllocator)               (SystemAllocator) (MotionAllocator)    ("{658DC073-5D33-4E08-B3F2-C9856E29AC9E}")("EMotionFX motion event handler memory allocator")) \
    ((MotionEventManagerAllocator)               (SystemAllocator) (MotionAllocator)    ("{61D4391F-F86E-404F-959D-0C6085BCD35D}")("EMotionFX motion event manager memory allocator")) \
    ((MotionManagerAllocator)                    (SystemAllocator) (MotionAllocator)    ("{ACFF8545-4D32-42A0-9C1B-6B127029F134}")("EMotionFX motion manager memory allocator")) \
    ((NodeAllocator)                             (SystemAllocator) (ActorAllocator)     ("{52EC041A-2F10-4990-A6C1-5CF43EF49EBC}")("EMotionFX node memory allocator")) \
    ((RecorderAllocator)                         (SystemAllocator) (GeneralAllocator)   ("{E01E8BF7-E103-4E99-AFF4-804D50665C6F}")("EMotionFX recorder memory allocator")) \
    ((SkeletonAllocator)                         (SystemAllocator) (ActorAllocator)     ("{83A8700C-224B-42A1-AB07-4C6E6165D4F4}")("EMotionFX skeleton memory allocator")) \
...
#define EMOTIONFX_SEQ_TAIL_STRIP_4(X) EMOTIONFX_SEQ_TAIL_STRIP_3(AZ_SEQ_TAIL(X))
...
#define EMOTIONFX_SEQ_HEAD_5(X) EMOTIONFX_SEQ_HEAD_1(EMOTIONFX_SEQ_TAIL_STRIP_4(X))
...
#define EMOTIONFX_ALLOCATOR_SEQ_GET_SUBALLOCATOR(X) EMOTIONFX_SEQ_HEAD_3(X)
#define EMOTIONFX_ALLOCATOR_SEQ_GET_UUID(X) EMOTIONFX_SEQ_HEAD_4(X)
#define EMOTIONFX_ALLOCATOR_SEQ_GET_DESCRIPTION(X) EMOTIONFX_SEQ_HEAD_5(X)

#define EMOTIONFX_ALLOCATOR_DECL(ALLOCATOR_SEQUENCE) \
    class EMOTIONFX_ALLOCATOR_SEQ_GET_NAME(ALLOCATOR_SEQUENCE) \
        : public AZ::EMOTIONFX_ALLOCATOR_SEQ_GET_TYPE(ALLOCATOR_SEQUENCE) \
    { \
