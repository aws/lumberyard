...
namespace EMotionFX
{
    ...
    class KeyTrackHermite
    {
        MCORE_MEMORYOBJECTCATEGORY(KeyTrackHermite, EMFX_DEFAULT_ALIGNMENT, EMFX_MEMCATEGORY_MOTIONS_KEYTRACKS);
