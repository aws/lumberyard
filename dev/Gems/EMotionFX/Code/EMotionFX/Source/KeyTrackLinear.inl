...
KeyTrackLinear<ReturnType, StorageType>::KeyTrackLinear()
{
}
...
template <class ReturnType, class StorageType>
KeyTrackLinear<ReturnType, StorageType>::KeyTrackLinear(uint32 nrKeys)
{
    SetNumKeys(nrKeys);
}
...
// clear all keys
template <class ReturnType, class StorageType>
void KeyTrackLinear<ReturnType, StorageType>::ClearKeys()
{
    mKeys.Clear();
}
...
// init the keytrack
template <class ReturnType, class StorageType>
void KeyTrackLinear<ReturnType, StorageType>::Init()
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::GetKey(uint32 nr)
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::GetFirstKey()
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::GetLastKey()
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE const KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::GetKey(uint32 nr) const
{
    MCORE_ASSERT(nr < mKeys.GetLength());
    return &mKeys[nr];
}
...
template <class ReturnType, class StorageType>
MCORE_INLINE const KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::GetFirstKey() const
{
    return (mKeys.GetLength() > 0) ? &mKeys[0] : nullptr;
}
...
template <class ReturnType, class StorageType>
MCORE_INLINE const KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::GetLastKey() const
{
    return (mKeys.GetLength() > 0) ? &mKeys.GetLast() : nullptr;
}
...
template <class ReturnType, class StorageType>
MCORE_INLINE float KeyTrackLinear<ReturnType, StorageType>::GetFirstTime() const
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE float KeyTrackLinear<ReturnType, StorageType>::GetLastTime() const
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE uint32 KeyTrackLinear<ReturnType, StorageType>::GetNumKeys() const
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackLinear<ReturnType, StorageType>::AddKey(float time, const ReturnType& value)
{
    #ifdef MCORE_DEBUG
    if (mKeys.GetLength() > 0)
    {
...
template <class ReturnType, class StorageType>
MCORE_INLINE uint32 KeyTrackLinear<ReturnType, StorageType>::FindKeyNumber(float curTime) const
{
...
// find a key at a given time
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackLinear<ReturnType, StorageType>::FindKey(float curTime)  const
{
    // find the key number
...
// perform interpolation
template <class ReturnType, class StorageType>
MCORE_INLINE ReturnType KeyTrackLinear<ReturnType, StorageType>::Interpolate(uint32 startKey, float currentTime) const
{
...
template <class ReturnType, class StorageType>
void KeyTrackLinear<ReturnType, StorageType>::AddKeySorted(float time, const ReturnType& value)
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackLinear<ReturnType, StorageType>::RemoveKey(uint32 keyNr)
{
    mKeys.Remove(keyNr);
}
...
template <class ReturnType, class StorageType>
void KeyTrackLinear<ReturnType, StorageType>::MakeLoopable(float fadeTime)
{
...
template <class ReturnType, class StorageType>
uint32 KeyTrackLinear<ReturnType, StorageType>::Optimize(float maxError)
{
    ...
    KeyTrackLinear<ReturnType, StorageType> keyTrackCopy;
...
// pre-alloc keys
template <class ReturnType, class StorageType>
bool KeyTrackLinear<ReturnType, StorageType>::SetNumKeys(uint32 numKeys)
{
    // resize the array of keys
    return mKeys.Resize(numKeys);
}


// set a given key
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackLinear<ReturnType, StorageType>::SetKey(uint32 keyNr, float time, const ReturnType& value)
{
...
// set a given key
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackLinear<ReturnType, StorageType>::SetStorageTypeKey(uint32 keyNr, float time, const StorageType& value)
{
    // adjust the value and time of the key
...
template <class ReturnType, class StorageType>
MCORE_INLINE bool KeyTrackLinear<ReturnType, StorageType>::CheckIfIsAnimated(const ReturnType& initialPose, float maxError) const
{
