...
namespace EMotionFX
{
    ...
    class KeyTrackTCB
    {
        MCORE_MEMORYOBJECTCATEGORY(KeyTrackTCB, EMFX_DEFAULT_ALIGNMENT, EMFX_MEMCATEGORY_MOTIONS_KEYTRACKS);
    ...
    public:
        ...
        struct TCBInfo
        {
            float   mTension;       /**< The tension, range [0..1]. */
            float   mContinuity;    /**< The continuity, range [0..1]. */
            float   mBias;          /**< The bias, range [0..1]. */
         ...
         */
        MCORE_INLINE ReturnType& GetTangent(uint32 keyNr) const;
         ...
         */
        MCORE_INLINE TCBInfo& GetTCBInfo(uint32 keyNr);
    ...
    protected:
        ...
        TCBInfo*    mTCBs;      /**< The TCB parameter values. */
    };


    // include keytrack inline code
#include "KeyTrackTCB.inl"
} // namespace EMotionFX
