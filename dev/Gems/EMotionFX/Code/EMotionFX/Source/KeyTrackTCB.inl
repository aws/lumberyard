...
KeyTrackTCB<ReturnType, StorageType>::KeyTrackTCB()
{
    mTangents   = nullptr;
    mTCBs       = nullptr;
}
...
template <class ReturnType, class StorageType>
KeyTrackTCB<ReturnType, StorageType>::KeyTrackTCB(uint32 nrKeys)
{
    SetNumKeys(nrKeys);
}
...
// clear all keys
template <class ReturnType, class StorageType>
void KeyTrackTCB<ReturnType, StorageType>::ClearKeys()
{
    mKeys.Clear();
    MCore::Free(mTangents);
    MCore::Free(mTCBs);
...
// init the keytrack
template <class ReturnType, class StorageType>
void KeyTrackTCB<ReturnType, StorageType>::Init()
{
    ...
    // init the TCB's when requesting them for the first time
    if (mTCBs == nullptr)
    {
        mTCBs  = (TCBInfo*)MCore::Realloc(mTCBs, sizeof(TCBInfo) * numKeys, EMFX_MEMCATEGORY_MOTIONS_KEYTRACKS);
        for (uint32 i = 0; i < numKeys; ++i)
        {
            mTCBs[i] = TCBInfo();
        }
    ...
    for (uint32 i = 0; i < numKeys; ++i)
    {
        ...
        else    // if there is a previous or next key
        {
            ...
            if (mTCBs)
            {
                ...
                //this->mTangents[i] = (0.5 * (value - prevValue)) + (0.5 * (nextValue - value));   // normal hermite interpolation
                //else
                mTangents[i] = (((1.0f - tension) * (1.0f + bias) * (1.0f + continuity)) * 0.5f) * (value - prevValue) + (((1.0f - tension) * (1.0f - bias) * (1.0f - continuity)) * 0.5f) * (nextValue - value);
            }
...
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackTCB<ReturnType, StorageType>::GetKey(uint32 nr)
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackTCB<ReturnType, StorageType>::GetFirstKey()
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE KeyFrame<ReturnType, StorageType>* KeyTrackTCB<ReturnType, StorageType>::GetLastKey()
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE const KeyFrame<ReturnType, StorageType>* KeyTrackTCB<ReturnType, StorageType>::GetKey(uint32 nr) const
{
    MCORE_ASSERT(nr < mKeys.GetLength());
    return &mKeys[nr];
}
...
template <class ReturnType, class StorageType>
MCORE_INLINE const KeyFrame<ReturnType, StorageType>* KeyTrackTCB<ReturnType, StorageType>::GetFirstKey() const
{
    return (mKeys.GetLength() > 0) ? &mKeys[0] : nullptr;
}
...
template <class ReturnType, class StorageType>
MCORE_INLINE const KeyFrame<ReturnType, StorageType>* KeyTrackTCB<ReturnType, StorageType>::GetLastKey() const
{
    return (mKeys.GetLength() > 0) ? &mKeys.GetLast() : nullptr;
}
...
template <class ReturnType, class StorageType>
MCORE_INLINE float KeyTrackTCB<ReturnType, StorageType>::GetFirstTime() const
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE float KeyTrackTCB<ReturnType, StorageType>::GetLastTime() const
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE uint32 KeyTrackTCB<ReturnType, StorageType>::GetNumKeys() const
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackTCB<ReturnType, StorageType>::AddKey(float time, const ReturnType& value)
{
    #ifdef MCORE_DEBUG
...
template <class ReturnType, class StorageType>
ReturnType KeyTrackTCB<ReturnType, StorageType>::GetValueAtTime(float currentTime, uint32* cachedKey, uint8* outWasCacheHit) const
{
...
// perform interpolation
template <class ReturnType, class StorageType>
MCORE_INLINE ReturnType KeyTrackTCB<ReturnType, StorageType>::Interpolate(uint32 startKey, float currentTime) const
{
...
template <class ReturnType, class StorageType>
void KeyTrackTCB<ReturnType, StorageType>::AddKeySorted(float time, const ReturnType& value)
{
...
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackTCB<ReturnType, StorageType>::RemoveKey(uint32 keyNr)
{
    mKeys.Remove(keyNr);
}
...
template <class ReturnType, class StorageType>
void KeyTrackTCB<ReturnType, StorageType>::MakeLoopable(float fadeTime)
{
...
template <class ReturnType, class StorageType>
uint32 KeyTrackTCB<ReturnType, StorageType>::Optimize(float maxError)
{
    ...
    KeyTrackTCB<ReturnType, StorageType> keyTrackCopy;
...
// pre-alloc keys
template <class ReturnType, class StorageType>
void KeyTrackTCB<ReturnType, StorageType>::SetNumKeys(uint32 numKeys)
{
...
// set a given key
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackTCB<ReturnType, StorageType>::SetKey(uint32 keyNr, float time, const ReturnType& value)
{
...
// set a given key
template <class ReturnType, class StorageType>
MCORE_INLINE void KeyTrackTCB<ReturnType, StorageType>::SetStorageTypeKey(uint32 keyNr, float time, const StorageType& value)
{
    // adjust the value and time of the key
...
template <class ReturnType, class StorageType>
MCORE_INLINE bool KeyTrackTCB<ReturnType, StorageType>::CheckIfIsAnimated(const ReturnType& initialPose, float maxError) const
{
...
// get a given tangent
template <class ReturnType, class StorageType>
MCORE_INLINE ReturnType& KeyTrackTCB<ReturnType, StorageType>::GetTangent(uint32 keyNr) const
{
...
// get a given tcb info
template <class ReturnType, class StorageType>
MCORE_INLINE typename KeyTrackTCB<ReturnType, StorageType>::TCBInfo& KeyTrackTCB<ReturnType, StorageType>::GetTCBInfo(uint32 keyNr)
{
    MCORE_ASSERT(keyNr < mKeys.GetLength());
