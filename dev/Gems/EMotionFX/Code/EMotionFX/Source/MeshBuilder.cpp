...
namespace EMotionFX
{
    ...
    void AddZeroVectors(AZStd::vector<AZ::Vector3>& tangents, AZStd::vector<AZ::Vector3>& bitangents, AZStd::vector<AZ::Vector2>& tangentsSpherical, AZStd::vector<AZ::Vector2>& bitangentsSpherical, uint32 numDuplicates)
    {
