...
namespace EMotionFX
{
    ...
    public:
        ...
        // with lock
        MotionInstance* RequestNew(Motion* motion, ActorInstance* actorInstance, uint32 startNodeIndex = MCORE_INVALIDINDEX32);
        void Free(MotionInstance* motionInstance);

        // without lock
        MotionInstance* RequestNewWithoutLock(Motion* motion, ActorInstance* actorInstance, uint32 startNodeIndex = MCORE_INVALIDINDEX32);
