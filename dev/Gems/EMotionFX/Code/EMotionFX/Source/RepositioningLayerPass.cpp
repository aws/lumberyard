...
namespace EMotionFX
{
    ...
    void RepositioningLayerPass::Process()
    {
        ...
        if (!actorInstance->GetMotionExtractionEnabled())
        {
            ...
            zeroTransform.ZeroWithIdentityQuaternion();
            actorInstance->SetTrajectoryDeltaTransform(zeroTransform);
            return;
        }
        ...
        Transform finalTrajectoryDelta;
        Transform trajectoryDelta;
        finalTrajectoryDelta.ZeroWithIdentityQuaternion();
