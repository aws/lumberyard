...
namespace EMotionFX
{
    ...
    protected:
        ...
        void SkinVertexRange(uint32 startVertex, uint32 endVertex, MCore::Vector3* positions, MCore::Vector3* normals, AZ::Vector4* tangents, uint32* orgVerts, SkinningInfoVertexAttributeLayer* layer);
    };
} // namespace EMotionFX
