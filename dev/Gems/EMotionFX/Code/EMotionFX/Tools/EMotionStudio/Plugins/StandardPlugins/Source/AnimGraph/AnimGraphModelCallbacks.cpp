...
namespace EMStudio
{
    bool AnimGraphModel::CommandDidLoadAnimGraphCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
    ...
    bool AnimGraphModel::CommandDidCreateAnimGraphCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
    ...
    bool AnimGraphModel::CommandDidActivateAnimGraphPostUndoCallback::Undo(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
    ...
    bool AnimGraphModel::CommandDidActivateAnimGraphCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
        CommandSystem::CommandActivateAnimGraph* commandActivateAnimGraph = static_cast<CommandSystem::CommandActivateAnimGraph*>(command);
        EMotionFX::ActorInstance* actorInstance = EMotionFX::GetActorManager().FindActorInstanceByID(commandActivateAnimGraph->mActorInstanceID);
        ...
        if (actorInstance)
        {
            ...
            if (oldAnimGraphInstance)
            {
                ...
                {
                    m_animGraphModel.SetAnimGraphInstance(oldAnimGraphInstance->GetAnimGraph(), nullptr, currentAnimGraphInstance);
                }
            }
            else
            {
    ...
    bool AnimGraphModel::CommandRemoveActorInstanceCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
    ...
    bool AnimGraphModel::CommandDidAdjustConnectionCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
        AZStd::string outResult;
    ...
    bool AnimGraphModel::CommandDidSetEntryStateCallback::Undo(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
    ...
    bool AnimGraphModel::CommandDidCreateMotionSetCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
    ...
    bool AnimGraphModel::CommandDidRemoveMotionSetCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
        EMotionFX::AnimGraphEditorRequestBus::Broadcast(&EMotionFX::AnimGraphEditorRequests::UpdateMotionSetComboBox);
        return true;
    }
    ...
    bool AnimGraphModel::CommandDidAdjustMotionSetCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
        EMotionFX::AnimGraphEditorRequestBus::Broadcast(&EMotionFX::AnimGraphEditorRequests::UpdateMotionSetComboBox);
        return true;
    }

    bool AnimGraphModel::CommandDidAdjustMotionSetCallback::Undo(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
        EMotionFX::AnimGraphEditorRequestBus::Broadcast(&EMotionFX::AnimGraphEditorRequests::UpdateMotionSetComboBox);
        return true;
    }
    ...
    bool AnimGraphModel::CommandDidLoadMotionSetCallback::Execute(MCore::Command* command, const MCore::CommandLine& commandLine)
    {
        EMotionFX::AnimGraphEditorRequestBus::Broadcast(&EMotionFX::AnimGraphEditorRequests::UpdateMotionSetComboBox);
        return true;
    }
