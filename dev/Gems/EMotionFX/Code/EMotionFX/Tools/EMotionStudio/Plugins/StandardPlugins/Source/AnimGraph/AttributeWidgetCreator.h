...
#define DEFINE_ANIMGRAPHATTRIBUTEWIDGETCREATOR(CLASSNAME, ATTRIBUTEWIDGETCLASSNAME, TYPEID, DEFAULTYPEID, MINMAXTYPEID, DATATYPEID, HASMINMAXVALUES, CANBEPARAMETER, TYPESTRING)                                                      \
    ...
    DEFINE_ANIMGRAPHATTRIBUTEWIDGETCREATOR(MorphTargetPickerAttributeWidgetCreator,         MorphTargetPickerAttributeWidget,       EMotionFX::ATTRIBUTE_INTERFACETYPE_MORPHTARGETPICKER,           EMotionFX::ATTRIBUTE_INTERFACETYPE_MORPHTARGETPICKER,           EMotionFX::ATTRIBUTE_INTERFACETYPE_MORPHTARGETPICKER,           MCore::AttributeArray::TYPE_ID,               false,  false,  "MorphTargetPicker");
}   // namespace EMStudio
