...
namespace EMStudio
{
    ...
    void BlendSpace1DNodeWidget::DrawPoints(QPainter& painter, EMotionFX::BlendSpace1DNode::UniqueData* uniqueData)
    {
        painter.setPen(QPen());
    ...
    EMotionFX::BlendSpace1DNode::UniqueData* BlendSpace1DNodeWidget::GetUniqueData() const
    {
        ...
        return static_cast<EMotionFX::BlendSpace1DNode::UniqueData*>(animGraphInstance->FindUniqueObjectData(blendSpaceNode));
    }
} // namespace EMStudio
