...
namespace MCore
{
    ...
    AttributeString* AttributeString::Create(const String& value)                       { AttributeString* result = static_cast<AttributeString*>(GetAttributePool().RequestNew(AttributeString::TYPE_ID)); result->SetValue(value); return result; }
