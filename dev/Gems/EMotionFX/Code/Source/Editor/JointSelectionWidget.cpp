...
namespace EMotionFX
{
    ...
    void JointSelectionWidget::SelectByJointName(const AZStd::string& jointName, bool clearSelection)
    {
    ...
    void JointSelectionWidget::OnTextFilterChanged(const QString& text)
    {
        m_treeView->expandAll();
    }

    void JointSelectionWidget::OnTypeFilterChanged(const AzQtComponents::SearchTypeFilterList& activeTypeFilters)
    {
        m_treeView->expandAll();
    }
} // namespace EMotionFX