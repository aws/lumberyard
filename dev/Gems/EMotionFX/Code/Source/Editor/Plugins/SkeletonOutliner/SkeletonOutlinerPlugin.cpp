...
namespace EMotionFX
{
    ...
    bool SkeletonOutlinerPlugin::Init()
    {
        ...
        header->resizeSection(1, s_iconSize);
        header->resizeSection(2, s_iconSize);
        header->resizeSection(3, s_iconSize);
        header->resizeSection(4, s_iconSize);
    ...
    void SkeletonOutlinerPlugin::OnTextFilterChanged(const QString& text)
    {
        m_treeView->expandAll();
    }

    void SkeletonOutlinerPlugin::OnTypeFilterChanged(const AzQtComponents::SearchTypeFilterList& activeTypeFilters)
    {
        m_treeView->expandAll();
    }
    ...
    void SkeletonOutlinerPlugin::OnSelectionChanged(const QItemSelection& selected, const QItemSelection& deselected)
    {
