...
namespace EMotionFX
{
    ...
    void AnimGraphTransitionIdPicker::Reinit()
    {
        ...
        vLayout->addLayout(transitionLayout);
        {
            ...
            for (const AZ::u64 id : m_transitionIds)
            {
                ...
                EMStudio::EMStudioManager::MakeTransparentButton(removeTransitionButton, "/Images/Icons/Trash.png", "Remove transition from list");
    ...
    void AnimGraphMultiTransitionIdHandler::ConsumeAttribute(AnimGraphTransitionIdPicker* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
        if (attrValue)
        {
    ...
    void AnimGraphMultiTransitionIdHandler::WriteGUIValuesIntoProperty(size_t index, AnimGraphTransitionIdPicker* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->GetTransitionIds();
    }

    bool AnimGraphMultiTransitionIdHandler::ReadValuesIntoGUI(size_t index, AnimGraphTransitionIdPicker* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
