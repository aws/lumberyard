...
namespace EMotionFX
{
    ...
    void BlendSpaceEvaluatorPicker::OnCurrentIndexChanged(int index)
    {
    ...
    void BlendSpaceEvaluatorHandler::ConsumeAttribute(BlendSpaceEvaluatorPicker* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
    ...
    void BlendSpaceEvaluatorHandler::WriteGUIValuesIntoProperty(size_t index, BlendSpaceEvaluatorPicker* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->GetEvaluatorType();
    }


    bool BlendSpaceEvaluatorHandler::ReadValuesIntoGUI(size_t index, BlendSpaceEvaluatorPicker* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
...
#include <Source/Editor/PropertyWidgets/BlendSpaceEvaluatorHandler.moc>