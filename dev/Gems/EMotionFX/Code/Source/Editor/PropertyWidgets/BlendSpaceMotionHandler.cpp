...
namespace EMotionFX
{
    AZ_CLASS_ALLOCATOR_IMPL(BlendSpaceMotionPicker, AZ::SystemAllocator, 0)
    AZ_CLASS_ALLOCATOR_IMPL(BlendSpaceMotionHandler, AZ::SystemAllocator, 0)
    ...
    void BlendSpaceMotionPicker::OnCurrentIndexChanged(int index)
    {
        emit MotionChanged();
    }
    ...
    void BlendSpaceMotionHandler::ConsumeAttribute(BlendSpaceMotionPicker* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
        if (attrValue)
        {
    ...
    void BlendSpaceMotionHandler::WriteGUIValuesIntoProperty(size_t index, BlendSpaceMotionPicker* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->GetMotionId();
    }


    bool BlendSpaceMotionHandler::ReadValuesIntoGUI(size_t index, BlendSpaceMotionPicker* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
...
#include <Source/Editor/PropertyWidgets/BlendSpaceMotionHandler.moc>