...
namespace EMotionFX
{
    ...
    AZ_CLASS_ALLOCATOR_IMPL(MotionIdRandomSelectionWeightsHandler, AZ::SystemAllocator, 0)
    AZ_CLASS_ALLOCATOR_IMPL(MotionSetMultiMotionIdHandler, AZ::SystemAllocator, 0)
    AZ_CLASS_ALLOCATOR_IMPL(MotionSelectionIdWidgetController, AZ::SystemAllocator, 0)
    ...
    void MotionIdRandomSelectionWeightsHandler::ConsumeAttribute(MotionSetMotionIdPicker* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
    ...
    void MotionIdRandomSelectionWeightsHandler::WriteGUIValuesIntoProperty(size_t index, MotionSetMotionIdPicker* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
    ...
    bool MotionIdRandomSelectionWeightsHandler::ReadValuesIntoGUI(size_t index, MotionSetMotionIdPicker* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
