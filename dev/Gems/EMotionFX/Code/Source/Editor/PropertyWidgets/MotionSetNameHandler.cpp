...
namespace EMotionFX
{
    ...
    void MotionSetNameHandler::ConsumeAttribute(QComboBox* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
...
#include <Source/Editor/PropertyWidgets/MotionSetNameHandler.moc>