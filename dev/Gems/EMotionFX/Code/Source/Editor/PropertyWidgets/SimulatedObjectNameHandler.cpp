...
namespace EMotionFX
{
    ...
    void SimulatedObjectNameHandler::ConsumeAttribute(SimulatedObjectNameLineEdit* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
    ...
    void SimulatedObjectNameHandler::WriteGUIValuesIntoProperty(size_t index, SimulatedObjectNameLineEdit* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->text().toUtf8().data();
    }

    bool SimulatedObjectNameHandler::ReadValuesIntoGUI(size_t index, SimulatedObjectNameLineEdit* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
