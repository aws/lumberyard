...
namespace EMotionFX
{
    ...
    QWidget* SimulatedObjectSelectionHandler::CreateGUI(QWidget* parent)
    {
        ...
        connect(picker, &SimulatedObjectPicker::SelectionChanged, this, [picker](const AZStd::vector<AZStd::string>& newSimulatedObjects)
        {
    ...
    void SimulatedObjectSelectionHandler::ConsumeAttribute(SimulatedObjectPicker* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
