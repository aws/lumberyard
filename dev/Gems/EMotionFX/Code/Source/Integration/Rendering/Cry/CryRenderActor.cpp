...
namespace EMotionFX
{
    namespace Integration
    {
            ...
            , m_actorAsset(actorAsset)
        {
            ...
            CryRenderActorRequestBus::Handler::BusConnect(actorAssetId);
        }

        CryRenderActor::~CryRenderActor()
        {
            CryRenderActorRequestBus::Handler::BusDisconnect();
        }
        ...
        bool CryRenderActor::Init()
        {
            ...
            const AZ::Data::AssetId actorAssetId = m_actorAsset->GetId();
            AZStd::function<void()> finalizeOnMainThread = [actorAssetId]()
            {
                ...
                CryRenderActorRequestBus::Event(actorAssetId, &CryRenderActorRequests::Finalize);
            };
