...
namespace EMotionFX
{
        ...
        : AzToolsFramework::PropertyTypeRegistrationMessages::Bus::Handler
    {
        ...
        AzToolsFramework::PropertyHandlerBase* ResolvePropertyHandler(AZ::u32 handlerName, const AZ::Uuid& handlerType) override
        {
            return {};
        }
        ...
        : AzFramework::AssetSystemRequestBus::Handler
    {
        ...
        int m_compileSyncCount = 0;
        int m_escalateCount = 0;
    };
    ...
    TEST_F(MotionSetFixture, MeshLoadTest)
    {
        ...
        handler->LoadAssetData(asset, fileName.c_str(), &AZ::Data::AssetFilterNoAssetLoading);
        handler->OnInitAsset(asset);

        ASSERT_EQ(assetSystem.m_escalateCount, 2);
        ASSERT_EQ(assetSystem.m_compileSyncCount, 2);
    }
