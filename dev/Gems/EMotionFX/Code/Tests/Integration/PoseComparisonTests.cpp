    ...
    INSTANTIATE_TEST_CASE_P(Integ_TestPoses, INTEG_PoseComparisonFixture,
        ::testing::Values(
            PoseComparisonFixtureParams (
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin.actor",
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin.animgraph",
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin.motionset",
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin.emfxrecording"
            ),
            PoseComparisonFixtureParams (
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Pendulum/pendulum.actor",
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Pendulum/pendulum.animgraph",
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Pendulum/pendulum.motionset",
                "@assets@/Gems/EMotionFX/Code/Tests/TestAssets/Pendulum/pendulum.emfxrecording"
            )
        )
    );
