...
namespace EMotionFX
{
    ...
    //--------------------------------------------------------------------------
    class KeyTrackLinearFixture : public SystemComponentFixture
    {
    public:
        KeyTrackLinearFixture()
            : SystemComponentFixture()
        {
        }

        void LogFloatTrack(KeyTrackLinear<float, float>& track)
        {
            AZ_Printf("EMotionFX", "----------\n");
        ...
        void FillFloatTrackZeroToThree(KeyTrackLinear<float, float>& track)
        {
            track.ClearKeys();
    ...
    // The actual tests.
    //--------------------------------------------------------------------------
    TEST_F(KeyTrackLinearFixture, KeyTrackAdd)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
        ASSERT_EQ(track.GetNumKeys(), 4);
    }

    TEST_F(KeyTrackLinearFixture, KeyTrackAddSorted)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
    ...
    TEST_F(KeyTrackLinearFixture, KeyTrackRemoveKey)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
        ASSERT_EQ(track.GetNumKeys(), 4);
    ...
    TEST_F(KeyTrackLinearFixture, KeyTrackClearKeys)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
        ASSERT_EQ(track.GetNumKeys(), 4);
    ...
    TEST_F(KeyTrackLinearFixture, KeyTrackCheckIfIsAnimated)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
    ...
    TEST_F(KeyTrackLinearFixture, KeyTrackGetFirstKey)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
    ...
    TEST_F(KeyTrackLinearFixture, KeyTrackGetLastKey)
    {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
   ...
   TEST_F(KeyTrackLinearFixture, KeyTrackFindKeyNumber)
   {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
   ...
   TEST_F(KeyTrackLinearFixture, KeyTrackSetNumKeys)
   {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
        track.SetNumKeys(10);
   ...
   TEST_F(KeyTrackLinearFixture, KeyTrackOptimize)
   {
        EMotionFX::KeyTrackLinear<float, float> track;
        track.AddKey(0.0f, 0.0f);
        track.AddKey(1.0f, 1.0f);
   ...
   TEST_F(KeyTrackLinearFixture, KeyTrackGetValueAtTime)
   {
        EMotionFX::KeyTrackLinear<float, float> track;
        FillFloatTrackZeroToThree(track);
