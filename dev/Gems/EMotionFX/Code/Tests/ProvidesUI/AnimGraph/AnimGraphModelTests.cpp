...
namespace EMotionFX
{
    ...
    public:
        ...
        void CallOnAnimGraphAssetChanged(AnimGraphReferenceNode* referenceNode)
        {
            ...
            for (const auto& [attributeId, attribute] : animGraphElement->m_attributes)
            {
                ...
                somethingCalled |= AZ::AttributeReader(referenceNode, attribute).Invoke<void>();
            }
    ...
    TEST_F(AnimGraphModelFixture, CanReloadAReferenceNodesReferencedGraph)
    {
...

        {
            ...
            AZ::Data::Asset<Integration::AnimGraphAsset> newAsset{handler->CreateAsset(assetId, AZ::AzTypeInfo<Integration::AnimGraphAsset>::Uuid())};
