...
namespace EMotionFX
{
    TEST_F(AnimGraphUIFixture, CanEditTransition)
    {
        ...
        typedef AZStd::pair<AzToolsFramework::InstanceDataNode*, AzToolsFramework::PropertyRowWidget*> WidgetListItem;
        typedef AZStd::unordered_map<AzToolsFramework::InstanceDataNode*, AzToolsFramework::PropertyRowWidget*> WidgetList;
