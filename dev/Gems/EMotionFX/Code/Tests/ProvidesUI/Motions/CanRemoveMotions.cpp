...
namespace EMotionFX
{
    ...
    TEST_F(UIFixture, CanRemoveMotions)
    {
        ...
        */
        ...
        const AZStd::string motionCmd = "ImportMotion -filename Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin_idle.motion";
        ...
        const AZStd::string motionJumpCmd = "ImportMotion -filename Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin_jump.motion";
