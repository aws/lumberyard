...
namespace EMotionFX
{
    TEST_F(UIFixture, CanAddJointAndChildren)
    {
        ...
        */
        ...
        QAction* addJointAndChildrenAction;
        EXPECT_TRUE(UIFixture::GetActionFromContextMenu(addJointAndChildrenAction, simulatedObjectMenu, "Add joint and children"));
        QMenu* addSelectedJointMenu = addJointAndChildrenAction->menu();
