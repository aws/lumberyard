...
namespace EMotionFX
{
    ...
    public:
        ...
        {
            QString dataDir = GetEMotionFX().GetAssetSourceFolder().c_str();
        ...
        void TestSaveWorkspaceMenuOption(QMenu* fileMenu, const QString& workspaceFilename)
        {
        ...
        {
            QString assets = GetEMotionFX().GetAssetSourceFolder().c_str();
            return assets + "Gems/EMotionFX/Code/Tests/TestAssets/Rin/rin_Idle.motion";
        }
