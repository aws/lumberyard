...
namespace EditorPythonBindings
{
        ...
        public:
            ...
            AZStd::optional<PythonMarshalTypeRequests::PythonValueResult> BehaviorValueParameterToPython(AZ::BehaviorValueParameter& behaviorValue) override
            {
                ...
                if (behaviorValue.ConvertTo(m_typeId))
                {
                    ...
                    auto elementCallback = [pythonDictionary, cleanUpList](void* instancePointer, const auto& elementClassId, const auto* elementGenericClassData, const auto* genericClassElement)
                    {
                        pybind11::object pythonKey { pybind11::none() };
                        pybind11::object pythonItem { pybind11::none() };

                        // visit the AZStd::pair<K,V> elements
                        auto pairCallback = [cleanUpList, &pythonKey, &pythonItem](void* instancePair, const auto& elementClassId, const auto* elementGenericClassData, const auto* genericClassElement)
                        {
        ...
        public:
            ...
            AZStd::optional<PythonMarshalTypeRequests::PythonValueResult> BehaviorValueParameterToPython(AZ::BehaviorValueParameter& behaviorValue) override
            {
                ...
                if (behaviorValue.ConvertTo(m_typeId) && container)
                {
                    ...
                    auto elementCallback = [this, pythonList, deleterList](void* instancePointer, const auto& elementClassId, const auto* elementGenericClassData, const auto* genericClassElement)
                    {
    ...
    void PythonMarshalComponent::Activate()
    {
        ...
        RegisterTypeConverter(AZ::AzTypeInfo<AZ::VectorFloat>::Uuid(), AZStd::make_unique<TypeConverterReal<AZ::VectorFloat, float, float>>());
