...
namespace UnitTest
{
    ...
    struct CustomTypeHandlerTester final
    {
        ...
        AZ::CustomType<AZ::MyCustomData> CustomTypeHandlerTester::CreateCustomData(
            AZ::s32 s32Value,
            AZ::u32 u32Value,
            AZ::s16 s16Value,
            AZ::u16 u16Value)
        ...
        : public EditorPythonBindings::CustomTypeBindingNotificationBus::MultiHandler
    {
        ...
        static const Handle NoAllocation { ~0UL };
            ...
            AZ::BehaviorValueParameter& outValue) override
        {
            ...
            if (typeId == azrtti_typeid<AZ::CustomType<int>>())
            {
                ...
                outValue.StoreInTempData<AZ::CustomType<int>>({ PyLong_AsLong(pyObj) });
                return { NoAllocation };
            }
            else if (typeId == azrtti_typeid<AZ::CustomType<float>>())
            {
