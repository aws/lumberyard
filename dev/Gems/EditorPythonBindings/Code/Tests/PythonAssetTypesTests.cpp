...
namespace UnitTest
{
    ...
    public:
        ...
        void PrintFooMockSimpleAsset(AzFramework::SimpleAssetReference<FooMockSimpleAsset>& fooMockSimpleAsset)
        {
    ...
    struct PythonReflectionAssetTypes
    {
        ...
        PythonReflectionAssetTypes()
        {
            ...
            m_myTestAssetDataAsset = &m_testAssetData;
        ...
        ~PythonReflectionAssetTypes()
        {
            ...
            m_myTestAssetDataAsset = nullptr;
        }

        static void PrintAssetData(const AZ::Data::Asset<AZ::Data::AssetData>& assetData)
        {
            AZ_TracePrintf("python", "Asset Data ID = %s\n",
                assetData.GetId().ToString<AZStd::string>().c_str());
        }

        static void PrintSimpleAssetReference(const AzFramework::SimpleAssetReferenceBase& simpleAssetRef)
        {
        ...
        static AZ::Data::Asset<AZ::Data::AssetData> GenerateAsset()
        {
            ...
            Internal::s_asset = &Internal::s_mockAssetData;
        ...
        AZ::Data::Asset<MyTestAssetData> CreateMyTestAssetData()
        {
            ...
            return AZ::Data::Asset<MyTestAssetData>(m_myTestAssetData.get());
        }
