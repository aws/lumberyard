...
namespace UnitTest
{
    ...
    public:
       ...
       MOCK_CONST_METHOD1(ListBuildsCallable
        ...
        Model::CreateGameSessionOutcomeCallable CreateGameSessionCallableMock(const Model::CreateGameSessionRequest& request) const
        {
        ...
        Model::StartGameSessionPlacementOutcomeCallable StartGameSessionPlacementCallableMock(const Model::StartGameSessionPlacementRequest& request) const
        {
            Model::GameSession gameSession = GetGameSessionMock();
        ...
        Model::DescribeGameSessionPlacementOutcomeCallable DescribeGameSessionPlacementCallableMock(const Model::DescribeGameSessionPlacementRequest& request) const
        {
            Model::GameSessionPlacement placement = Model::GameSessionPlacement();
            placement.SetPlacementId(m_testPlacementId);
        ...
        Model::DescribeGameSessionDetailsOutcome DescribeGameSessionDetailsMock(const Model::DescribeGameSessionDetailsRequest& request) const
        {
        ...
        Model::SearchGameSessionsOutcomeCallable SearchGameSessionsCallableMock(const Model::SearchGameSessionsRequest& request) const
        {
        ...
        Model::DescribeGameSessionQueuesOutcomeCallable DescribeGameSessionQueuesCallableMock(const Model::DescribeGameSessionQueuesRequest& request) const
        {
        ...
        Model::StartMatchmakingOutcomeCallable StartMatchmakingCallableMock(const Model::StartMatchmakingRequest& request) const
        {
        ...
        Model::DescribeMatchmakingOutcomeCallable DescribeMatchmakingCallableMock(const Model::DescribeMatchmakingRequest& request) const
        {
        ...
        Model::DescribeGameSessionsOutcomeCallable DescribeGameSessionsCallableMock(const Model::DescribeGameSessionsRequest& request) const
        {
        ...
        Model::CreatePlayerSessionOutcomeCallable CreatePlayerSessionCallableMock(const Model::CreatePlayerSessionRequest& request) const
        {
        ...
        Model::ListBuildsOutcomeCallable ListBuildsCallableMock(const Model::ListBuildsRequest& request) const
        {
        ...
        std::future<T> CallableErrorMock(const U& request) const
        {
        ...
        template <typename T, typename U>
        T ErrorMock(const U& request) const
        {
            Aws::Client::AWSError<GameLiftErrors> error;
            error.SetExceptionName(m_testError);
            T outcome(error);
