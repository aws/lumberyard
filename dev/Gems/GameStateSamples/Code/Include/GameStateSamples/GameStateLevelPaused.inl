...
namespace GameStateSamples
{
    ...
    inline void GameStateLevelPaused::PauseGame()
    {
        ...
        IGame* iGame = iSystem ? iSystem->GetIGame() : nullptr;
        IGameFramework* iGameFramework = iGame ? iGame->GetIGameFramework() : nullptr;
        if (iGameFramework)
        {
            iGameFramework->PauseGame(true, false);
        }
    }
    ...
    inline void GameStateLevelPaused::UnpauseGame()
    {
        ...
        if (iGameFramework)
        {
            iGameFramework->PauseGame(false, false);
        }
    }
}
