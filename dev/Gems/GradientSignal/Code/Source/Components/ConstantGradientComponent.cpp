...
namespace GradientSignal
{
    ...
    void ConstantGradientComponent::GetRequiredServices(AZ::ComponentDescriptor::DependencyArrayType& services)
    {
    }
    ...
    float ConstantGradientComponent::GetValue(const GradientSampleParams& sampleParams) const
    {
