...
namespace UnitTest
{
    ...
    TEST_F(GradientSignalTestGeneratorFixture, PerlinGradientComponent_GoldenMasterTest)
    {
        // Make sure PerlinGradientComponent generates a set of values that
        // matches a previously-calculated "golden master" set of values.
    ...
    TEST_F(GradientSignalTestGeneratorFixture, RandomGradientComponent_GoldenMasterTest)
    {
        // Make sure RandomGradientComponent returns back a "golden master" set
