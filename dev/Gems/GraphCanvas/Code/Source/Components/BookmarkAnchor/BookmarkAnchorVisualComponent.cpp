...
namespace GraphCanvas
{
    ...
    void BookmarkAnchorVisualGraphicsWidget::OnPositionChanged(const AZ::EntityId& entityId, const AZ::Vector2& position)
    {
    ...
    void BookmarkAnchorVisualGraphicsWidget::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget)
    {
