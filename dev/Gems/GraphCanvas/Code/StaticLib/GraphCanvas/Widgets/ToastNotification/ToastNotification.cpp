...
namespace GraphCanvas
{
    ...
    void ToastNotification::mousePressEvent(QMouseEvent* mouseEvent)
    {
        if (m_closeOnClick)
        {
    ...
    bool ToastNotification::eventFilter(QObject* object, QEvent* event)
    {
...
#include <StaticLib/GraphCanvas/Widgets/ToastNotification/ToastNotification.moc>
}
