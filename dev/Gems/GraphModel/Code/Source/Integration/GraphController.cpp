...
namespace GraphModelIntegration
{
    ...
    AZ::EntityId GraphController::CreateNodeUi(GraphModel::NodeId nodeId, GraphModel::NodePtr node, AZStd::function<AZ::Vector2(AZ::EntityId/*nodeUiId*/)> getScenePosition)
    {
        using namespace GraphModel;
    ...
    void GraphController::CenterOnNodes(GraphModel::NodePtrList nodes)
    {
        ...
        QRectF boundingRect(topLeft.GetX(), topLeft.GetY(), boundingBox.GetWidth(), boundingBox.GetHeight());
    ...
    bool GraphController::IsValidVariableAssignment(const AZ::EntityId& variableId, const GraphCanvas::Endpoint& targetPoint) const
    {
    ...
    GraphCanvas::NodePropertyDisplay* GraphController::CreatePropertySlotPropertyDisplay(const AZ::Crc32& propertyId, const GraphCanvas::NodeId& nodeUiId, const GraphCanvas::SlotId& slotUiId) const
    {
    ...
    GraphCanvas::NodePropertyDisplay* GraphController::CreateDataSlotPropertyDisplay(const AZ::Uuid& dataTypeUuid, const GraphCanvas::NodeId& nodeUiId, const GraphCanvas::SlotId& slotUiId) const
    {
