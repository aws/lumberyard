...
namespace GraphModelIntegrationTest
{
    ...
    void GraphModelTestEnvironment::SetupEnvironment()
    {
        ...
        // Setup loading of GraphModel.Editor gem so that the tests will be able to
        // access the systems and buses
        AZ::DynamicModuleDescriptor dynamicModuleDescriptor = AZ::DynamicModuleDescriptor();
        dynamicModuleDescriptor.m_dynamicLibraryPath = "Gem.GraphModel.Editor.0844f64a3acf4f5abf3a535dc9b63bc9.v0.1.0";
