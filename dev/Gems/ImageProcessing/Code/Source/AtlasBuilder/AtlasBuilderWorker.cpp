...
namespace TextureAtlasBuilder
{
        ...
        AssetBuilderSDK::CreateJobsResponse& response)
    {
        ...
        AzFramework::StringFunc::Path::Join(
            request.m_watchFolder.c_str(), request.m_sourceFile.c_str(), fullPath, true, true, true);
        ...
        AssetBuilderSDK::ProcessJobResponse& response)
    {
        ...
        AzFramework::StringFunc::Path::Join(
            request.m_tempDirPath.c_str(), fileName.c_str(), outputPath, true, true, true);
        ...
        imageFileName += ".dds";
        AzFramework::StringFunc::Path::Join(
            request.m_tempDirPath.c_str(), imageFileName.c_str(), imageOutputPath, true, true, true);
