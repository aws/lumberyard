...
namespace ImageProcessing
{
    ...
    EPixelFormat ETC2Compressor::GetSuggestedUncompressedFormat(EPixelFormat compressedfmt, EPixelFormat uncompressedfmt)
    {
        return ePixelFormat_R8G8B8A8;
    }
    
    bool ETC2Compressor::DoesSupportDecompress(EPixelFormat fmtDst)
    {
        return false;
    }
    ...
    IImageObjectPtr ETC2Compressor::DecompressImage(IImageObjectPtr srcImage, EPixelFormat fmtDst)
    {
