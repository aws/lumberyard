...
namespace ImageProcessing
{
    ...
    EPixelFormat PVRTCCompressor::GetSuggestedUncompressedFormat(EPixelFormat compressedfmt, EPixelFormat uncompressedfmt)
    {
        return ePixelFormat_R8G8B8A8;
    }


    bool PVRTCCompressor::DoesSupportDecompress(EPixelFormat fmtDst)
    {
        return true;
    }
