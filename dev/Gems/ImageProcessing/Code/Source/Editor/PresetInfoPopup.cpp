...
namespace ImageProcessingEditor
{
    ...
    static const char* MipGenEvalTypeToString(MipGenEvalType mipGenEvalType)
    {
        static const char* mipGenEvalTypeNames[] = { "sum", "max", "min" };
        AZ_Assert(mipGenEvalType <= MipGenEvalType::min, "Invalid MipGenEvalType!");
        return  mipGenEvalTypeNames[(int)mipGenEvalType];
    }
...
#include <Source/Editor/PresetInfoPopup.moc>
