...
namespace ImageProcessingEditor
{
    ...
    void TexturePropertyEditor::OnSave()
    {
        ...
        if (sourceControlActive)
        {
            ...
            ApplicationBus::BroadcastResult(checkoutResult, &ApplicationBus::Events::RequestEditForFileBlocking, outputPath.c_str(), "Checking out .imagesetting file", [](int& current, int& max) {});
...
#include <Source/Editor/TexturePropertyEditor.moc>
