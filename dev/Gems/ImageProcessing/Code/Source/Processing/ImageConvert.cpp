...
#undef AZ_RESTRICTED_PLATFORM_EXPANSION
        ...
        , const PlatformName& platformName, AZ::SerializeContext* context)
    {
        ...
        fileName += ".dds";
        AzFramework::StringFunc::Path::Join(exportDir.c_str(), fileName.c_str(), outputPath, true, true, true);
    ...
    void ImageConvertProcess::CreateDiffuseCubemap()
    {
        ...
        fileName += "_diff.dds";
        AzFramework::StringFunc::Path::Join(folderName.c_str(), fileName.c_str(), outProductPath, true, true, true);
    ...
    IImageObjectPtr MergeOutputImageForPreview(IImageObjectPtr image, IImageObjectPtr alphaImage)
    {
        ...
        if (alphaImage)
        {
            ...
            ImageToProcess imageToProcess(alphaImage);
            imageToProcess.ConvertFormat(ePixelFormat_A8);
            IImageObjectPtr previewImageAlpha = imageToProcess.Get();
