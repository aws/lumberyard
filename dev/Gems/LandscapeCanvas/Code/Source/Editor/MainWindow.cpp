...
#undef REGISTER_NODE_PALETTE_ITEM_UNIQUE
    ...
    void MainWindow::HandleWrapperNodeActionWidgetClicked(GraphModel::NodePtr wrapperNode, const QRect& actionWidgetBoundingRect, const QPointF& scenePoint, const QPoint& screenPoint)
    {
    ...
    void MainWindow::UpdateConnectionData(GraphModel::ConnectionPtr connection, bool added)
    {
        ...
        QTimer::singleShot(0, [this, graphId, targetNode, targetSlot, newEntityId, propertyPath, elementIndexToModify, elementInContainer]() {
            ...
            m_serializeContext->EnumerateObject(component,
                ...
                [this, propertyPath, elementIndexToModify, elementInContainer](void *instance, const AZ::SerializeContext::ClassData *classData, const AZ::SerializeContext::ClassElement *classElement) -> bool
                {
    ...
    void MainWindow::ParseNodeConnections(GraphCanvas::GraphId graphId, GraphModel::NodePtr node, ConnectionsList& connections)
    {
        ...
        m_serializeContext->EnumerateObject(component,
            // beginElemCB
            [this, &previewEntityId, &inboundShapeEntityId, &gradientSamplerIds, &vegetationAreaIds](void *instance, const AZ::SerializeContext::ClassData *classData, const AZ::SerializeContext::ClassElement *classElement) -> bool
        {
...
#include <Source/Editor/MainWindow.moc>
