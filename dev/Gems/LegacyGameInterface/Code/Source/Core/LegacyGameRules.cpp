...
{
    DECLARE_DEFAULT_COMPONENT_FACTORY(LegacyGameRules, IGameRules)

    bool LegacyGameRules::Init(IGameObject* pGameObject)
    {
    ...
    void LegacyGameRules::PostInit(IGameObject* pGameObject)
    {
    ...
    bool LegacyGameRules::OnClientConnect(ChannelId channelId, bool isReset)
    {
