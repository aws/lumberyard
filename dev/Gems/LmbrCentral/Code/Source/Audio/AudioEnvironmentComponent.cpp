...
namespace LmbrCentral
{
    ...
    {
        extern bool ConvertOldAudioEnvironmentComponent(AZ::SerializeContext&, AZ::SerializeContext::DataElementNode&);
    } // namespace ClassConverters
    ...
    void AudioEnvironmentComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            // Deprecate the old AudioEnvironmentComponent in favor of a new Editor component.
            serializeContext->ClassDeprecate("AudioEnvironmentComponent", "{DDDCA462-A8E2-4D09-952C-22BAF89B7ED1}", &ClassConverters::ConvertOldAudioEnvironmentComponent);
