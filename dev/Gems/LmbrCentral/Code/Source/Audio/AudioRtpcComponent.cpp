...
namespace LmbrCentral
{
    ...
    {
        extern bool ConvertOldAudioRtpcComponent(AZ::SerializeContext&, AZ::SerializeContext::DataElementNode&);
    } // namespace ClassConverters
    ...
    void AudioRtpcComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            // Deprecate the old AudioRtpcComponent in favor of a new Editor component.
            serializeContext->ClassDeprecate("AudioRtpcComponent", "{4441F9C5-D4AD-40CF-B1DE-D5A296C03798}", &ClassConverters::ConvertOldAudioRtpcComponent);
