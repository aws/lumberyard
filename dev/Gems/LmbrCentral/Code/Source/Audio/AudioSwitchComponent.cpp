...
namespace LmbrCentral
{
    ...
    {
        extern bool ConvertOldAudioSwitchComponent(AZ::SerializeContext&, AZ::SerializeContext::DataElementNode&);
    } // namespace ClassConverters
    ...
    void AudioSwitchComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            // Deprecate the old AudioSwitchComponent in favor of a new Editor component.
            serializeContext->ClassDeprecate("AudioSwitchComponent", "{7A23B947-8EE8-4E6B-A772-C43BBBB4D090}", &ClassConverters::ConvertOldAudioSwitchComponent);
