...
namespace CopyDependencyBuilder
{
    ...
    bool CfgBuilderWorker::ParseProductDependenciesFromCfgContents(const AZStd::string& fullPath, const AZStd::string& contents, AssetBuilderSDK::ProductPathDependencySet& pathDependencies)
    {
