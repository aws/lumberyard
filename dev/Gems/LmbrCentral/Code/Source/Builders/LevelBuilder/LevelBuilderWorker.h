...
namespace LevelBuilder
{
    ...
    public:
        ...
        void PopulateLevelSliceDependenciesHelper(AZ::IO::GenericStream* stream, AZStd::vector<AssetBuilderSDK::ProductDependency>& productDependencies, AssetBuilderSDK::ProductPathDependencySet& productPathDependencies) const;
