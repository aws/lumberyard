...
namespace SliceBuilder
{
    ...
    public:
        ...
        static bool GetCompiledSliceAsset(AZ::IO::GenericStream* stream, const char* fullPath, const AZ::PlatformTagSet& platformTags, AZ::Data::Asset<AZ::SliceAsset>& outSliceAsset);
