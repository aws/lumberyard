...
namespace LmbrCentral
{
    ...
    AZ::Aabb DiskShape::GetEncompassingAabb()
    {
        ...
        return AZ::Aabb::CreateCenterHalfExtents(m_currentTransform.GetPosition(), halfsize);
    }
    ...
    bool DiskShape::IsPointInside(const AZ::Vector3& point)
    {
    ...
    float DiskShape::DistanceSquaredFromPoint(const AZ::Vector3& point)
    {
        ...
        AZ::Plane plane = AZ::Plane::CreateFromNormalAndPoint(m_intersectionDataCache.m_normal, m_currentTransform.GetPosition());
        ...
        AZ::Vector3 centerToClosestPoint = closestPointToPlane - m_currentTransform.GetPosition();
        ...
        AZ::Vector3 closestPoint = m_currentTransform.GetPosition() + centerToClosestPoint;
    ...
    bool DiskShape::IntersectRay(const AZ::Vector3& src, const AZ::Vector3& dir, AZ::VectorFloat& distance)
    {
        m_intersectionDataCache.UpdateIntersectionParams(m_currentTransform, m_diskShapeConfig);
        ...
        const AZ::Transform& currentTransform, const DiskShapeConfig& configuration)
    {
        ...
        m_normal = currentTransform.GetBasisZ().GetNormalizedExact();
