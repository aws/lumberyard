...
namespace LmbrCentral
{
    ...
    inline void DependencyMonitor::OnShapeChanged(ShapeComponentNotifications::ShapeChangeReasons reasons)
    {
        SendNotification();
    }
    ...
    inline void DependencyMonitor::OnAssetMoved(AZ::Data::Asset<AZ::Data::AssetData> asset, void* oldDataPointer)
    {
        SendNotification();
    }
    ...
    inline void DependencyMonitor::OnAssetUnloaded(const AZ::Data::AssetId assetId, const AZ::Data::AssetType assetType)
    {
        SendNotification();
    }
