...
namespace LmbrCentral
{
    ...
    public:
        ...
        virtual void OceanHeightChanged(float height) {}

        //! Notifies when a water volume is moved
        virtual void WaterVolumeTransformChanged(AZ::EntityId entityId, const AZ::Transform& worldTransform) {}

        //! Notifies when a water volume shape is changed
        virtual void WaterVolumeShapeChanged(AZ::EntityId entityId) {}
    };
