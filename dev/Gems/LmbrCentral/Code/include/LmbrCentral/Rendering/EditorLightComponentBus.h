...
namespace LmbrCentral
{
    ...
    */
    ...
    //! @deprecated Use EditorLightComponentRequests
    using LightComponentEditorRequests = EditorLightComponentRequests;
    //! @deprecated Use EditorLightComponentRequestBus
    using LightComponentEditorRequestBus = EditorLightComponentRequestBus;
