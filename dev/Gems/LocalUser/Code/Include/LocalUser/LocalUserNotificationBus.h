...
namespace LocalUser
{
    ...
    public:
        ...
        virtual void OnLocalUserIdAssignedToLocalPlayerSlot(AzFramework::LocalUserId localUserId,
        ...
        virtual void OnLocalUserIdRemovedFromLocalPlayerSlot(AzFramework::LocalUserId localUserId,
