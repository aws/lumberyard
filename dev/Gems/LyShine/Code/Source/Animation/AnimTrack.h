...
public:
    ...
    virtual IUiAnimTrack* GetSubTrack(int nIndex) const { return 0; };
    ...
    virtual void GetValue(float time, AZ::Vector2& value) { assert(0); };
    virtual void GetValue(float time, AZ::Vector3& value) { assert(0); };
    virtual void GetValue(float time, AZ::Vector4& value) { assert(0); };
    virtual void GetValue(float time, AZ::Color& value) { assert(0); };
    ...
    virtual void SetValue(float time, const AZ::Vector2& value, bool bDefault = false) { assert(0); };
    virtual void SetValue(float time, const AZ::Vector3& value, bool bDefault = false) { assert(0); };
    virtual void SetValue(float time, const AZ::Vector4& value, bool bDefault = false) { assert(0); };
    virtual void SetValue(float time, const AZ::Color& value, bool bDefault = false) { assert(0); };
...
//////////////////////////////////////////////////////////////////////////
template <class KeyType>
inline bool TUiAnimTrack<KeyType>::Serialize(IUiAnimationSystem* uiAnimationSystem, XmlNodeRef& xmlNode, bool bLoading, bool bLoadEmptyTracks)
{
    if (bLoading)
    {
