...
static void TranslateMsg(const char* in, wchar_t* out, const size_t outSize)
{
    assert(outSize > 0);

    size_t len = min(outSize - 1, strlen(in));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CDraw2d::RotatePointsAboutPivot(AZ::Vector2* points, int numPoints, AZ::Vector2 pivot, float angle) const
{
