...
namespace
{
    ...
    void TestLocalTransform(CLyShine* lyShine) 
    {
        ...
        EBUS_EVENT_ID(testElemId, UiTransformBus, GetLocalTransform, transform);
        AZ_Assert(AZ::IsClose(transform.RetrieveScale().GetX(), testScale, AZ_FLT_EPSILON), "Test failed");
        AZ_Assert(AZ::IsClose(transform.RetrieveScale().GetY(), testScale, AZ_FLT_EPSILON), "Test failed");
        AZ_Assert(AZ::IsClose(transform.RetrieveScale().GetZ(), 1, AZ_FLT_EPSILON), "Test failed");
        ...
        EBUS_EVENT_ID(testElemId, UiTransformBus, GetLocalTransform, transform);
        AZ_Assert(AZ::IsClose((AZ::Vector3(1.f, 0, 0) * transform).GetY(), -1.f, AZ_FLT_EPSILON), "Test failed");
    ...
    void TestLocalInverseTransform(CLyShine* lyShine)
    {
        ...
        AZ_Assert(AZ::IsClose(transform.RetrieveScale().GetX(), inverseTestScale, AZ_FLT_EPSILON), "Test failed");
        AZ_Assert(AZ::IsClose(transform.RetrieveScale().GetY(), inverseTestScale, AZ_FLT_EPSILON), "Test failed");
        AZ_Assert(AZ::IsClose(transform.RetrieveScale().GetZ(), 1, AZ_FLT_EPSILON), "Test failed");
        ...
        AZ_Assert(after.IsClose(before, AZ_FLT_EPSILON), "Test failed");
    ...
    void TestLocalSizeParameters(CLyShine* lyShine)
    {
        ...
        EBUS_EVENT_ID_RESULT(actualWidth, testElemId, UiTransform2dBus, GetLocalWidth);
        AZ_Assert(AZ::IsClose(actualWidth, expectedWidth, AZ_FLT_EPSILON), "Test failed");
        EBUS_EVENT_ID(testElemId, UiTransform2dBus, SetLocalHeight, expectedHeight);
        EBUS_EVENT_ID_RESULT(actualHeight, testElemId, UiTransform2dBus, GetLocalHeight);
        AZ_Assert(AZ::IsClose(actualHeight, expectedHeight, AZ_FLT_EPSILON ), "Test failed");
        ...
        EBUS_EVENT_ID_RESULT(actualWidth, testElemId, UiTransform2dBus, GetLocalWidth);
        AZ_Assert(AZ::IsClose(actualWidth, 0, AZ_FLT_EPSILON ), "Test failed");
        EBUS_EVENT_ID_RESULT(actualHeight, testElemId, UiTransform2dBus, GetLocalHeight);
        AZ_Assert(AZ::IsClose(actualHeight, 0, AZ_FLT_EPSILON ), "Test failed");
