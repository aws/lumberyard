...
////////////////////////////////////////////////////////////////////////////////////////////////////
AZStd::string UiImageSequenceComponent::GetImageIndexAlias(AZ::u32 index)
{
    return AZStd::string();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void UiImageSequenceComponent::SetImageIndexAlias(AZ::u32 index, const AZStd::string& alias)
{
    // Purposefully empty
}

////////////////////////////////////////////////////////////////////////////////////////////////////
AZ::u32 UiImageSequenceComponent::GetImageIndexFromAlias(const AZStd::string& alias)
{
    return 0;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool UiImageSequenceComponent::VersionConverter(AZ::SerializeContext& context,
