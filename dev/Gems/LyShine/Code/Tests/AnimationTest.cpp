...
namespace UnitTest
{
    ...
    {
    public:
        const CTimeValue& GetFrameStartTime(ITimer::ETimer which = ITimer::ETIMER_GAME) const override
        {
    ...
    public:
        ...
        void OnUiAnimationEvent(IUiAnimationListener::EUiAnimationEvent uiAnimationEvent, AZStd::string animSequenceName) {};
