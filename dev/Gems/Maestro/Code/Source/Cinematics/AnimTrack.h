...
public:
    ...
    virtual void GetValue(float time, AZ::Data::AssetId& value) { assert(0); }
    ...
    virtual void SetValue(float time, const AZ::Data::AssetId& value, bool bDefault = false) { assert(0); }
