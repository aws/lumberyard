...
namespace MessagePopup
{
    ...
    //-------------------------------------------------------------------------
    bool MessagePopupSystemComponent::ShowNativePopup(const AZStd::string& _message, MessagePopup::EPopupButtons _buttons, MessagePopup::EPopupKind _kind, AZStd::function<void(int _button)> _callback)
    {
        switch (_buttons)
        {
