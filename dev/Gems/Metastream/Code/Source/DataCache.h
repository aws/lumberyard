...
namespace Metastream
{
    ...
    public:
        ...
        void AddToArray(const std::string & tableName, const std::string & arrayName, const Vec3 & value);
        ...
        void AddToObject(const std::string & tableName, const std::string & objName, const std::string & key, const Vec3 & value);
    ...
    private:
        class Document
        {
            public:
                ...
                rapidjson::Value ToJson(const Vec3 & value);
                rapidjson::Value ToJson(double value);
                rapidjson::Value ToJson(AZ::u64 value);
                rapidjson::Value ToJson(AZ::s64 value);

            private:
                typedef std::shared_ptr<rapidjson::Value> rapidJsonValuePtr;
                typedef std::map<std::string, rapidJsonValuePtr> JsonValueMap;
        ...
        typedef std::map<std::string, DocumentPtr> Database;
