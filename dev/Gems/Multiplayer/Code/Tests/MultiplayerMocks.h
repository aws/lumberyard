...
namespace UnitTest
{
    ...
    public:
        ...
        GridMate::GridSearch* DefaultRequestSession(const GridMate::GameLiftSessionRequestParams& params)
        {
        ...
        GridMate::GridSearch* DefaultStartMatchmaking(const AZStd::string& matchmakingConfig)
        {
            EXPECT_EQ(nullptr, m_search);
    ...
    public:
        MultiplayerLobbyLANServiceWrapperMock(const AZ::EntityId& multiplayerLobbyEntityId) : Multiplayer::MultiplayerLobbyLANServiceWrapper(multiplayerLobbyEntityId)
        {
            ...
            ON_CALL(*this, CreateServer(_,_)).WillByDefault(Invoke(
                [this](GridMate::IGridMate* gridMate, GridMate::CarrierDesc& carrierDesc)
                {
            ...
            ON_CALL(*this, JoinSession(_, _,_)).WillByDefault(Invoke(
                [this](GridMate::IGridMate* gridMate, GridMate::CarrierDesc& carrierDesc, const GridMate::SearchInfo* searchInfo)
                {
                    return GetGridSessionMock();
                }
            ));
            ...
            ON_CALL(*this, ListServers(_)).WillByDefault(Invoke(
                [this](GridMate::IGridMate* gridMate)
                {
