...
namespace NvCloth
{
    ...
    private:
        ...
        {
            AZStd::vector<Vec3> m_particles;
            AZStd::vector<Vec3f16> m_normals;
        ...
        // Render data as needed by IRenderMesh.
        InternalRenderData m_internalRenderData;
