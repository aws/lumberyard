...
namespace UnitTest
{
        ...
        const AZ::Transform& offset)
    {
        ...
        colliderConf->m_rotation = AZ::Quaternion::CreateFromTransform(offset);
        ...
        const AZStd::vector<AZ::Color>& clothData)
    {
        ...
        auto meshBuilder = MCore::MemoryObjectUniquePtr<EMotionFX::MeshBuilder>{ EMotionFX::MeshBuilder::Create(nodeIndex, vertCount, false) };
