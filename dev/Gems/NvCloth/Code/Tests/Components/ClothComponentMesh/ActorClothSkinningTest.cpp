...
namespace UnitTest
{
    ...
    TEST_F(NvClothActorClothSkinning, ActorClothSkinning_UpdateAndApplyLinearSkinning_ModifiesVertices)
    {
        ...
        const AZStd::vector<NvCloth::SimParticleFormat> clothParticlesResult = {{
            NvCloth::SimParticleFormat::CreateFromVector3AndFloat(diffTransform * MeshVertices[0], 1.0f),
            NvCloth::SimParticleFormat::CreateFromVector3AndFloat(diffTransform * MeshVertices[1], 1.0f),
            NvCloth::SimParticleFormat::CreateFromVector3AndFloat(diffTransform * MeshVertices[2], 1.0f),
        }};
