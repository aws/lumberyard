...
namespace UnitTest
{
    ...
    TEST_F(NvClothSystemCloth, Cloth_ClothConfigurationSetTransform_TranslationAndRotationAreAppliedToNativeCloth)
    {
        ...
        ExpectEq(AZ::Quaternion::CreateFromTransform(identity), m_nvCloth->getRotation());

        m_cloth->GetClothConfigurator()->SetTransform(rotationX);

        ExpectEq(rotationX.GetTranslation(), m_nvCloth->getTranslation());
        ExpectEq(AZ::Quaternion::CreateFromTransform(rotationX), m_nvCloth->getRotation());
        ...
        ExpectEq(AZ::Quaternion::CreateFromTransform(rotationYAndTranslation), m_nvCloth->getRotation());
    }
