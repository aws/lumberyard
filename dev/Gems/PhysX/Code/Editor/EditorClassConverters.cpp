...
namespace PhysX
{
    namespace ClassConverters
    {
        ...
        {
            // collision group id
            Physics::CollisionGroups::Id collisionGroupId;
            ...
            if (result)
            {
                classElement.AddElementWithData<Physics::CollisionGroups::Id>(context, "CollisionGroupId", collisionGroupId);
        ...
        bool UpgradeEditorColliderComponent(AZ::SerializeContext& context, AZ::SerializeContext::DataElementNode& dataElement)
        {
            ...
            if (dataElement.GetVersion() <= 1)
            {
                ...
                Physics::CollisionGroups::Id groupId;
                dataElement.GetChildData<Physics::CollisionGroups::Id>(AZ_CRC("CollisionGroupId", 0x84fe4bbe), groupId);
