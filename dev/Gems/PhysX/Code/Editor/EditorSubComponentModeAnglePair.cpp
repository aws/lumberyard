...
namespace PhysX
{
        ...
        , m_secondMin(secondMin)
    {
        ...
        AZ::Vector3 displacementTranslate = localRotation * displacement;
        ...
        displacement = -m_axis;
        displacementTranslate = localRotation * displacement;
        displacementTransform.SetPosition(localTransform.GetPosition() + displacementTranslate);
        ...
        AzFramework::DebugDisplayRequests& debugDisplay)
    {
        ...
        if (AZ::IsCloseMag<AZ::VectorFloat>(m_axis.GetX(), 1.0f))
        {
            points[2].SetZ(size);
            points[3].SetZ(size);
        }
        else if (AZ::IsCloseMag<AZ::VectorFloat>(m_axis.GetY(), 1.0f))
        {
            points[2].SetX(size);
            points[3].SetX(size);
        }
        else if (AZ::IsCloseMag<AZ::VectorFloat>(m_axis.GetZ(), 1.0f))
        {
            points[2].SetX(size);
            points[3].SetX(size);
        }
