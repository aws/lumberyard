...
namespace PhysXCharacters
{
    ...
    {
        const AZ::Quaternion worldRotation = AZ::Quaternion::CreateFromTransform(worldTransform);
        ...
        for (size_t nodeIndex = 0; nodeIndex < numNodes; nodeIndex++)
        {
            ...
            bindPoseWorld[nodeIndex].m_position = worldRotation * bindPose[nodeIndex].m_position + worldTranslation;
        }
    ...
    void RagdollComponent::Reinit()
    {
        ...
        for (size_t nodeIndex = 0; nodeIndex < numNodes; nodeIndex++)
        {
            ...
            AZ::Outcome<size_t> parentIndex = Utils::GetNodeIndex(ragdollConfiguration, parentName);
        ...
        m_ragdoll = Utils::CreateRagdoll(ragdollConfiguration, bindPoseWorld, parentIndices);
        if (!m_ragdoll)
        {
