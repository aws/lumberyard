...
namespace SVOGI
{
    ...
    void SVOGISystemComponent::OnCrySystemPreInitialize(ISystem& system, const SSystemInitParams& systemInitParams)
    {
    }

    void SVOGISystemComponent::OnCrySystemInitialized(ISystem& system, const SSystemInitParams& systemInitParams)
    {
    ...
    void SVOGISystemComponent::OnCrySystemShutdown(ISystem& system)
    {
        UnregisterCVars();
#if !defined(AZ_MONOLITHIC_BUILD)
        gEnv = nullptr;
