...
namespace ScriptCanvasEditor
{
    ...
    private:
        ...
        AZ::Data::Asset<T> Clone()
        {
            ...
            newAsset = aznew T(assetId, AZ::Data::AssetData::AssetStatus::Ready);
        ...
        {
            asset = AZ::Data::AssetManager::Instance().GetAsset<T>(assetId, true, nullptr, false);
        }
        ...
        AZ::Data::Asset<AZ::Data::AssetData> CloneAssetData(AZ::Data::AssetId newAssetId)
        {
            ...
            m_inMemoryAsset = AZStd::move(assetData);
