...
namespace ScriptCanvasEditor
{
    ...
    inline void RunGraph(AZStd::string_view graphPath, ScriptCanvas::ExecutionMode execution, const DurationSpec& duration, Reporter& reporter)
    {
        ...
        if (loadResult.m_graph)
        {
            ...
            // force the runtime asset state
            AZ::Data::AssetManagerBus::Broadcast(&AZ::Data::AssetManagerEvents::OnAssetReady, loadResult.m_asset);
            // force the runtime component to receive the OnAssetReady event, on which it will execute the graph
