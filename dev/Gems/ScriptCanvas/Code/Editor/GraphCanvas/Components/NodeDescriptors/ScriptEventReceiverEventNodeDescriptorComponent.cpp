...
namespace ScriptCanvasEditor
{
    ...
    void ScriptEventReceiverEventNodeDescriptorComponent::OnSceneMemberDeserialized(const AZ::EntityId& graphId, const GraphCanvas::GraphSerialization& serializationTarget)
    {
    ...
    void ScriptEventReceiverEventNodeDescriptorComponent::OnAddedToGraphCanvasGraph(const GraphCanvas::GraphId& grapphId, const AZ::EntityId& scriptCanvasNodeId)
    {
