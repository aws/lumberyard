...
namespace ScriptCanvasEditor
{
    ...
    void ScriptEventReceiverNodeDescriptorComponent::OnAddedToScene(const AZ::EntityId& graphCanvasGraphId)
    {
    ...
    void ScriptEventReceiverNodeDescriptorComponent::OnMemberSetupComplete()
    {
        ...
        AZ::Data::Asset<ScriptEvents::ScriptEventsAsset> asset = AZ::Data::AssetManager::Instance().GetAsset<ScriptEvents::ScriptEventsAsset>(m_scriptEventsAssetId);
    ...
    void ScriptEventReceiverNodeDescriptorComponent::OnSceneMemberDeserialized(const AZ::EntityId&, const GraphCanvas::GraphSerialization&)
    {
        ...
        AZ::Data::AssetManager::Instance().GetAsset<ScriptEvents::ScriptEventsAsset>(m_scriptEventsAssetId);
    }
