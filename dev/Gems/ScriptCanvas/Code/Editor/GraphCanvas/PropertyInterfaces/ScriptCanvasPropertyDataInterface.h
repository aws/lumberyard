...
namespace ScriptCanvasEditor
{
    ...
    protected:
        ...
        {
            AZ_STATIC_ASSERT((AZStd::is_base_of<GraphCanvas::DataInterface, InterfaceType>::value), "ScriptCanvasPropertyDataInterface given invalid GraphCanvas::DataInterface to inherit.");
