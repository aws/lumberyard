...
namespace ScriptCanvasEditor
{
    ...
    public:
        ...
        virtual void OnTestStart(const AZ::Uuid& sourceID) {}
        virtual void OnTestResult(const AZ::Uuid& sourceID, UnitTestResult result) {}
        virtual void OnCheckStateCountChange(const int count) {}
    };
