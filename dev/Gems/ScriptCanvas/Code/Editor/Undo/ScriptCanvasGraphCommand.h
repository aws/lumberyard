...
namespace ScriptCanvasEditor
{
    ...
    public:
        ...
        GraphItemAddCommand(AZStd::string_view friendlyName);
    ...
    public:
        ...
        GraphItemRemovalCommand(AZStd::string_view friendlyName);
    ...
    protected:
        GraphItemRemovalCommand(const GraphItemAddCommand&) = delete;
