...
namespace ScriptCanvasEditor
{
    namespace Widget
    {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////
        CommandListDataModel::CommandListDataModel(QWidget* parent /*= nullptr*/)
        {
        ...
        QModelIndex CommandListDataModel::parent(const QModelIndex& child) const
        {
            return QModelIndex();
        }

        int CommandListDataModel::rowCount(const QModelIndex& parent /*= QModelIndex()*/) const
        {
            return static_cast<int>(m_nodeTypes.size());
        }

        int CommandListDataModel::columnCount(const QModelIndex& parent /*= QModelIndex()*/) const
        {
        ...
        void CommandLineEdit::onTextChanged(const QString& text)
        {
        }
        ...
        void CommandLineEdit::keyPressEvent(QKeyEvent* event)
        {
            ...
            case Qt::Key_Return:
            {
                ...
                Metrics::MetricsEventsBus::Broadcast(&Metrics::MetricsEventRequests::SendMetric, ScriptCanvasEditor::Metrics::Events::CommandLine::Execute);
        ...
        bool CommandListDataProxyModel::filterAcceptsRow(int sourceRow, const QModelIndex& sourceParent) const
        {
        ...
        void CommandLine::showEvent(QShowEvent* event)
        {
            ...
            Metrics::MetricsEventsBus::Broadcast(&Metrics::MetricsEventRequests::SendMetric, ScriptCanvasEditor::Metrics::Events::CommandLine::Open);
        }

        #include <Editor/View/Widgets/CommandLine.moc>
    }
}
