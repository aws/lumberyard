...
namespace ScriptCanvasEditor
{
    ...
    void LoggingDataAggregator::ProcessSignal(const ScriptCanvas::Signal& signal)
    {
    ...
    void LoggingDataAggregator::ProcessNodeStateChanged(const ScriptCanvas::NodeStateChange& stateChangeSignal)
    {
    }
    ...
    void LoggingDataAggregator::ProcessVariableChangedSignal(const ScriptCanvas::VariableChange& variableChangeSignal)
    {
