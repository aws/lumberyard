...
namespace ScriptCanvasEditor
{
    ...
    GraphPivotTreeEntityItem* GraphPivotTreeGraphItem::FindEntityTreeItem(const AZ::NamedEntityId& namedEntityId, const ScriptCanvas::GraphIdentifier& graphIdentifier) const
    {
    ...
    void GraphPivotTreeGraphItem::SetupDynamicallySpawnedElementItem(bool isChecked)
    {
    ...
    void GraphPivotTreeFolder::OnChildDataChanged(GraphCanvasTreeItem* treeItem)
    {
        CalculateCheckState();
        ...
        : m_categorizer((*this))
    {
        ...
        assetFilter->SetAssetGroup(ScriptCanvasEditor::ScriptCanvasAsset::GetGroup());
    ...
    GraphCanvas::GraphCanvasTreeItem* GraphPivotTreeRoot::CreateCategoryNode(AZStd::string_view categoryPath, AZStd::string_view categoryName, GraphCanvasTreeItem* parent) const
    {
...
#include <Editor/View/Widgets/LoggingPanel/PivotTree/GraphPivotTree/GraphPivotTree.moc>
