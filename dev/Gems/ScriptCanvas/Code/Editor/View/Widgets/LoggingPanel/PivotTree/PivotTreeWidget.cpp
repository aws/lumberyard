...
namespace ScriptCanvasEditor
{
    ...
    Qt::ItemFlags PivotTreeItem::Flags(const QModelIndex& index) const
    {
    ...
    bool PivotTreeSortProxyModel::filterAcceptsRow(int sourceRow, const QModelIndex& sourceParent) const
    {
        ...
        while (!showRow && parentIndex.isValid())
        {
            ...
            showRow = test.contains(m_filterRegex);
...
#include <Editor/View/Widgets/LoggingPanel/PivotTree/PivotTreeWidget.moc>
}
