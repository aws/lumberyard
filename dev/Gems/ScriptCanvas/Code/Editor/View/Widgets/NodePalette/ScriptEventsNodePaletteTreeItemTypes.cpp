...
namespace ScriptCanvasEditor
{
    ...
    CreateScriptEventsReceiverMimeEvent::CreateScriptEventsReceiverMimeEvent(const AZ::Data::AssetId assetId, const ScriptEvents::Method& methodDefinition)
        ...
        , m_methodDefinition(methodDefinition)
    {
        m_asset = AZ::Data::AssetManager::Instance().GetAsset<ScriptEvents::ScriptEventsAsset>(m_assetId);
    }
    ...
    bool CreateScriptEventsReceiverMimeEvent::ExecuteEvent(const AZ::Vector2& mousePosition, AZ::Vector2& sceneDropPosition, const AZ::EntityId& graphCanvasGraphId)
    {
    ...
    const AZ::Data::Asset<ScriptEvents::ScriptEventsAsset> CreateScriptEventsSenderMimeEvent::GetAsset()
    {
    ...
    ScriptEventsEventNodePaletteTreeItem::ScriptEventsEventNodePaletteTreeItem(const AZ::Data::AssetId& assetId, const ScriptEvents::Method& methodDefinition, const ScriptCanvas::EBusEventId& eventId)
        ...
        , m_eventId(eventId)
    {
        m_asset = AZ::Data::AssetManager::Instance().GetAsset<ScriptEvents::ScriptEventsAsset>(assetId);
