    ...
    namespace Data
    {
        ...
        struct PropertyTraits<Data::eType::Transform>
        {
            static GetterContainer GetGetterWrappers(const Data::Type&)
            {
                ...
                getterFunctions.emplace("position", WrapGetter<decltype(&Data::TransformType::GetPosition)>::Callback("position", &Data::TransformType::GetPosition));
                return getterFunctions;
            }
            ...
            {
                SetterContainer setterFunctions;
                setterFunctions.emplace("basisX", WrapSetter<void(AZ::Transform::*)(const AZ::Vector3&)>::Callback("basisX", &Data::TransformType::SetBasisX));
                setterFunctions.emplace("basisY", WrapSetter<void(AZ::Transform::*)(const AZ::Vector3&)>::Callback("basisY", &Data::TransformType::SetBasisY));
                setterFunctions.emplace("basisZ", WrapSetter<void(AZ::Transform::*)(const AZ::Vector3&)>::Callback("basisZ", &Data::TransformType::SetBasisZ));
                setterFunctions.emplace("position", WrapSetter<void(AZ::Transform::*)(const AZ::Vector3&)>::Callback("position", &Data::TransformType::SetPosition));
                return setterFunctions;
            }
        };
        ...
        struct PropertyTraits<Data::eType::OBB>
        {
            ...
            {
                SetterContainer setterFunctions;
                setterFunctions.emplace("axisX", WrapSetter<decltype(&Data::OBBType::SetAxisX)>::Callback("axisX", &Data::OBBType::SetAxisX));
                setterFunctions.emplace("axisY", WrapSetter<decltype(&Data::OBBType::SetAxisY)>::Callback("axisY", &Data::OBBType::SetAxisY));
                setterFunctions.emplace("axisZ", WrapSetter<decltype(&Data::OBBType::SetAxisZ)>::Callback("axisZ", &Data::OBBType::SetAxisZ));
        ...
        struct PropertyTraits<Data::eType::Matrix4x4>
        {
            static GetterContainer GetGetterWrappers(const Data::Type&)
            {
                ...
                getterFunctions.emplace("position", WrapGetter<decltype(&Data::Matrix4x4Type::GetPosition)>::Callback("position", &Data::Matrix4x4Type::GetPosition));
                return getterFunctions;
            }
            ...
            static SetterContainer GetSetterWrappers(const Data::Type&)
            {
                ...
                setterFunctions.emplace("position", WrapSetter<void(AZ::Matrix4x4::*)(const AZ::Vector3&)>::Callback("position", &Data::Matrix4x4Type::SetPosition));
                return setterFunctions;
            }
        };
