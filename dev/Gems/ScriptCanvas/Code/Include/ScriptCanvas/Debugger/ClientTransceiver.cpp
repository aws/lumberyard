...
namespace ScriptCanvas
{
    namespace Debugger
    {
        ...
        void ClientTransceiver::DesiredTargetChanged(AZ::u32 newId, AZ::u32 oldId)
        {
        ...
        void ClientTransceiver::Visit(Message::Disconnected& notification)
        {
        ...
        void ClientTransceiver::Visit(Message::Continued& notification)
        {
