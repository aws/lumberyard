...
namespace ScriptCanvas
{
    namespace Nodes    
    {
        namespace Internal
        {
            ...
            void BaseTimerNode::OnTick(float delta, AZ::ScriptTimePoint timePoint)
            {
                switch (m_timeUnits)
                {
            ...
            void BaseTimerNode::OnTimeUnitsChanged(const int& timeUnits)
            {
                UpdateTimeName();
            }
...
#include <Include/ScriptCanvas/Internal/Nodes/BaseTimerNode.generated.cpp>
