...
namespace ScriptCanvas
{
    namespace Nodes
    {
        namespace Internal
        {
            ...
            void ExpressionNodeBase::OnResult(const ExpressionEvaluation::ExpressionResult& result)
            {
                AZ_Assert(false, "Implementing node must override OnResult.");
            }

            ExpressionEvaluation::ParseOutcome ExpressionNodeBase::ParseExpression(const AZStd::string& formatString)
            {
                AZ_Assert(false , "Implementing node must override OnResult.");
...
#include <Include/ScriptCanvas/Internal/Nodes/ExpressionNodeBase.generated.cpp>
