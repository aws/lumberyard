...
namespace ScriptCanvas
{
    namespace Nodes
    {
        namespace Core
        {
            ...
            static bool FunctionVersionConverter(AZ::SerializeContext& serializeContext, AZ::SerializeContext::DataElementNode& rootElement)
            {
            ...
            FunctionNode::FunctionNode() 
                ...
                , m_executionContextEntity(nullptr)
            ...
            void FunctionNode::OnSignalOut(ID nodeId, SlotId slotId)
            {
            ...
            FunctionNode::~FunctionNode()
            {
                delete m_executionContextEntity;
            ...
            {
                AZ::Data::Asset<ScriptCanvas::RuntimeFunctionAsset> asset = AZ::Data::AssetManager::Instance().GetAsset<ScriptCanvas::RuntimeFunctionAsset>(m_asset.GetId(), true, nullptr, true);
            ...
            void FunctionNode::Initialize(AZ::Data::AssetId assetId)
            {
                ...
                if (assetId.IsValid())
                {
                    ...
                    m_asset = AZ::Data::AssetManager::Instance().GetAsset<RuntimeFunctionAsset>(assetId, true, nullptr, blockingLoad);
                }
            }
            ...
            {
                AZ::Data::Asset<RuntimeFunctionAsset> assetData = AZ::Data::AssetManager::Instance().GetAsset<RuntimeFunctionAsset>(m_asset.GetId(), true, nullptr, true);
            ...
            void FunctionNode::OnAssetReady(AZ::Data::Asset<AZ::Data::AssetData> asset)
            {
                ...
                m_executionContextEntity = new AZ::Entity();
                ...
                AZ::Data::Asset<RuntimeFunctionAsset> assetData = AZ::Data::AssetManager::Instance().GetAsset<RuntimeFunctionAsset>(asset.GetId());
...
#include <Include/ScriptCanvas/Libraries/Core/FunctionNode.generated.cpp>
