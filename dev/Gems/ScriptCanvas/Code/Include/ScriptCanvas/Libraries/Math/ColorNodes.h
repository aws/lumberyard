...
namespace ScriptCanvas
{
    namespace ColorNodes
    {
        ...
        {
            return FromVectorFloat(a.Dot3(b));
        }
        ...
        {
            return ColorType(ToVectorFloat(r), ToVectorFloat(g), ToVectorFloat(b), ToVectorFloat(a));
        }
        ...
        {
            return ColorType::CreateFromVector3AndFloat(RGB, ToVectorFloat(A));
        }
        ...
        {
            source.SetR(ToVectorFloat(value));
            return source;
        }
        ...
        {
            source.SetG(ToVectorFloat(value));
            return source;
        }
        ...
        {
            source.SetB(ToVectorFloat(value));
            return source;
        }
        ...
        {
            source.SetA(ToVectorFloat(value));
            return source;
        }
