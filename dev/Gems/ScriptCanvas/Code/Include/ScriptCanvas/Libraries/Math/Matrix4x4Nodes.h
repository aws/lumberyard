...
namespace ScriptCanvas
{
    namespace Matrix4x4Nodes
    {
        ...
        {
            return Data::Matrix4x4Type::CreateProjection(Data::ToVectorFloat(fovY), Data::ToVectorFloat(aspectRatio), Data::ToVectorFloat(nearDist), Data::ToVectorFloat(farDist));
        }
        ...
        {
            return Data::Matrix4x4Type::CreateProjectionFov(Data::ToVectorFloat(fovX), Data::ToVectorFloat(fovY), Data::ToVectorFloat(nearDist), Data::ToVectorFloat(farDist));
        }
        ...
        {
            return Data::Matrix4x4Type::CreateProjectionOffset(Data::ToVectorFloat(left), Data::ToVectorFloat(right), Data::ToVectorFloat(bottom), Data::ToVectorFloat(top), Data::ToVectorFloat(nearDist), Data::ToVectorFloat(farDist));
        }
        ...
        {
            Data::Vector4Type row0, row1, row2;
            source.GetRows(&row0, &row1, &row2);
            return Data::Matrix4x4Type::CreateFromRows(row0, row1, row2, Data::Vector4Type::CreateAxisW());
        }
        ...
        AZ_INLINE Data::NumberType GetElement(const Data::Matrix4x4Type& source, Data::NumberType row, Data::NumberType col)
        {
            ...
            const auto colIndex = aznumeric_cast<AZ::s32>(col);
            return rowIndex >= 0 && rowIndex < numRows && colIndex >= 0 && colIndex < numColumns ? Data::FromVectorFloat(source.GetElement(rowIndex, colIndex)) : Data::NumberType();
        }
