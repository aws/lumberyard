...
namespace ScriptCanvas
{
    namespace OBBNodes
    {
        ...
        AZ_INLINE OBBType FromPositionAndAxes(Vector3Type position, Vector3Type axisX, NumberType halfX, Vector3Type axisY, NumberType halfY, Vector3Type axisZ, NumberType halfZ)
        {
            return OBBType::CreateFromPositionAndAxes(position, axisX, aznumeric_caster(halfX), axisY, aznumeric_caster(halfY), axisZ, aznumeric_caster(halfZ));
        }
        SCRIPT_CANVAS_GENERIC_FUNCTION_NODE(FromPositionAndAxes, "Math/OBB", "{F09F5646-0BFF-4414-9389-2764E819917E}", "returns an OBB from the position, and axis-half length pairs", "Position", "X-Axis", "X Half-Length", "Y-Axis", "Y Half-Length", "Z-Axis", "Z Half-Length");
