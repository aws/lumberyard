...
namespace ScriptCanvas
{
    namespace QuaternionNodes
    {
        ...
        {
            return QuaternionType(ToVectorFloat(x), ToVectorFloat(y), ToVectorFloat(z), ToVectorFloat(w));
        }
        ...
        {
            return QuaternionType::CreateFromTransform(source);
        }
        ...
        {
            return QuaternionType::CreateFromVector3AndValue(imaginary, ToVectorFloat(real));
        }
