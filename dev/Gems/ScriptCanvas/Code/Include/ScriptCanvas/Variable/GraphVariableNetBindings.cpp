...
namespace ScriptCanvas
{
    ...
    void GraphVariableNetBindingTable::Reflect(AZ::ReflectContext* reflect)
    {
    ...
    void GraphVariableNetBindingTable::OnPropertyUpdate(const Datum* const & scriptProperty, const GridMate::TimeContext& tc)
    {
    }
