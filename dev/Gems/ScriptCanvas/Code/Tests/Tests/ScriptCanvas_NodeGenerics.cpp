...
{
    AZ_INLINE AZ::Vector3 NormalizeWithDefault(const AZ::Vector3& source, const Data::NumberType tolerance, const Data::BooleanType fakeValueForTestingDefault)
    {
...
TEST_F(ScriptCanvasTestFixture, NodeGenerics)
{
    ...
    NormalizeWithDefaultNode::Reflect(m_behaviorContext);
    NormalizeWithDefaultNode::Reflect(m_serializeContext);
...
#if defined DEFAULT_AR_OVERRIDES
    NormalizeWithDefaultNode::Reflect(m_behaviorContext);
    NormalizeWithDefaultNode::Reflect(m_serializeContext);
#endif
