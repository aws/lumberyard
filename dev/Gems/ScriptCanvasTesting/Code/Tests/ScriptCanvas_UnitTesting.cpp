...
// Handler
void MetaReporter::ExpectFalse(const bool value, const Report& report)
{
    if (!value)
...
void MetaReporter::ExpectTrue(const bool value, const Report& report)
{
    if (value)
...
void MetaReporter::ExpectEqualNumber(const Data::NumberType lhs, const Data::NumberType rhs, const Report& report)
{
...
void MetaReporter::ExpectNotEqualNumber(const Data::NumberType lhs, const Data::NumberType rhs, const Report& report)
{
    if (!AZ::IsClose(lhs, rhs, ScriptCanvas_UnitTestingCPP::k_tolerance))
        ++m_countNESucceeded;
    else
