...
namespace SliceFavorites
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    FavoriteDataModel::FavoriteDataModel(QObject *parent)
    {
    ...
    bool FavoriteDataModel::dropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent)
    {
        if (!data)
        {
            return true;
    ...
    bool FavoriteDataModel::canDropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent) const
    {
        if (!data)
        {
            return false;
    ...
    void FavoriteDataModel::NotifyRegisterViews()
    {
        ...
        sliceFavoritesOptions.sendViewPaneNameBackToAmazonAnalyticsServers = true;
