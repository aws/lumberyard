...
namespace SliceFavorites
{
    ...
    void SliceFavoritesSystemComponent::GetRequiredServices(AZ::ComponentDescriptor::DependencyArrayType& required)
    {
        required.push_back(AZ_CRC("BootstrapService", 0x90c22e09));
    }

    void SliceFavoritesSystemComponent::GetDependentServices(AZ::ComponentDescriptor::DependencyArrayType& /*dependent*/)
    {
    }
