...
namespace StarterGameGem
{
    ...
    void DebugManagerComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context))
        {
            behaviorContext->EBus<DebugManagerComponentRequestsBus>("DebugManagerComponentRequestsBus")
                ->Event("GetVariablesAreReady", &DebugManagerComponentRequestsBus::Events::GetVariablesAreReady)
                ->Event("SetVariablesAreReady", &DebugManagerComponentRequestsBus::Events::SetVariablesAreReady)
    ...
    bool DebugManagerComponent::GetVariablesAreReady()
    {
        return m_variablesAreReady;
    }

    void DebugManagerComponent::SetVariablesAreReady()
    {
        m_variablesAreReady = true;
    }
