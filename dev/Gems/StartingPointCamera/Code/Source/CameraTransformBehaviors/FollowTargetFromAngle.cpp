...
namespace Camera
{
    ...
    void FollowTargetFromAngle::AdjustCameraTransform(float deltaTime, const AZ::Transform& initialCameraTransform, const AZ::Transform& targetTransform, AZ::Transform& inOutCameraTransform)
    {
        ...
        inOutCameraTransform.SetPosition(targetTransform.GetPosition() - rotation.GetColumn(ForwardBackward) * m_distanceFromTarget);
    }
} //namespace Camera