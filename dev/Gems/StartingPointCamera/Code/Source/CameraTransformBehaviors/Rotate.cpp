...
namespace Camera
{
    ...
    void Rotate::AdjustCameraTransform(float deltaTime, const AZ::Transform& initialCameraTransform, const AZ::Transform& targetTransform, AZ::Transform& inOutCameraTransform)
    {
        AZ::Vector3 position = inOutCameraTransform.GetPosition();
        ...
        inOutCameraTransform.SetPosition(position);
    }
} // namespace Camera