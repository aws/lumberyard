...
namespace Input
{
    ...
    inline AZStd::string ConvertInputEventName(AZStd::string inputEventName)
    {
        ...
        static const std::unordered_map<std::string, std::string> map =
        {
            ...
            { "xi_a", InputDeviceGamepad::Button::A.GetName() },
            { "xi_b", InputDeviceGamepad::Button::B.GetName() },
            { "xi_x", InputDeviceGamepad::Button::X.GetName() },
            { "xi_y", InputDeviceGamepad::Button::Y.GetName() },
            { "xi_shoulderl", InputDeviceGamepad::Button::L1.GetName() },
            { "xi_shoulderr", InputDeviceGamepad::Button::R1.GetName() },
            { "xi_triggerl", InputDeviceGamepad::Trigger::L2.GetName() },
            { "xi_triggerr", InputDeviceGamepad::Trigger::R2.GetName() },
            { "xi_triggerl_btn", InputDeviceGamepad::Trigger::L2.GetName() },
            { "xi_triggerr_btn", InputDeviceGamepad::Trigger::R2.GetName() },
            { "xi_thumbl", InputDeviceGamepad::Button::L3.GetName() },
            { "xi_thumbr", InputDeviceGamepad::Button::R3.GetName() },
            { "xi_dpad_up", InputDeviceGamepad::Button::DU.GetName() },
            { "xi_dpad_down", InputDeviceGamepad::Button::DD.GetName() },
            { "xi_dpad_left", InputDeviceGamepad::Button::DL.GetName() },
            { "xi_dpad_right", InputDeviceGamepad::Button::DR.GetName() },
            { "xi_start", InputDeviceGamepad::Button::Start.GetName() },
            { "xi_back", InputDeviceGamepad::Button::Select.GetName() },
            { "xi_thumblx", InputDeviceGamepad::ThumbStickAxis1D::LX.GetName() },
            { "xi_thumbly", InputDeviceGamepad::ThumbStickAxis1D::LY.GetName() },
            { "xi_thumbl_up", InputDeviceGamepad::ThumbStickDirection::LU.GetName() },
            { "xi_thumbl_down", InputDeviceGamepad::ThumbStickDirection::LD.GetName() },
            { "xi_thumbl_left", InputDeviceGamepad::ThumbStickDirection::LL.GetName() },
            { "xi_thumbl_right", InputDeviceGamepad::ThumbStickDirection::LR.GetName() },
            { "xi_thumbrx", InputDeviceGamepad::ThumbStickAxis1D::RX.GetName() },
            { "xi_thumbry", InputDeviceGamepad::ThumbStickAxis1D::RY.GetName() },
            { "xi_thumbr_up", InputDeviceGamepad::ThumbStickDirection::RU.GetName() },
            { "xi_thumbr_down", InputDeviceGamepad::ThumbStickDirection::RD.GetName() },
            { "xi_thumbr_left", InputDeviceGamepad::ThumbStickDirection::RL.GetName() },
            { "xi_thumbr_right", InputDeviceGamepad::ThumbStickDirection::RR.GetName() },

            { "pad_cross", InputDeviceGamepad::Button::A.GetName() },
            { "pad_circle", InputDeviceGamepad::Button::B.GetName() },
            { "pad_square", InputDeviceGamepad::Button::X.GetName() },
            { "pad_triangle", InputDeviceGamepad::Button::Y.GetName() },
            { "pad_l1", InputDeviceGamepad::Button::L1.GetName() },
            { "pad_r1", InputDeviceGamepad::Button::R1.GetName() },
            { "pad_l2", InputDeviceGamepad::Trigger::L2.GetName() },
            { "pad_r2", InputDeviceGamepad::Trigger::R2.GetName() },
            { "pad_l3", InputDeviceGamepad::Button::L3.GetName() },
            { "pad_r3", InputDeviceGamepad::Button::R3.GetName() },
            { "pad_up", InputDeviceGamepad::Button::DU.GetName() },
            { "pad_down", InputDeviceGamepad::Button::DD.GetName() },
            { "pad_left", InputDeviceGamepad::Button::DL.GetName() },
            { "pad_right", InputDeviceGamepad::Button::DR.GetName() },
            { "pad_start", InputDeviceGamepad::Button::Start.GetName() },
            { "pad_select", InputDeviceGamepad::Button::Select.GetName() },
            { "pad_sticklx", InputDeviceGamepad::ThumbStickAxis1D::LX.GetName() },
            { "pad_stickly", InputDeviceGamepad::ThumbStickAxis1D::LY.GetName() },
            { "pad_stickrx", InputDeviceGamepad::ThumbStickAxis1D::RX.GetName() },
            { "pad_stickry", InputDeviceGamepad::ThumbStickAxis1D::RY.GetName() },
