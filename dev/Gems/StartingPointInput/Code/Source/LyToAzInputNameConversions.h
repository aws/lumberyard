...
namespace Input
{
    ...
    inline AZStd::string ConvertInputDeviceName(AZStd::string inputDeviceName)
    {
        ...
        static const std::unordered_map<std::string, std::string> map =
        {
            ...
            { "xenia controller", InputDeviceGamepad::Name },
            { "provo controller", InputDeviceGamepad::Name },
...
#include "Platform/Xenia/LyToAzInputNameConversion_h_xenia.inl"
#endif

#if defined(AZ_PLATFORM_PROVO) || defined(TOOLS_SUPPORT_PROVO)
#include "Platform/Provo/LyToAzInputNameConversion_h_provo.inl"
#endif
