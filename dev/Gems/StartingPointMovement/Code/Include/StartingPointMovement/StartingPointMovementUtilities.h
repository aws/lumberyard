...
namespace Movement
{
    ...
    //////////////////////////////////////////////////////////////////////////
    static AZ::Transform CreateRotationFromAxis(AxisOfRotation rotationType, AZ::VectorFloat radians)
    {
        static const AZ::Transform(*s_createRotation[3]) (const AZ::VectorFloat &) =
        {
