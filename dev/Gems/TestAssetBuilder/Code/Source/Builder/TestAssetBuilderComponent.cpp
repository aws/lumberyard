...
namespace TestAssetBuilder
{
    ...
    void TestAssetBuilderComponent::ProcessJob(const AssetBuilderSDK::ProcessJobRequest& request, AssetBuilderSDK::ProcessJobResponse& response)
    {
        ...
        if (AzFramework::StringFunc::Equal(ext.c_str(), "source"))
        {
            ...
            AzToolsFramework::AssetSystemRequestBus::BroadcastResult(gotAssetInfo, &AzToolsFramework::AssetSystem::AssetSystemRequest::GetAssetInfoById, depAssetId, AZ::AzTypeInfo<TestDependentAsset>::Uuid(), assetSystemDepInfo, depRootFolder);
            if (!gotAssetInfo)
            {
        ...
        else if (AzFramework::StringFunc::Equal(ext.c_str(), "slicetest"))
        {
            ...
            AzToolsFramework::AssetSystemRequestBus::BroadcastResult(gotAssetSystemInfoByIdFromProduct, &AzToolsFramework::AssetSystem::AssetSystemRequest::GetAssetInfoById, pathAssetId, AZ::AzTypeInfo<AZ::SliceAsset>::Uuid(), sliceSourceInfo, sourcePathFromProduct);
            ...
            AzToolsFramework::AssetSystemRequestBus::BroadcastResult(gotAssetSystemInfoByIdFromProduct, &AzToolsFramework::AssetSystem::AssetSystemRequest::GetAssetInfoById, badAssetId, AZ::AzTypeInfo<AZ::SliceAsset>::Uuid(), sliceSourceInfo, sourcePathFromProduct);
            if (gotAssetSystemInfoByIdFromProduct)
            {
            ...
            AzToolsFramework::AssetSystemRequestBus::BroadcastResult(gotResultAssetInfo, &AzToolsFramework::AssetSystem::AssetSystemRequest::GetAssetInfoById, sourceAssetId, sourcePathAssetInfo.m_assetType, systemAssetInfo, rootPath);
