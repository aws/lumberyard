...
namespace Vegetation
{
    ...
    void BlockerComponent::UpdateShapeParams()
    {
        AZStd::lock_guard<decltype(m_shapeMutex)> shapeLock(m_shapeMutex);
        GradientSignal::GetObbParamsFromShape(GetEntityId(), m_shapeBounds, m_shapeTransformInverse);
    }

    bool BlockerComponent::PrepareToClaim(EntityIdStack& stackIds)
    {
        UpdateShapeParams();
        return true;
    }
    ...
    void BlockerComponent::UnclaimPosition(const ClaimHandle handle)
    {
    }
    ...
    float BlockerComponent::GetAreaPriority() const
    {
        return m_configuration.m_priority;
    }

    void BlockerComponent::SetAreaPriority(float priority)
    {
        m_configuration.m_priority = priority;
        LmbrCentral::DependencyNotificationBus::Event(GetEntityId(), &LmbrCentral::DependencyNotificationBus::Events::OnCompositionChanged);
    }

    AreaLayer BlockerComponent::GetAreaLayer() const
    {
        return m_configuration.m_layer;
    }

    void BlockerComponent::SetAreaLayer(AreaLayer layer)
    {
