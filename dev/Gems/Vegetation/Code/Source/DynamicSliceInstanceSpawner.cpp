...
namespace Vegetation
{
    ...
    InstancePtr DynamicSliceInstanceSpawner::CreateInstance(const InstanceData& instanceData)
    {
        ...
        AzFramework::GameEntityContextRequestBus::BroadcastResult(
            *ticket,
            &AzFramework::GameEntityContextRequestBus::Events::InstantiateDynamicSlice,
            m_sliceAsset,
            world,
            nullptr);
        ...
        else
        {
            ...
            AZ_Assert(*ticket, "Unable to instantiate dynamic slice");
            delete ticket;
        }
    ...
    void DynamicSliceInstanceSpawner::DeleteSliceInstance(const AzFramework::SliceInstantiationTicket &ticket, AZ::EntityId firstEntityInSlice)
    {
        ...
        AzFramework::GameEntityContextRequestBus::Broadcast(&AzFramework::GameEntityContextRequestBus::Events::CancelDynamicSliceInstantiation, ticket);
        ...
        {
            bool result = false;
            AzFramework::GameEntityContextRequestBus::BroadcastResult(result, &AzFramework::GameEntityContextRequestBus::Events::DestroyDynamicSliceByEntity, firstEntityInSlice);
            AZ_Assert(result, "Failed to destroy slice instance.");
        }

    }

    void DynamicSliceInstanceSpawner::DestroyInstance(InstanceId id, InstancePtr instance)
    {
        if (instance)
        {
    ...
    void DynamicSliceInstanceSpawner::OnSliceInstantiated(const AZ::Data::AssetId & sliceAssetId, const AZ::SliceComponent::SliceInstanceAddress & sliceAddress)
    {
    ...
    void DynamicSliceInstanceSpawner::OnSliceInstantiationFailedOrCanceled(const AZ::Data::AssetId & sliceAssetId, bool cancelled)
    {
        const AzFramework::SliceInstantiationTicket ticket = *AzFramework::SliceInstantiationResultBus::GetCurrentBusId();
