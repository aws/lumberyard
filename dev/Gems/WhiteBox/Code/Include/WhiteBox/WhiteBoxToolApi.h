...
namespace WhiteBox
{
    ...
    namespace Api
    {
        ...
        //! Take an input stream of bytes and create a white box mesh from the de-serialized data.
        //! @return Will return false if any error was encountered during de-serialization, true otherwise.
