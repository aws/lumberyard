...
namespace WhiteBox
{
    namespace Pipeline
    {
        ...
        public:
            ...
            void SetUndoData(const AZStd::vector<AZ::u8> undoData)
            {
                m_assetUndoData = undoData;
            }

            const AZStd::vector<AZ::u8>& GetUndoData()
            {
                return m_assetUndoData;
            }

            void UpdateUndoData()
            {
                Api::WriteMesh(*m_mesh, m_assetUndoData);
            }
        ...
        private:
            ...
            AZStd::vector<AZ::u8> m_assetUndoData; //! Data used for creating undo commands.
        };
    } // namespace Pipeline
} // namespace WhiteBox
