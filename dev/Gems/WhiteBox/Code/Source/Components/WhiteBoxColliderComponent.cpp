...
namespace WhiteBox
{
    ...
    void WhiteBoxColliderComponent::Activate()
    {
        ...
        bodyConfiguration.m_orientation = AZ::Quaternion::CreateFromTransform(worldTransform);
        bodyConfiguration.m_position = worldTransform.GetPosition();
        ...
        AZStd::visit(
            [&shape](auto& rigidBody)
            {
                ...
                Physics::WorldRequestBus::Event(Physics::DefaultPhysicsWorldId, &Physics::World::AddBody, *rigidBody);
            },
            m_rigidBody);
        ...
        [[maybe_unused]] const AZ::Transform& local, const AZ::Transform& world)
    {
        ...
        {
            worldTransform.ExtractScaleExact();
