...
namespace WhiteBox
{
    ...
    {
        const AZ::Transform spaceFromLocal = localFromSpace.GetInverseFull();
        const AZ::Vector3 spacePosition = spaceFromLocal * localPosition;
        const AZ::Vector3 spaceScaledPosition = AZ::Transform::CreateScale(AZ::Vector3(scale)) * spacePosition;
        return localFromSpace * spaceScaledPosition;
    }
