...
namespace WhiteBox
{
        ...
        const WhiteBoxMesh* whiteBox, const AzToolsFramework::LinearManipulator::Action& action)
    {
        ...
        m_startingDistance = (m_pivotPoint - m_initialVertexPositions[m_selectedHandleIndex]).GetLengthExact();
    }
    ...
    void EdgeScaleModifier::CreateManipulators()
    {
        ...
        const AZ::Vector3 axis_lr = (vertexPositions[1] - vertexPositions[0]).GetNormalizedExact();
