...
# Generated 2014-10-19 06:24:59.623702 by PyXB version 1.2.4 using Python 2.7.3.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:8fb222ae-5782-11e4-9fb6-c8600024e903')
...
class STD_ANON (pyxb.binding.basis.STD_list):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.mqXn05k/PyXB-1.2.4/pyxb/bundles/wssplat/schemas/wsdli.xsd', 30, 4)
    _Documentation = None
