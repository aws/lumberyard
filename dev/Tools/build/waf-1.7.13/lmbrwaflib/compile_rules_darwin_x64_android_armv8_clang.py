...
def load_debug_darwin_x64_android_armv8_clang_settings(conf):
    """
    Setup all compiler and linker settings shared over all darwin_x64_android_armv8_clang configurations for
    the 'debug' configuration
    """

    # load this first because it finds the compiler
    conf.load_darwin_x64_android_armv8_clang_common_settings()
