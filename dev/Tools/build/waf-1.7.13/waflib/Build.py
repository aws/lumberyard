...
SAVED_ATTRS = 'root node_deps raw_deps task_sigs last_build'.split()
"""Build class members to save between the runs (root, node_deps, raw_deps, task_sigs, last_build)"""
...
class BuildContext(Context.Context):
	...
	def __init__(self, **kw):
		...
		"""Dict of debugging data describing the state of the last build (persists between executions)"""
	...
	def debug_get_env_vars(self, env, vars_lst):
		"""
		Fetch configuration set variables for debug::

			def build(bld):
				bld.debug_get_env_vars(bld.env, ['CXX', 'CC'])
